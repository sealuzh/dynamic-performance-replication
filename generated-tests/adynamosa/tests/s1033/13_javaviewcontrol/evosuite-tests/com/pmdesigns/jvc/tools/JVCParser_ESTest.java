...
public class JVCParser_ESTest extends JVCParser_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      SimpleCharStream simpleCharStream0 = new SimpleCharStream((Reader) null, 2507, 0, 2507);
      JVCParserTokenManager jVCParserTokenManager0 = new JVCParserTokenManager(simpleCharStream0, 0);
      JVCParser jVCParser0 = new JVCParser(jVCParserTokenManager0);
      jVCParser0.getToken((-276));
      assertEquals(100, jVCParser0.debugColumn);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jVCParser0.ReInit((InputStream) byteArrayInputStream0, "com.pmdesigns.jvc.tools.Token");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.io.UnsupportedEncodingException: com.pmdesigns.jvc.tools.Token
         //
         verifyException("com.pmdesigns.jvc.tools.JVCParser", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      try {
        jVCParser0 = new JVCParser("m}J*EzqZ+pgj", (Set<String>) null, true);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test14()  throws Throwable  {
      ...
      JVCParser jVCParser0 = null;
      try {
        jVCParser0 = new JVCParser(dataInputStream0, "-debug");
        fail("Expecting exception: RuntimeException");
  ...
  public void test15()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("z0=+R+");
      byte[] byteArray0 = new byte[0];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      Locale locale0 = Locale.JAPAN;
      Set<String> set0 = locale0.getUnicodeLocaleAttributes();
      JVCParser jVCParser0 = new JVCParser("z0=+R+", set0);
      assertEquals(100, jVCParser0.debugColumn);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JVCParser jVCParser0 = new JVCParser("z0=+R+", set0, true);
  ...
  public void test32()  throws Throwable  {
      ...
      JVCParser jVCParser0 = null;
      try {
        jVCParser0 = new JVCParser("z0=+R+", set0);
        fail("Expecting exception: FileNotFoundException");
