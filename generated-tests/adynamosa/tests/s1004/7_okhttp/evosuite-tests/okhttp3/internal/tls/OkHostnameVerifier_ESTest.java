...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.INSTANCE.verify(")M@ub{Uw!IY;}8z.,", (SSLSession) null);
  ...
  public void test7()  throws Throwable  {
      ...
      String string0 = "{<6sbqK\"p/01_";
      // Undeclared exception!
      try { 
        okHostnameVerifier1.verify("{<6sbqK\"p/01_", x509Certificate0);
        fail("Expecting exception: NullPointerException");
