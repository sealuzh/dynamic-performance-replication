...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JavaBeanInfo.build((Class<?>) class4, (Type) class0, propertyNamingStrategy0);
      Class<Method> class5 = Method.class;
      // Undeclared exception!
      try { 
        JavaBeanInfo.build((Class<?>) class5, (Type) class2, propertyNamingStrategy0, false, false);
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "com.alibaba.fastjson.util.FieldInfo";
      Class<Object> class1 = Object.class;
      PropertyNamingStrategy propertyNamingStrategy1 = PropertyNamingStrategy.CamelCase;
      JavaBeanInfo.build((Class<?>) class1, (Type) class0, propertyNamingStrategy1);
  ...
  public void test05()  throws Throwable  {
      Class<String> class0 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("vnc", class0, class0, class0, (Field) null, 2284, 2284, 2284);
  ...
  public void test12()  throws Throwable  {
      ...
      doReturn("HB1W[V").when(jSONType0).typeKey();
      doReturn("HB1W[V").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<AtomicBoolean> class0 = AtomicBoolean.class;
  ...
  public void test14()  throws Throwable  {
      ...
      stringArray0[0] = "P)Q|#AX:3Oj0'r >v,t";
      stringArray0[1] = "P)Q|#AX:3Oj0'r >v,t";
      stringArray0[2] = "";
      stringArray0[3] = "P)Q|#AX:3Oj0'r >v,t";
      stringArray0[4] = "P)Q|#AX:3Oj0'r >v,t";
      stringArray0[5] = "P)Q|#AX:3Oj0'r >v,t";
      stringArray0[6] = "P)Q|#AX:3Oj0'r >v,t";
      stringArray0[7] = "P)Q|#AX:3Oj0'r >v,t";
      stringArray0[8] = "P)Q|#AX:3Oj0'r >v,t";
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn((Class) null).when(jSONType0).builder();
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("P)Q|#AX:3Oj0'r >v,t").when(jSONType0).typeKey();
      ...
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.PascalCase;
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build((Class<?>) class3, (Type) class1, propertyNamingStrategy0);
  ...
  public void test16()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("(iH", class0, class2, class2, (Field) null, 0, 79, 6);
  ...
  public void test18()  throws Throwable  {
      Class<String> class0 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("v]|", class0, class0, class0, (Field) null, 137, 137, 137);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<AtomicBoolean> class1 = AtomicBoolean.class;
      Class<FieldInfo> class2 = FieldInfo.class;
      FieldInfo fieldInfo1 = new FieldInfo("v]|", class1, class2, fieldInfo0.fieldType, (Field) null, 137, 137, 137);
  ...
  public void test19()  throws Throwable  {
      ...
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.KebabCase;
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build((Class<?>) class3, (Type) fieldInfo0.declaringClass, propertyNamingStrategy0);
  ...
  public void test20()  throws Throwable  {
      ...
      JavaBeanInfo.add(linkedList0, fieldInfo1);
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
      JavaBeanInfo.build((Class<?>) class2, (Type) class0, propertyNamingStrategy0, false, false);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo0);
