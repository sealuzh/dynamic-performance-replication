...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.minFresh((-570), timeUnit0);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-81), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1460), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(1402, timeUnit0);
  ...
  public void test14()  throws Throwable  {
      ...
      cacheControl_Builder0.maxStale(358, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
  ...
  public void test16()  throws Throwable  {
      ...
      cacheControl_Builder0.maxAge(404, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
  ...
  public void test17()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(404, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      int int0 = cacheControl0.maxAgeSeconds();
      assertEquals(34905600, int0);
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertEquals((-1), cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.isPublic());
      assertEquals((-1), cacheControl0.maxStaleSeconds());
  ...
  public void test22()  throws Throwable  {
      ...
      cacheControl_Builder0.minFresh(358, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
      assertEquals("min-fresh=21480", string0);
  }
  ...
  public void test23()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(358, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      String string0 = cacheControl0.toString();
      assertEquals("max-age=21480", string0);
      assertNotNull(string0);
  }
  ...
  public void test31()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.addLenient("pragma", "S6D2^=\":2;.");
  ...
  public void test32()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("Cache-Control", "]&P<[oEQ_;eL`6uHX");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPublic());
      assertFalse(cacheControl0.isPrivate());
  ...
  public void test33()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("pragma", "no-cache, no-store, max-age=21480, min-fresh=21480");
      Headers headers0 = new Headers(headers_Builder0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.onlyIfCached());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertEquals(21480, cacheControl0.maxAgeSeconds());
      assertTrue(cacheControl0.noStore());
      assertFalse(cacheControl0.noTransform());
      assertTrue(cacheControl0.noCache());
      assertFalse(cacheControl0.isPublic());
      assertEquals(21480, cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.mustRevalidate());
      assertFalse(cacheControl0.isPrivate());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      stringArray0[0] = "82DBZ nEfC#)X";
      stringArray0[1] = "max-age";
      stringArray0[2] = "no-cache";
      stringArray0[3] = "s|~o$gi";
