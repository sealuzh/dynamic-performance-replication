...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        timeout1.waitUntilNotified("T!Ds+>%g-");
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.timeout(2047L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(2047L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1554L));
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(2047L, timeUnit0);
      timeout1.deadline(2047L, timeUnit0);
      assertEquals(2047L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-972L));
      assertSame(timeout1, timeout0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        timeout0.deadline((-600L), timeUnit0);
  ...
  public void test14()  throws Throwable  {
      ...
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(1392409281322047L, long0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(971000000L);
      try { 
        timeout1.waitUntilNotified(timeUnit0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.deadline(971000000L, timeUnit0);
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1111L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1111L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(2122L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeUnit0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.timeout(2169L, (TimeUnit) null);
      assertSame(timeout1, timeout0);
  }
