...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      Class<Object> class0 = Object.class;
      FieldInfo fieldInfo0 = new FieldInfo("YIg<32*zX_P7@__kY@", class0, class0, class0, (Field) null, (-423), (-423), (-423));
  ...
  public void test15()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("YIg<2*zX_=P7@__kY@", class1, class2, class2, (Field) null, (-428), (-428), (-428));
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("YIg<2*zX_=P7@__kY@", class0, class0, class0, (Field) null, (-428), (-428), (-428));
  ...
  public void test16()  throws Throwable  {
      ...
      doReturn("`hq;2").when(jSONType0).typeName();
      JavaBeanInfo javaBeanInfo0 = null;
      try {
        javaBeanInfo0 = new JavaBeanInfo(class0, class0, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      ...
      doReturn("B{8:t").when(jSONType0).typeKey();
      doReturn("B{8:t").when(jSONType0).typeName();
      JavaBeanInfo javaBeanInfo0 = null;
      try {
        javaBeanInfo0 = new JavaBeanInfo(class0, class0, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("2j8Nv*M", class1, class2, class0, (Field) null, (-428), 1011, (-428));
      boolean boolean0 = fieldInfo0.fieldTransient;
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<FieldInfo> class3 = FieldInfo.class;
      String[] stringArray0 = new String[6];
      stringArray0[3] = "2j8Nv*M";
      stringArray0[4] = "2j8Nv*M";
      stringArray0[5] = "2j8Nv*M";
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("").when(jSONType0).typeKey();
      doReturn("2j8Nv*M").when(jSONType0).typeName();
  ...
  public void test19()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("1fNc0.k},.xA}uB", class0, class1, class0, (Field) null, 52429, 52429, (-170));
      linkedList0.addLast(fieldInfo0);
      Class<Annotation> class2 = Annotation.class;
      String[] stringArray0 = new String[26];
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn(">@8Eqjxg.!j").when(jSONType0).typeKey();
      doReturn("Da").when(jSONType0).typeName();
  ...
  public void test20()  throws Throwable  {
      Class<Method> class0 = Method.class;
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      FieldInfo fieldInfo0 = new FieldInfo("^'ko z'b4f;Sh)SNKN", class0, class0, class0, (Field) null, 45, 51, 45);
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<Object> class1 = Object.class;
      FieldInfo fieldInfo1 = new FieldInfo("^'ko z'b4f;Sh)SNKN", class1, class1, fieldInfo0.fieldType, (Field) null, 53, 45, 5);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
      assertTrue(boolean0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn(">@8EqjxPg.!j").when(jSONType0).typeKey();
