...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("jp*e>PR^a8S}LYB=<I8").when(jSONType0).typeKey();
      doReturn("jp*e>PR^a8S}LYB=<I8").when(jSONType0).typeName();
  ...
  public void test19()  throws Throwable  {
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Object> class0 = Object.class;
      FieldInfo fieldInfo0 = new FieldInfo("java.lang.Integer", class0, class0, class0, (Field) null, 994, 994, 994);
