...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(999968L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.deadline(1585L, timeUnit0);
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(138336409281320000L, long0);
  }
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(504L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(1790L);
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        timeout0.deadline((-1341L), timeUnit0);
  ...
  public void test08()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2354L, timeUnit0);
  ...
  public void test09()  throws Throwable  {
      ...
      timeout0.timeout(217L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-453L));
      try { 
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.deadline(999968L, timeUnit0);
      timeout1.throwIfReached();
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline(496L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(496L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(870L, timeUnit0);
      timeout1.deadline(504L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      assertEquals(75168000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.NONE.timeout(1819L, timeUnit0);
  ...
  public void test22()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.deadline(504L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeUnit0);
        fail("Expecting exception: IllegalMonitorStateException");
