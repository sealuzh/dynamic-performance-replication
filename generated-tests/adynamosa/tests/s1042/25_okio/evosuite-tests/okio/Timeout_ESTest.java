...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(20L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1165L));
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(2501L, timeUnit0);
      Object object0 = new Object();
      try { 
        timeout0.waitUntilNotified(object0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.timeout(3866L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(13917600000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime(2543L);
      timeout0.timeout(2543L, timeUnit0);
      assertEquals(2543L, timeout0.timeoutNanos());
  }
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.deadline(20L, timeUnit0);
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.deadline(2853L, timeUnit0);
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(247891609281320000L, long0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals(13917600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline((-1439L), timeUnit0);
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-2719L));
  ...
  public void test17()  throws Throwable  {
      ...
      Timeout timeout2 = timeout1.deadline(1L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(23L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2789L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(2543L, timeUnit0);
      timeout1.deadlineNanoTime(2543L);
      assertEquals(2543L, timeout0.timeoutNanos());
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.NONE.deadline(2543L, timeUnit0);
