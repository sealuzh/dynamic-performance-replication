...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn("b>&%X@e\"1WyC{|=").when(request0).method();
  ...
  public void test02()  throws Throwable  {
      ...
      stringArray0[1] = "z@*UL1j]O9f7V=hWw";
      stringArray0[2] = "5z}'J\"f&C/";
      stringArray0[3] = "T Mh&CMiCX-%M?nzM^";
      stringArray0[4] = "HEAD";
      stringArray0[5] = "endIndex > length(";
      stringArray0[6] = "vary";
      stringArray0[7] = "KrkP&|,VfdeCa+XiBF3";
  ...
  public void test03()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "bnidl2}i(qajecq";
      stringArray0[1] = "bnidl2}i(qajecq";
      stringArray0[2] = "T Mh&CMiCX-%M?nzM^";
      stringArray0[3] = "vary";
      stringArray0[4] = "vary";
      stringArray0[5] = "nexpected char %#04x at %d in header nam: %s";
      stringArray0[6] = "vary";
      stringArray0[7] = "bnidl2}i(qajecq";
      Headers headers0 = Headers.of(stringArray0);
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("SPDY_3", (-1438), (String) null);
  ...
  public void test12()  throws Throwable  {
      ...
      stringArray0[0] = "bnidl2}i(qajecq";
      stringArray0[1] = "bnidl2}i(qajecq";
      stringArray0[2] = "bnidl2}i(qajecq";
      stringArray0[3] = "bnidl2}i(qajecq";
      stringArray0[4] = "vary";
      stringArray0[5] = "nexpected char %#04x at %d in header nam: %s";
      stringArray0[6] = "vary";
      stringArray0[7] = "bnidl2}i(qajecq";
  ...
  public void test14()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("networkResponse", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-815));
      assertEquals((-815), int0);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", (-815));
      assertEquals((-815), int0);
  }
  ...
  public void test17()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "size < 2: ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("Ue7Av|", (-414));
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, 3744);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 97, ",~'tokz9");
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("1", 268);
      assertEquals(1, int0);
  }
  ...
  public void test35()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" +m[^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)", 5);
      assertEquals(6, int0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(",~'tokz9", 1231);
  ...
  public void test38()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("bnidl2}i(qajecq").when(request0).method();
  ...
  public void test39()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("n$n3[;").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test41()  throws Throwable  {
      ...
      doReturn("bnidl2}i(qajecq").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn((-2948)).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("bnidl2}i(qaj*cq").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test44()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "Content-Length";
      stringArray0[1] = "z@UL3j]O9f7V=haw";
      stringArray0[2] = "5z}'J\"f&C/";
      stringArray0[3] = "T Mh&CMiCX-%M?nzM^";
      stringArray0[4] = "HEAD";
      stringArray0[5] = "T Mh&CMiCX-%M?nzM^";
      stringArray0[6] = "vary";
      stringArray0[7] = "&s";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "5z}'J\"f&C/");
  ...
  public void test50()  throws Throwable  {
      ...
      stringArray0[7] = "bnidl2}i(qajecq";
      Headers headers0 = Headers.of(stringArray0);
      List<String> list0 = headers0.values("bnidl2}i(qajecq");
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn(list0, (List) null).when(request0).headers(anyString());
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(headers0).when(response0).headers();
  ...
  public void test53()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "bHXJ\"Krp21)";
      stringArray0[1] = "head";
      stringArray0[2] = "Content-Length";
      stringArray0[3] = "o9?>{0^";
      stringArray0[4] = "content-length";
      stringArray0[5] = "bnidl2}i(qaj*cq";
      stringArray0[6] = ".=CHoW";
      stringArray0[7] = "*NvW\"5*W(]Om";
      Headers headers0 = Headers.of(stringArray0);
      long long0 = HttpHeaders.contentLength(headers0);
      assertEquals((-1L), long0);
  }
