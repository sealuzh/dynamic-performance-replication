...
public class Okio_ESTest extends Okio_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      realBufferedSink0.writeDecimalLong(1714L);
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile("&_(:Xof'Qp");
      try { 
        Okio.source((File) mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".>0:()c!{6zP", ".>0:()c!{6zP");
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("0MzG\"}");
      Sink sink0 = Okio.appendingSink(mockFile0);
      RealBufferedSink realBufferedSink0 = new RealBufferedSink(sink0);
      BufferedSink bufferedSink0 = realBufferedSink0.writeDecimalLong(2544L);
      bufferedSink0.flush();
  ...
  public void test14()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".xA4J^;oG]aSQ4nZ");
      Sink sink0 = Okio.appendingSink(mockFile0);
      assertNotNull(sink0);
  }
  ...
  public void test15()  throws Throwable  {
      File file0 = MockFile.createTempFile("J=Z", "");
      MockFile mockFile0 = new MockFile(file0, "R#S%|{De`N");
      try { 
        Okio.appendingSink(mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test22()  throws Throwable  {
      MockThrowable mockThrowable0 = new MockThrowable("AXe^+z}+");
      AssertionError assertionError0 = new AssertionError("AXe^+z}+", mockThrowable0);
  ...
  public void test35()  throws Throwable  {
      Buffer buffer0 = new Buffer();
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(buffer0);
      buffer0.writeInt((-543));
      InputStream inputStream0 = realBufferedSource0.inputStream();
      Source source0 = Okio.source(inputStream0);
      // Undeclared exception!
      realBufferedSource0.buffer.writeAll(source0);
  }
  ...
  public void test40()  throws Throwable  {
      MockFile mockFile0 = new MockFile("ZAD`gNE?wg");
      Sink sink0 = Okio.appendingSink(mockFile0);
      RealBufferedSink realBufferedSink0 = new RealBufferedSink(sink0);
