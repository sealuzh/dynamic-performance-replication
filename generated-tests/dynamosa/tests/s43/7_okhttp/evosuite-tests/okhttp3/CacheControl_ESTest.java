...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[0] = "cBche-cHntrol";
      stringArray0[1] = "no-store, max-age=0, max-stale=2937600, min-fresh=0";
      stringArray0[2] = "pragma";
      stringArray0[3] = "no-store, max-age=0, max-stale=2937600, min-fresh=0";
      stringArray0[4] = "cBche-cHntrol";
      stringArray0[5] = "no-store, max-age=0, max-stale=2937600, min-fresh=0";
      stringArray0[6] = "cBche-cHntrol";
      stringArray0[7] = "cBche-cHntrol";
      ...
      assertEquals(2937600, cacheControl0.maxStaleSeconds());
  ...
  public void test10()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(3278, timeUnit0);
  ...
  public void test12()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      cacheControl_Builder0.maxStale(875, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
  ...
  public void test14()  throws Throwable  {
      ...
      cacheControl_Builder0.maxAge(512, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
  ...
  public void test15()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      cacheControl_Builder0.maxAge(1982, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      int int0 = cacheControl0.maxAgeSeconds();
      assertEquals(1, int0);
      assertEquals((-1), cacheControl0.maxStaleSeconds());
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-2339), timeUnit0);
  ...
  public void test21()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxStale(2147483622, timeUnit0);
      assertSame(cacheControl_Builder0, cacheControl_Builder1);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-1969716768), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // maxStale < 0: -1969716768
         //
         verifyException("okhttp3.CacheControl$Builder", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1969716773), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals("min-fresh=52531200", string0);
  }
  ...
  public void test34()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.addLenient("Pragma", "lk;");
      Headers headers0 = new Headers(headers_Builder0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.maxStaleSeconds());
  ...
  public void test35()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "cBche-cHntrol";
      stringArray0[1] = "no-store, max-age=151200, max-stale=0, min-fresh=151200";
      stringArray0[2] = "pragma";
      stringArray0[3] = "no-store, max-age=151200, max-stale=0, min-fresh=151200";
      stringArray0[4] = "cBche-cHntrol";
      stringArray0[5] = "no-store, max-age=151200, max-stale=0, min-fresh=151200";
      stringArray0[6] = "cBche-cHntrol";
      stringArray0[7] = "cBche-cHntrol";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      ...
      assertTrue(cacheControl0.noStore());
      assertFalse(cacheControl0.isPrivate());
      assertEquals(151200, cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.isPublic());
      assertEquals(151200, cacheControl0.maxAgeSeconds());
  }
  ...
  public void test36()  throws Throwable  {
      ...
      headers_Builder0.add("cache-control", "_y{.|Xon#A");
      Headers headers0 = new Headers(headers_Builder1);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.minFreshSeconds());
