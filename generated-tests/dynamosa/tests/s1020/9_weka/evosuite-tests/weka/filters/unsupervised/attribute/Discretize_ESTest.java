...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      Instances instances0 = new Instances("${PNa5P+kcg{)U|Ix|K", arrayList0, 2702);
  ...
  public void test003()  throws Throwable  {
      Discretize discretize0 = new Discretize("^Q[6FRn[");
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test007()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      discretize0.setDesiredWeightOfInstancesPerInterval(1901.425715865149);
      double double0 = discretize0.getDesiredWeightOfInstancesPerInterval();
      assertEquals(1901.425715865149, double0, 0.01);
  }
  ...
  public void test025()  throws Throwable  {
      ...
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance((-1468.0861516362318), intArray0, (-3021));
      // Undeclared exception!
      try { 
        discretize0.input(binarySparseInstance0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test026()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("{", arrayList0, 2704);
      ArrayList<String> arrayList1 = new ArrayList<String>();
      Attribute attribute0 = new Attribute("   * Returns only the classnames and what filter it is based on.\n", arrayList1);
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      discretize0.setInputFormat(instances0);
  ...
  public void test030()  throws Throwable  {
      Discretize discretize0 = new Discretize("yRm:l4");
  ...
  public void test031()  throws Throwable  {
      ...
      SparseInstance sparseInstance0 = new SparseInstance((-173.80838113942627), doubleArray0, intArray0, (-970));
      // Undeclared exception!
      try { 
        discretize0.convertInstance(sparseInstance0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test032()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Discretize discretize0 = new Discretize();
      Instances instances0 = new Instances("^Q[AFRn[", arrayList0, 0);
  ...
  public void test038()  throws Throwable  {
      ...
      stringArray0[0] = "No input instance format defined";
      stringArray0[1] = "o#nxN";
      stringArray0[2] = "-";
      try { 
        discretize0.setOptions(stringArray0);
  ...
  public void test039()  throws Throwable  {
      ...
      Discretize discretize0 = new Discretize("egpz6RK,P{lF6fCu0");
      try { 
        discretize0.setOptions(stringArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test040()  throws Throwable  {
      Attribute attribute0 = new Attribute("RBK(s,>HF");
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      Instances instances0 = new Instances("RBK(s,>HF", arrayList0, 0);
      discretize0.setMakeBinary(true);
      try { 
        discretize0.setInputFormat(instances0);
  ...
  public void test041()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("Pm^6E", arrayList0, 2704);
  ...
  public void test046()  throws Throwable  {
      Attribute attribute0 = new Attribute("^Q[6FRn[");
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
  ...
  public void test047()  throws Throwable  {
      Attribute attribute0 = new Attribute("HUy<cg E2e@k=b4v");
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
  ...
  public void test049()  throws Throwable  {
      Attribute attribute0 = new Attribute("+pF{,r:qkz<|J;<)");
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      Instances instances0 = new Instances("real", arrayList0, 0);
  ...
  public void test051()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("!o2", arrayList0, 2704);
  ...
  public void test052()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        discretize0.calculateCutPointsByEqualFrequencyBinning(2758);
  ...
  public void test056()  throws Throwable  {
      Attribute attribute0 = new Attribute("Can only format date values for date attributes!");
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      Instances instances0 = new Instances("real", arrayList0, 0);
  ...
  public void test058()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("O", arrayList0, 2704);
      Attribute attribute0 = new Attribute(".arff");
      arrayList0.add(attribute0);
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
  ...
  public void test081()  throws Throwable  {
      ...
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      discretize0.m_DesiredWeightOfInstancesPerInterval = (double) 2702;
      discretize0.setInputFormat(instances0);
      // Undeclared exception!
      try { 
        discretize0.calculateCutPointsByEqualFrequencyBinning(1);
  ...
  public void test082()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("Pm^6E", arrayList0, 1);
      Attribute attribute0 = new Attribute("@relation");
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      discretize0.setInputFormat(instances0);
  ...
  public void test083()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("l&", arrayList0, 2704);
      Attribute attribute0 = new Attribute(".arff");
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      discretize0.setFindNumBins(true);
  ...
  public void test084()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      discretize0.getBinRangesString((-2289));
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01);
      assertFalse(discretize0.getUseBinNumbers());
      assertFalse(discretize0.getFindNumBins());
  ...
  public void test087()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("BFL6E", arrayList0, 2704);
      Attribute attribute0 = new Attribute("@relation");
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      discretize0.setInputFormat(instances0);
  ...
  public void test088()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("{", arrayList0, 2671);
      Attribute attribute0 = new Attribute(".arff");
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      discretize0.setInputFormat(instances0);
  ...
  public void test093()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("lIb&", arrayList0, 1060);
      Attribute attribute0 = new Attribute(".bsi", 1060);
      arrayList0.add(attribute0);
      Discretize discretize0 = new Discretize();
      discretize0.m_UseEqualFrequency = true;
      discretize0.setFindNumBins(true);
  ...
  public void test100()  throws Throwable  {
      ...
      Instances instances0 = new Instances("Can only format date values for date attributes!", arrayList0, 0);
      boolean boolean0 = discretize0.setInputFormat(instances0);
      assertFalse(boolean0);
