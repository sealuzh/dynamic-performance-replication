...
public class MnMinos_ESTest extends MnMinos_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      FunctionMinimum functionMinimum0 = new FunctionMinimum(minimumSeed0, linkedList0, 4);
  ...
  public void test03()  throws Throwable  {
      FCNBase fCNBase0 = mock(FCNBase.class, new ViolatedAssumptionAnswer());
      MnMinos mnMinos0 = new MnMinos(fCNBase0, (FunctionMinimum) null, (-3729));
      // Undeclared exception!
      try { 
        mnMinos0.minos((-3729));
  ...
  public void test08()  throws Throwable  {
      FCNBase fCNBase0 = mock(FCNBase.class, new ViolatedAssumptionAnswer());
      doReturn((-882.75286), (-882.75286), (-103.13279), 0.05, (-103.13279)).when(fCNBase0).valueOf(any(double[].class));
      ...
      MinimumState minimumState0 = new MinimumState(minimumParameters0, (-712.7251793667732), 10);
      double[] doubleArray0 = new double[8];
      MnUserTransformation mnUserTransformation0 = new MnUserTransformation(doubleArray0, doubleArray0);
      MinimumSeed minimumSeed0 = new MinimumSeed(minimumState0, mnUserTransformation0);
      mnUserTransformation0.add("d@x+`<[CT=", 10, 0.05, (-103.13279), 0.05);
      LinkedList<MinimumState> linkedList0 = new LinkedList<MinimumState>();
      FunctionMinimum functionMinimum0 = new FunctionMinimum(minimumSeed0, (-712.7251793667732));
      mnAlgebraicVector0.clone();
      mnUserTransformation0.add("le3~:|]?!h;WNu", (-103.13279), 0.0);
      mnAlgebraicVector0.clone();
      functionMinimum0.userState();
      LinkedList<MinimumState> linkedList1 = new LinkedList<MinimumState>();
      linkedList1.stream();
      MnMinos mnMinos0 = new MnMinos(fCNBase0, functionMinimum0);
      mnMinos0.range(8, (double) 2, 2);
      // Undeclared exception!
      mnMinos0.lower(8);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      MnUserTransformation mnUserTransformation0 = new MnUserTransformation(doubleArray0, doubleArray0);
      MinimumSeed minimumSeed0 = new MinimumSeed(minimumState0, mnUserTransformation0);
      mnUserTransformation0.add("d@x+`<[CT=", 2924.383914133618, (-753.734231), (-103.13279), (-753.734231));
      LinkedList<MinimumState> linkedList0 = new LinkedList<MinimumState>();
      FunctionMinimum functionMinimum0 = new FunctionMinimum(minimumSeed0, (-753.734231));
      functionMinimum0.add(minimumState0);
      mnAlgebraicVector0.clone();
      mnUserTransformation0.add("leP3~:-|]?!h;WNu", (-103.13279), 0.0);
      functionMinimum0.userState();
      mnAlgebraicVector0.clone();
      functionMinimum0.userState();
      LinkedList<MinimumState> linkedList1 = new LinkedList<MinimumState>();
      ...
      double double0 = mnMinos0.upper(5, 2924.383914133618);
  ...
  public void test10()  throws Throwable  {
      FCNBase fCNBase0 = mock(FCNBase.class, new ViolatedAssumptionAnswer());
      doReturn((-882.75286), (-882.75286), (-101.88443547930305), 0.0, (-101.88443547930305)).when(fCNBase0).valueOf(any(double[].class));
      MnAlgebraicVector mnAlgebraicVector0 = new MnAlgebraicVector(10);
      MinimumParameters minimumParameters0 = new MinimumParameters(mnAlgebraicVector0, mnAlgebraicVector0, (-101.88443547930305));
      MinimumState minimumState0 = new MinimumState(minimumParameters0, (-712.7251793667732), 10);
      double[] doubleArray0 = new double[8];
      MnUserTransformation mnUserTransformation0 = new MnUserTransformation(doubleArray0, doubleArray0);
      mnAlgebraicVector0.clone();
      MinimumSeed minimumSeed0 = new MinimumSeed(minimumState0, mnUserTransformation0);
      mnUserTransformation0.add("d@x+`<[CT=", 2924.383914133618, 0.0, (-101.88443547930305), 0.0);
      LinkedList<MinimumState> linkedList0 = new LinkedList<MinimumState>();
      FunctionMinimum functionMinimum0 = new FunctionMinimum(minimumSeed0, (-712.7251793667732));
      functionMinimum0.add(minimumState0);
      mnAlgebraicVector0.clone();
      mnUserTransformation0.add("le3~:|]?!h;WNu", (-101.88443547930305), 0.0);
      functionMinimum0.userState();
      mnAlgebraicVector0.clone();
      functionMinimum0.userState();
      functionMinimum0.userState();
      LinkedList<MinimumState> linkedList1 = new LinkedList<MinimumState>();
      linkedList1.offer(minimumState0);
      linkedList1.stream();
      linkedList1.add(minimumState0);
      functionMinimum0.add(minimumState0);
      functionMinimum0.userCovariance();
      MnMinos mnMinos0 = new MnMinos(fCNBase0, functionMinimum0);
      mnMinos0.loval(5);
