...
public class Product_ESTest extends Product_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      Product product0 = new Product();
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/THIRD PARTY NEW PRICE - __HEAVY_.XML");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      FullProduct fullProduct0 = product0.getProduct("third party new price - ", "", "");
  ...
  public void test3()  throws Throwable  {
      Product product0 = new Product();
      FullProduct fullProduct0 = product0.getProduct("_^ 9-", "_^ 9-", "|U0]gX2Jo8*_gZ.");
      assertNull(fullProduct0);
  }
}
