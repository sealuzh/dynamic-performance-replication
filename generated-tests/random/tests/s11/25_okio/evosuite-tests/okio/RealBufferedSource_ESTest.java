...
public class RealBufferedSource_ESTest extends RealBufferedSource_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      realBufferedSink0.writeLongLe(1254L);
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(realBufferedSink0.buffer);
      byte[] byteArray0 = realBufferedSource0.readByteArray();
      assertArrayEquals(new byte[] {(byte) (-26), (byte)4, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray0);
  }
  ...
  public void test03()  throws Throwable  {
      Pipe pipe0 = new Pipe(4365L);
      Buffer buffer0 = pipe0.buffer;
      HashingSource hashingSource0 = HashingSource.sha1(buffer0);
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(hashingSource0);
      long long0 = realBufferedSource0.indexOf((byte)32, 570L, 570L);
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        realBufferedSource0.readByteString((-220L));
  ...
  public void test08()  throws Throwable  {
      Pipe pipe0 = new Pipe(3780L);
      Buffer buffer0 = pipe0.buffer;
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(buffer0);
      ByteString byteString0 = ByteString.EMPTY;
      long long0 = realBufferedSource0.indexOfElement(byteString0, 4401L);
      assertEquals((-1L), long0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        realBufferedSource0.readUtf8LineStrict(2911L);
        fail("Expecting exception: EOFException");
  ...
  public void test12()  throws Throwable  {
      Buffer buffer0 = new Buffer();
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(buffer0);
      long long0 = realBufferedSource0.indexOf((byte) (-54), 8L, 8L);
      assertEquals((-1L), long0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        realBufferedSource0.indexOf((byte) (-43), 65536L, 5392L);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // fromIndex=65536 toIndex=5392
         //
         verifyException("okio.RealBufferedSource", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      Buffer buffer0 = new Buffer();
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(buffer0);
      realBufferedSource0.skip((-1390L));
  }
  ...
  public void test18()  throws Throwable  {
      ...
      ByteString byteString0 = ByteString.encodeUtf8("Znnh");
  ...
  public void test22()  throws Throwable  {
      ...
      ByteString byteString0 = ByteString.encodeString("`.\"+e+{m(N", charset0);
      HashingSource hashingSource0 = HashingSource.hmacSha1(buffer0, byteString0);
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(hashingSource0);
      long long0 = realBufferedSource0.read(buffer0, 679L);
      assertEquals((-1L), long0);
  }
  ...
  public void test33()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        realBufferedSource0.indexOf((byte)34, (long) (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test37()  throws Throwable  {
      Buffer buffer0 = new Buffer();
      ByteString byteString0 = ByteString.encodeUtf8("`.\"+e+{m(N");
      HashingSource hashingSource0 = HashingSource.hmacSha1(buffer0, byteString0);
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(hashingSource0);
  ...
  public void test44()  throws Throwable  {
      Buffer buffer0 = new Buffer();
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(buffer0);
      ByteString byteString0 = ByteString.encodeUtf8("p,)EdwLZ6DvLgt");
      long long0 = realBufferedSource0.indexOfElement(byteString0);
      assertEquals((-1L), long0);
  }
