...
public class ICSSearchAlgorithm_ESTest extends ICSSearchAlgorithm_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Instances instances0 = new Instances("5Ai^q.70n7~Bb9C", arrayList0, 1);
      BayesNet bayesNet0 = new BayesNet();
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      boolean[][] booleanArray0 = new boolean[3][5];
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next((-1952), 2, 2, booleanArray0);
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet(2598, 1, 0, booleanArray0);
  ...
  public void test02()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("cAi^q.7Tn7~Bb69@", arrayList0, 303);
      iCSSearchAlgorithm0.setMaxCardinality(303);
      BayesNet bayesNet0 = new BayesNet();
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      iCSSearchAlgorithm0.existsSepSet(303, (-1253), 303, (boolean[][]) null);
      assertEquals(303, iCSSearchAlgorithm0.getMaxCardinality());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet(0, (-38), 1, (boolean[][]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test04()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Attribute attribute0 = new Attribute("5Ai^q.70n7~Bb9@");
      arrayList0.add(attribute0);
      Instances instances0 = new Instances("5Ai^q.70n7~Bb9@", arrayList0, 290);
      arrayList0.add(attribute0);
      arrayList0.add(attribute0);
      try { 
  ...
  public void test07()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ICSSearchAlgorithm.SeparationSet iCSSearchAlgorithm_SeparationSet0 = iCSSearchAlgorithm0.new SeparationSet();
      iCSSearchAlgorithm0.setMaxCardinality((-4187));
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains(964);
      assertEquals((-4187), iCSSearchAlgorithm0.getMaxCardinality());
      assertFalse(boolean0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      int int0 = iCSSearchAlgorithm0.next((-1), 11, 11, booleanArray0);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
      assertEquals(0, int0);
  }
  ...
  public void test09()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("5Ai^q.70n7~Bb9@", arrayList0, 277);
      iCSSearchAlgorithm0.search((BayesNet) null, instances0);
      int int0 = iCSSearchAlgorithm0.next(277, 277, 277, (boolean[][]) null);
  ...
  public void test11()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("K*: An Instance-based Learner Using an Entropic Distance Measure", arrayList0, 106);
      iCSSearchAlgorithm0.search((BayesNet) null, instances0);
  ...
  public void test12()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality((-417));
  ...
  public void test16()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("5Ai^q.70n7~BQb9C", arrayList0, 1);
  ...
  public void test19()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("RTL[s'w>oXs}~KY*x{", arrayList0, 142);
      LinkedList<String> linkedList0 = new LinkedList<String>();
      Attribute attribute0 = new Attribute("U^mDu8r^Ws1(T^", linkedList0, (-378));
      arrayList0.add(attribute0);
      BayesNet bayesNet0 = new BayesNet();
      bayesNet0.m_Instances = instances0;
      try { 
  ...
  public void test20()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("B$gr.Vl$9zK", arrayList0, 293);
      BayesNet bayesNet0 = new BayesNet();
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next(1000, 2, 1000, booleanArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      stringArray0[0] = "J^)=)[?qQ0iV/W?RU<Y";
      stringArray0[1] = "d*!L'Q]?FszWw{!/r";
      stringArray0[2] = "-";
      try { 
        iCSSearchAlgorithm0.setOptions(stringArray0);
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[0] = "],uYOnPurc#Ma_a";
      stringArray0[1] = "-cardinality";
      stringArray0[2] = "],uYOnPurc#Ma_a";
      try { 
        iCSSearchAlgorithm0.setOptions(stringArray0);
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"],uYOnPurc#Ma_a\"
         //
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next((-3238), (-3238), (-3238), (boolean[][]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("5Ai^q.70n7~Bb9@", arrayList0, 286);
      iCSSearchAlgorithm0.search((BayesNet) null, instances0);
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.name((-991));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test42()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality((-59));
      boolean[][] booleanArray0 = new boolean[0][5];
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet((-1850), (-709), (-709), booleanArray0);
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet((-980), (-980), (-980), (boolean[][]) null);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next((-532), (-959), 2, booleanArray0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test52()  throws Throwable  {
      ...
      iCSSearchAlgorithm0.existsSepSet(277, 277, 2, booleanArray0);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      intArray0[0] = (-1);
      iCSSearchAlgorithm_SeparationSet0.m_set = intArray0;
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains(92);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
      assertFalse(boolean0);
  }
