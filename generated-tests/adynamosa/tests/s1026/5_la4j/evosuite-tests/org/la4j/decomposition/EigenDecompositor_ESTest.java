...
public class EigenDecompositor_ESTest extends EigenDecompositor_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      SparseMatrix sparseMatrix0 = SparseMatrix.identity(19);
      EigenDecompositor eigenDecompositor0 = new EigenDecompositor(sparseMatrix0);
      ColumnMajorSparseMatrix columnMajorSparseMatrix0 = ColumnMajorSparseMatrix.zero(19, 791);
  ...
  public void test09()  throws Throwable  {
      double[] doubleArray0 = new double[13];
      doubleArray0[3] = (-7.034642866579501);
  ...
  public void test12()  throws Throwable  {
      double[] doubleArray0 = new double[13];
      doubleArray0[7] = (double) 3;
      doubleArray0[3] = 2.0000000000000004;
      doubleArray0[6] = (double) 3;
      DenseMatrix denseMatrix0 = DenseMatrix.from1DArray(3, 3, doubleArray0);
      EigenDecompositor eigenDecompositor0 = new EigenDecompositor(denseMatrix0);
      Matrix[] matrixArray0 = eigenDecompositor0.decompose();
  ...
  public void test14()  throws Throwable  {
      ...
      EigenDecompositor eigenDecompositor0 = new EigenDecompositor(denseMatrix0);
      eigenDecompositor0.decompose();
      assertArrayEquals(new double[] {0.0, 0.0, 0.0, (-7.034642866579501), 0.0, 3.0, 3.0, 0.0, 0.0}, doubleArray0, 0.01);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      EigenDecompositor eigenDecompositor0 = new EigenDecompositor(sparseMatrix0);
      Matrix matrix0 = eigenDecompositor0.matrix.copyOfColumns(32);
      boolean boolean0 = eigenDecompositor0.applicableTo(matrix0);
  ...
  public void test16()  throws Throwable  {
      SparseMatrix sparseMatrix0 = SparseMatrix.identity(46);
      EigenDecompositor eigenDecompositor0 = new EigenDecompositor(sparseMatrix0);
      ColumnMajorSparseMatrix columnMajorSparseMatrix0 = ColumnMajorSparseMatrix.zero(791, 46);
      eigenDecompositor0.matrix = (Matrix) columnMajorSparseMatrix0;
      // Undeclared exception!
      try { 
        eigenDecompositor0.decompose();
  ...
  public void test17()  throws Throwable  {
      Matrix matrix0 = Matrix.constant(4, 4, 19.2250123073381);
      EigenDecompositor eigenDecompositor0 = new EigenDecompositor(matrix0);
      Matrix[] matrixArray0 = eigenDecompositor0.decompose();
      assertEquals(2, matrixArray0.length);
  }
