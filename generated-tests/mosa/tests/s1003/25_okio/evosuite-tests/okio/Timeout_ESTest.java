...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-116L));
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(107222400000000000L, timeUnit0);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1494000000000000L);
      timeout0.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-3786L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(950L);
      try { 
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1555200000000000L);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(107222400000000003L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeout1);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test16()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1363L, timeUnit0);
      Timeout timeout2 = timeout1.deadlineNanoTime(1363L);
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(39L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(39L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
