...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime((-1568L));
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(2254L, timeUnit0);
      try { 
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        timeout1.waitUntilNotified("jAl{_ffB56h!48`WP/d");
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test02()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(3694L, timeUnit0);
      TimeUnit timeUnit1 = TimeUnit.HOURS;
      timeout1.deadline(2219L, timeUnit1);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified("|E+MP]cMnc:v@");
  ...
  public void test04()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1188L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(4276800000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime(668L);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(725L);
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(1159L, timeUnit0);
      timeout1.deadlineNanoTime(668L);
      assertEquals(100137600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      timeout0.timeout(829L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(829000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-3290L), timeUnit0);
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-384L));
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(63L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1817L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1308L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.timeout(2254L, timeUnit0);
      timeout0.deadline(253L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.NONE.timeout((-3124L), timeUnit0);
