...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.deadlineNanoTime((-2872L));
      timeout0.timeout(2870L, timeUnit0);
      assertEquals(172200000000000L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-2872L));
  ...
  public void test08()  throws Throwable  {
      ...
      timeout0.timeout(1159L, timeUnit0);
      timeout0.deadline(1159L, timeUnit0);
      assertEquals(1159L, timeout0.timeoutNanos());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(283L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-3000L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(2804L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-1501L));
  ...
  public void test31()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(14245200000000000L);
      // Undeclared exception!
      try { 
