...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(98L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(2263L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      ...
      assertSame(timeout0, timeout2);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(3837L);
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-26259L));
      long long0 = timeout0.deadlineNanoTime();
      assertEquals((-26259L), long0);
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(98L, timeUnit0);
      timeout1.deadline(98L, timeUnit0);
      assertEquals(98L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2502L);
  ...
  public void test10()  throws Throwable  {
      ...
      timeout0.timeout(2081L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(7491600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2502L);
  ...
  public void test18()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(3805L, timeUnit0);
      timeout0.deadlineNanoTime(3805L);
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1278L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(";hg4PTrWEL&mpE/f w@");
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test21()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(98L);
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1064L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(61L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.NONE.timeout(777L, timeUnit0);
