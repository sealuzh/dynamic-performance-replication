...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-1060L));
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-128177L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1882L, timeUnit0);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(4108L);
      try { 
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(10598400000000000L);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(1000000000L, timeUnit0);
      timeout1.deadlineNanoTime(1000000000L);
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(3069L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3069L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
