...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(225, byteOrder0, myLzwDecompressor_Listener0);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress((InputStream) null, 1687);
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(mockFileInputStream0, (-2991));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -2991
         //
  ...
  public void test05()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = null;
      try {
        myLzwDecompressor0 = new MyLzwDecompressor((byte) (-12), byteOrder0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test06()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((byte)2, (ByteOrder) null, (MyLzwDecompressor.Listener) null);
  ...
  public void test08()  throws Throwable  {
      ...
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      try { 
        myLzwDecompressor0.decompress(dataInputStream0, 4075);
        fail("Expecting exception: IOException");
  ...
  public void test10()  throws Throwable  {
      ...
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      try { 
        myLzwDecompressor0.decompress(dataInputStream0, (byte)70);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Bad Code: 383 codes: 258 code_size: 9, table: 4096
         //
         verifyException("org.apache.commons.imaging.common.mylzw.MyLzwDecompressor", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      byteArray0[1] = (byte)13;
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream0, (byte)3);
      assertEquals(0, byteArrayInputStream0.available());
      assertArrayEquals(new byte[] {(byte)6, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals(0, byteArrayInputStream0.available());
      assertArrayEquals(new byte[] {(byte)14, (byte)0, (byte)0, (byte)0}, byteArray1);
  }
}
