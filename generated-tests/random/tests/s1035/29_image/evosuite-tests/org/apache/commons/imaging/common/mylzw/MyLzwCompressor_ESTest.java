...
public class MyLzwCompressor_ESTest extends MyLzwCompressor_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor((-1720), byteOrder0, true, myLzwCompressor_Listener0);
  ...
  public void test2()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.BIG_ENDIAN;
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(1026, byteOrder0, true);
      byte[] byteArray0 = new byte[4];
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
      assertEquals(771, byteArray1.length);
  }
  ...
  public void test4()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[4];
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
      assertArrayEquals(new byte[] {(byte)0, (byte)1, (byte)8, (byte)4, (byte)16, (byte)16}, byteArray1);
  }
}
