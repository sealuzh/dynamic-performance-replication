...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        timeout0.deadline((-758L), timeUnit0);
  ...
  public void test04()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(952L);
  ...
  public void test06()  throws Throwable  {
      ...
      timeout0.timeout(628L, timeUnit0);
      assertEquals(37680000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      timeout0.timeout(774L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1392409281319195L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // timeout < 0: -1392409281319195
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(731L);
      try { 
        timeout0.throwIfReached();
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.deadline(628L, timeUnit0);
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1407L));
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.timeout(774L, timeUnit0);
      Timeout timeout1 = timeout0.deadline(774L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(774L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(774L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
