...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      timeout0.NONE.timeout((-807L), timeUnit0);
  ...
  public void test06()  throws Throwable  {
      ...
      timeout0.NONE.deadline(37L, timeUnit0);
      Timeout timeout1 = timeout0.clearDeadline();
      assertEquals(0L, timeout1.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-269L));
      try { 
        timeout0.throwIfReached();
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test14()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1477L, timeUnit0);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(979L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
