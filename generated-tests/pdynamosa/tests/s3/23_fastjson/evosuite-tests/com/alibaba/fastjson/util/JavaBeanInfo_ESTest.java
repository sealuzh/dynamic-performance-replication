...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("f+eld", class0, class1, class1, (Field) null, 13, 13, 13);
  ...
  public void test13()  throws Throwable  {
      Constructor<LinkedList<String>>[] constructorArray0 = (Constructor<LinkedList<String>>[]) Array.newInstance(Constructor.class, 1);
      Class<Object> class0 = Object.class;
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      Constructor<LinkedList<String>>[] constructorArray0 = (Constructor<LinkedList<String>>[]) Array.newInstance(Constructor.class, 8);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("m=\u0003CdKx/kz", class1, class0, class0, (Field) null, 25, 25, 25);
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("m=\u0003CdKx/kz", class0, class0, class0, (Field) null, (-941), (-2695), (-941));
  ...
  public void test29()  throws Throwable  {
      ...
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Integer> class1 = Integer.class;
      FieldInfo fieldInfo0 = new FieldInfo("serialzeFeatures", class1, class0, class1, (Field) null, 0, 0, 0);
      FieldInfo fieldInfo1 = new FieldInfo("serialzeFeatures", class1, class1, class0, (Field) null, (-4808), (-1396), 0);
  ...
  public void test30()  throws Throwable  {
      ...
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Integer> class1 = Integer.class;
      FieldInfo fieldInfo0 = new FieldInfo("serialzeFeatures", class1, class0, class1, (Field) null, 0, (-2), (-2));
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("serialzeFeatures", class1, class1, class0, (Field) null, (-4808), (-1396), 0);
  ...
  public void test34()  throws Throwable  {
      ...
      doReturn("4G#<ZA}-=").when(jSONType0).typeKey();
      doReturn("4G#<ZA}-=").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<AtomicInteger> class0 = AtomicInteger.class;
      Class<Object> class1 = Object.class;
      FieldInfo fieldInfo0 = new FieldInfo("AmkB%KEO1/$:tbM", class1, class1, class1, (Field) null, (-3128), (-1024), (-3128));
      linkedList0.add(fieldInfo0);
  ...
  public void test35()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("Q+ bIlU(Of2CiYH_").when(jSONType0).typeKey();
      doReturn("Q+ bIlU(Of2CiYH_").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
