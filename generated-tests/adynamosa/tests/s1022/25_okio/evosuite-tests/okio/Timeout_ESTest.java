...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1211L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1434L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(1434000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2145L);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.timeout(1434L, timeUnit0);
      timeout0.deadlineNanoTime(1434L);
      assertEquals(1434000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1026L));
      long long0 = timeout1.deadlineNanoTime();
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(4979L, timeUnit0);
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2145L);
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Object object0 = new Object();
      Timeout timeout1 = timeout0.deadlineNanoTime((-348L));
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout1.timeout(2070L, timeUnit0);
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-651L), (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-57L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
