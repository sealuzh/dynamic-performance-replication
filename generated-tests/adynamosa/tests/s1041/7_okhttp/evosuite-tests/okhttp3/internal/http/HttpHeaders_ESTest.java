...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn(308).when(response0).code();
  ...
  public void test02()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Q-DU3Zrme&* R[boz|H").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "Ac*ayy[E";
      stringArray0[1] = "Ac*ayy[E";
      stringArray0[2] = "f\"6|6#";
      stringArray0[3] = " +([^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)";
      stringArray0[4] = "Vary";
      stringArray0[5] = "Vary";
  ...
  public void test06()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("Expected alternating header names and values", (-477));
  ...
  public void test11()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("g*4r Gvqx^T", 0);
      assertEquals(0, int0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      URL uRL1 = MockURL.URL(uRL0, "rKE?w~hs");
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("N;`Gcd", (-323));
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-477));
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil(")mZJq&34Z*Qt*5/", (-477), "Expected alternating header names and values");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test39()  throws Throwable  {
      ...
      stringArray0[1] = "Ac*ayy[E";
      stringArray0[2] = "f\"6|6#";
      stringArray0[3] = "Ac*ayy[E";
      stringArray0[4] = "Vary";
      stringArray0[5] = "!,)R<52K-~]";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test43()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("7", 828);
      assertEquals(7, int0);
  }
  ...
  public void test46()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("[p/r3", 0, "[p/r3");
      assertEquals(0, int0);
  }
  ...
  public void test47()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("H=$%do6.gQ>5E)aEC@k").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test48()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn(")mZJq&34Z*Qt*5/").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test49()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("x*PAXr}F HuR\"fc@").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test53()  throws Throwable  {
      ...
      stringArray0[5] = "Vary";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "f\"6|6#");
  ...
  public void test54()  throws Throwable  {
      ...
      hashMap0.merge("Vary", "content-length", biFunction0);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(headers0).when(response0).headers();
  ...
  public void test55()  throws Throwable  {
      ...
      BiFunction<String, String, String> biFunction0 = (BiFunction<String, String, String>) mock(BiFunction.class, new ViolatedAssumptionAnswer());
      hashMap0.merge("Vary", "content-length", biFunction0);
      hashMap0.put("Sary", "Sary");
      hashMap0.put(".ZpKt+-0", "Vary");
      hashMap0.replace("content-length", "Dd");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      ...
      HttpHeaders.parseChallenges(headers1, "Sary");
      URL uRL0 = MockURL.getHttpExample();
      headers0.names();
      HttpUrl.get(uRL0);
      HttpUrl.get(uRL0);
      ...
      HttpHeaders.varyHeaders(headers0, headers3);
      HashMap<String, String> hashMap1 = new HashMap<String, String>();
      Headers.of((Map<String, String>) hashMap1);
      Headers.of((Map<String, String>) hashMap1);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(headers2).when(response0).headers();
  ...
  public void test56()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Length", "#DIbf$/ y");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      long long0 = HttpHeaders.contentLength(headers0);
      assertEquals((-1L), long0);
  }
  ...
  public void test57()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("dIg").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
