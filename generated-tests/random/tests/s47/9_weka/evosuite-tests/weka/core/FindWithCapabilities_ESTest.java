...
public class FindWithCapabilities_ESTest extends FindWithCapabilities_ESTest_scaffolding {
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "(ct;vH(1QWY<2ly3(]";
      stringArray0[1] = "";
      stringArray0[2] = "^{q![0Bl";
      stringArray0[3] = "-only-multiinstance";
      stringArray0[4] = "1Er<d}cW9:o";
      stringArray0[5] = "p";
      stringArray0[6] = "jqlv~bsa\"y#WpKL";
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "WK<3J4";
      stringArray0[1] = "'Cv{$<p6Y-4";
      stringArray0[2] = "SH(w04fc~+Y>&Z@(^h<";
      stringArray0[3] = "-no-class";
      stringArray0[4] = "ByKk)%MZ";
      stringArray0[5] = "'!";
      stringArray0[6] = "}[kA$*=gR";
      try { 
        findWithCapabilities0.setOptions(stringArray0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test34()  throws Throwable  {
      FindWithCapabilities findWithCapabilities0 = new FindWithCapabilities();
      findWithCapabilities0.setClassIndex(">08^0c");
      findWithCapabilities0.setFilename(">08^0c");
      String[] stringArray0 = findWithCapabilities0.getOptions();
      FindWithCapabilities.main(stringArray0);
      assertEquals(">08^0c", findWithCapabilities0.getFilename());
