...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", (-1605));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("0qY.K", 6);
      assertEquals(6, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn("vnry").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(2782).when(response0).code();
  ...
  public void test03()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Ra@&").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "do&b;p}1";
      stringArray0[1] = "do&b;p}1";
      stringArray0[2] = "vary";
      stringArray0[3] = "vary";
  ...
  public void test05()  throws Throwable  {
      ...
      stringArray0[1] = "vary";
      stringArray0[2] = "vary";
      stringArray0[3] = "s,_>YGN2[n](0$($";
      stringArray0[4] = "vary";
      stringArray0[5] = "vary";
      stringArray0[6] = "vary";
      stringArray0[7] = "`s31bTrG/?M";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("s'", 0, "");
      assertEquals(2, int0);
  }

  @Test(timeout = 4000)
  public void test14()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("s'", 0, "s'");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 401, "([^ \"=]*)");
  ...
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-1904));
  ...
  public void test27()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x7f at 0 in vary value: do&b;p}1
         //
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("Luxus!k%sC Eu,", (-1717986916));
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, 2360);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-3140), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[3] = "s'";
      stringArray0[4] = "s'";
      stringArray0[5] = "do&b;p}1";
      stringArray0[6] = "s'";
      stringArray0[7] = "do&b;p}1";
      Headers headers0 = Headers.of(stringArray0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
  ...
  public void test36()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("6", 2147483645);
      assertEquals(6, int0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-6", 9);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" AO=:E&pL!(my", 0);
      assertEquals(1, int0);
  }
  ...
  public void test39()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("~hfull", (-89), "~hfull");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test41()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("HTP@_1").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(167).when(response0).code();
      doReturn("HTP@_1").when(response0).header(anyString());
      doReturn(headers0).when(response0).headers();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertFalse(boolean0);
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("&xg5?({95O>z").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("vK&").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test47()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vaQy", "vaQy");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "vaQy");
      assertEquals(0, list0.size());
  }
