...
public class MyLzwCompressor_ESTest extends MyLzwCompressor_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor((-2747), byteOrder0, true);
  ...
  public void test3()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.BIG_ENDIAN;
      MyLzwCompressor.Listener myLzwCompressor_Listener0 = mock(MyLzwCompressor.Listener.class, new ViolatedAssumptionAnswer());
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(449, byteOrder0, false, myLzwCompressor_Listener0);
      byte[] byteArray0 = new byte[2];
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
      assertEquals(282, byteArray1.length);
  }
  ...
  public void test4()  throws Throwable  {
      ...
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(2, byteOrder0, true, (MyLzwCompressor.Listener) null);
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
      assertArrayEquals(new byte[] {(byte) (-124), (byte) (-95), (byte)0}, byteArray1);
  }
