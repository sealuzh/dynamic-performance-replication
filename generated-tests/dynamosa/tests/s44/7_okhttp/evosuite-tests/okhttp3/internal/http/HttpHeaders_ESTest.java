...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("8", 12);
      assertEquals(8, int0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("$y", 69);
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn("+EiD").when(request0).method();
  ...
  public void test03()  throws Throwable  {
      ...
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("!Ef").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(100).when(response0).code();
      doReturn("!Ef").when(response0).header(anyString());
  ...
  public void test04()  throws Throwable  {
      ...
      hashMap0.put("Vary", "F,_X+1U>&uT6T6");
  ...
  public void test05()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "?Wr&}Io";
      stringArray0[1] = "HEAD";
      stringArray0[2] = "okhttp3.RequestBody$1";
      stringArray0[3] = "okhttp3.RequestBody$1";
      stringArray0[4] = "HEAD";
      stringArray0[5] = "HEAD";
      Headers headers0 = Headers.of(stringArray0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test10()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" must Gave a r9quest body.", 5);
      assertEquals(6, int0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 14, "");
  ...
  public void test13()  throws Throwable  {
      ...
      URL uRL1 = MockURL.URL(uRL0, "aeN$+8 ?=exyu2N");
  ...
  public void test15()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("kMy66F9cuN", (-707));
  ...
  public void test20()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "must gave a r9quest boy.");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("$", (-2790));
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("G:Lh|h'!&OE0-HH58", (-1112), "G:Lh|h'!&OE0-HH58");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("O_!iC7", 0, "O_!iC7");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("U0", 0, "\u0004^ T3");
      assertEquals(2, int0);
  }
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("-]TG'zgYc*").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test45()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("p>yT~8 ^ozL~v?w%a;0").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(74).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test47()  throws Throwable  {
      ...
      doReturn("p>yT~8 ^ozL~v?w%a;0").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(597).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test48()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("aeN$8 =exyu2V", "aeN$8 =exyu2V");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "aeN$8 =exyu2V");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test49()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("; realmet=guqf-8", "; realmet=guqf-8");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "; realmet=guqf-8");
  ...
  public void test50()  throws Throwable  {
      String[] stringArray0 = new String[2];
      stringArray0[0] = "okhttp3.RequestBody$1";
      stringArray0[1] = "okhttp3.RequestBody$1";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "okhttp3.RequestBody$1");
      assertEquals(0, list0.size());
  }
  ...
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put(" must have a request body.", "aC2c-[*kfQ[{d?NOH");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      boolean boolean0 = HttpHeaders.hasVaryAll(headers0);
      assertFalse(boolean0);
  }
