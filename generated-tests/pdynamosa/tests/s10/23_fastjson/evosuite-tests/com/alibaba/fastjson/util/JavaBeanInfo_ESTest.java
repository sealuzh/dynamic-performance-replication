...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test26()  throws Throwable  {
      ...
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.KebabCase;
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build((Class<?>) class0, (Type) class0, propertyNamingStrategy0);
      FieldInfo fieldInfo0 = new FieldInfo("com.alibaba.fastjson.util.FieldInfo", (Class<?>) null, javaBeanInfo0.clazz, javaBeanInfo0.clazz, (Field) null, 27, 27, 27);
      Class<Object> class1 = Object.class;
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build(fieldInfo0.fieldClass, (Type) class1, propertyNamingStrategy0, true, false);
  ...
  public void test30()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("&k:w{H-{O#2j=", class0, class1, class0, (Field) null, 512, 512, 79);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("&k:w{H-{O#2j=", class1, class0, fieldInfo0.fieldType, (Field) null, (-1244), 1700, 32);
  ...
  public void test33()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build(javaBeanInfo0.clazz, (Type) null, (PropertyNamingStrategy) null, false, true);
  ...
  public void test34()  throws Throwable  {
      ...
      doReturn("Form1a,t").when(jSONType0).typeKey();
      doReturn("Form1a,t").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Object> class0 = Object.class;
      Class<Void> class1 = Void.class;
      FieldInfo fieldInfo0 = new FieldInfo("Form1a,t", class0, class1, class0, (Field) null, 284, 102, (-60));
      linkedList0.add(fieldInfo0);
      linkedList0.add(fieldInfo0);
  ...
  public void test35()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "Form1at";
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("Form1at").when(jSONType0).typeKey();
      doReturn("Form1at").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Object> class0 = Object.class;
      Class<Void> class1 = Void.class;
      FieldInfo fieldInfo0 = new FieldInfo("Form1at", class0, class1, class0, (Field) null, 284, 102, (-60));
      linkedList0.add(fieldInfo0);
      Class<AtomicInteger> class2 = AtomicInteger.class;
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class2, class2, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      assertEquals(0, javaBeanInfo0.defaultConstructorParameterSize);
  ...
  public void test36()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("*lgC|HJ").when(jSONType0).typeKey();
      doReturn("*lgC|HJ").when(jSONType0).typeName();
