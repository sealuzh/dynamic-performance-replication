...
public class PageModelExtractor_ESTest extends PageModelExtractor_ESTest_scaffolding {
  ...
  public void test5()  throws Throwable  {
      ...
      pageModelExtractor0.process(page0);
      Page page1 = Page.fail();
      Request request0 = new Request("Only one of 'ExtractBy ComboExtract ExtractByUrl' can be added to a field!");
      request0.addHeader((String) null, (String) null);
      request0.addHeader("Only one of 'ExtractBy ComboExtract ExtractByUrl' can be added to a field!", "Only one of 'ExtractBy ComboExtract ExtractByUrl' can be added to a field!");
      page1.setRequest(request0);
      pageModelExtractor0.process(page1);
      pageModelExtractor0.process(page1);
      pageModelExtractor0.getHelpUrlPatterns();
      page1.setStatusCode(2199);
      pageModelExtractor0.getClazz();
      pageModelExtractor0.process(page1);
      ...
      pageModelExtractor1.getTargetUrlPatterns();
      PageModelExtractor.create(class0);
      List<Pattern> list1 = pageModelExtractor2.getTargetUrlPatterns();
