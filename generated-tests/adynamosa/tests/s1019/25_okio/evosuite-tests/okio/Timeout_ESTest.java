...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(1268L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime(1268L);
      Timeout timeout1 = timeout0.timeout(1268L, timeUnit0);
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.timeout(15L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(54000000000000L, long0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      timeout1.deadlineNanoTime((-5113L));
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-3027L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test10()  throws Throwable  {
      ...
      timeout0.timeout(568L, timeUnit0);
      timeout0.deadline(568L, timeUnit0);
      assertEquals(568000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime(1507L);
      assertSame(timeout0, timeout1);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline((-252L), timeUnit0);
  ...
  public void test17()  throws Throwable  {
      ...
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(1392409281321268L, long0);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(5L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(1268L, timeUnit0);
      timeout1.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2345L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
