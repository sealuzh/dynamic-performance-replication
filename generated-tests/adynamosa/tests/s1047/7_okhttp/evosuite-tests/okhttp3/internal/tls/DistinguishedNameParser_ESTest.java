...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("ou=4dl1ga");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("7mD`0)K],/P:r&f1?L7[");
      assertNull(string0);
  }
  ...
  public void test2()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("O=!14(G~a=Z");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
  ...
  public void test4()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("O=4(G~aZ");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("o");
      assertNotNull(string0);
      assertEquals("4(G~aZ", string0);
  }
  ...
  public void test6()  throws Throwable  {
      ...
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("by`>a&hkjdw_");
      assertNull(string0);
  }
}
