...
public class DynamicSelectModel_ESTest extends DynamicSelectModel_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Label label0 = new Label(errorPage0, "6g<eC:");
      Any any0 = new Any(label0, "6g<eC:");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getLabel(497);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("<>Kwr.pUEG=CNw)jYY");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.translateValue("<>Kwr.pUEG=CNw)jYY");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Expression <>Kwr.pUEG=CNw)jYY evaluated to an object that is not an instance of Collection or Object[]. Can't build a dynamic ISelectModel
         //
         verifyException("wheel.util.DynamicSelectModel", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel1.getValue(1019);
        fail("Expecting exception: RuntimeException");
  ...
  public void test20()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("{g#'zCWSb3?NQ");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Could not evaluate expression {g#'zCWSb3?NQ.values() to create a dynamic ISelectModel.
         //
         verifyException("wheel.components.ElExpression", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      DynamicSelectModel dynamicSelectModel2 = dynamicSelectModel1.label("asset/");
      // Undeclared exception!
      try { 
        dynamicSelectModel2.getLabel((-2099));
        fail("Expecting exception: RuntimeException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel1.getLabel((-2417));
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      ErrorPage errorPage0 = new ErrorPage();
      ActionExpression actionExpression0 = new ActionExpression("cNOz]{K");
  ...
  public void test28()  throws Throwable  {
      ...
      Any any0 = new Any(errorPage0, actionExpression0);
      DynamicSelectModel dynamicSelectModel0 = any0.selectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.label("cNOz]{K");
      DynamicSelectModel dynamicSelectModel2 = dynamicSelectModel1.collection("cNOz]{K");
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      ...
      Any any0 = new Any(errorPage0, actionExpression0);
      DynamicSelectModel dynamicSelectModel0 = any0.selectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.translator("cNOz]{K");
      assertSame(dynamicSelectModel1, dynamicSelectModel0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getValue((-596));
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      ...
      Any any0 = new Any(errorPage0, actionExpression0);
      DynamicSelectModel dynamicSelectModel0 = any0.selectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.value("V+.%~sCb<7pFh\"Ot;NA");
      assertSame(dynamicSelectModel0, dynamicSelectModel1);
  }
  ...
  public void test40()  throws Throwable  {
      ...
      Any any0 = new Any(errorPage0, actionExpression0);
      DynamicSelectModel dynamicSelectModel0 = any0.selectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("cNOz]{K");
      // Undeclared exception!
      try { 
