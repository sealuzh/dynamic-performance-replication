...
public class Library_ESTest extends Library_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      library0.getDictionaries();
      library0.loadFromDirectory("G1");
      library0.loadFromDirectory("G1");
      library0.getDictionary("G1");
      library0.getDictionaries();
      library0.getDictionaries();
      library0.getDictionaries();
      library0.getDictionaries();
  ...
  public void test2()  throws Throwable  {
      Library library0 = new Library();
      library0.getDictionaries();
      library0.getDictionary("0^");
      library0.getDictionaries();
      library0.getDictionary("0^");
      library0.getDictionaries();
      library0.getDictionaries();
      library0.loadFromDirectory("PaDddbs-h#nhQL4t");
      library0.getDictionaries();
      ...
      library0.getDictionaries();
      library0.getDictionaries();
      library0.getDictionary("5=XQQD");
      DictionaryInfo dictionaryInfo0 = library0.getDictionary("d&WR#~");
