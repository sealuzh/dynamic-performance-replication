...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn("BP(3").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(1214).when(response0).code();
  ...
  public void test02()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("BJ(r").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-1869), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("]/#~d+_*k@#Co", (-1065));
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("VMBY%~*p+a", (-1941));
  ...
  public void test34()  throws Throwable  {
      ...
      stringArray0[2] = "Vary";
      stringArray0[3] = "Z";
      stringArray0[4] = "E>A+70e0J*XT";
      stringArray0[5] = "UTF-15q)";
      stringArray0[6] = "Vary";
      stringArray0[7] = "UTF-15q)";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("9", 14);
      assertEquals(9, int0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" D(7-z-", 0);
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("hex=", 0, "he");
      assertEquals(0, int0);
  }
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn(".K3@hy").when(request0).method();
  ...
  public void test45()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("`N?BJ(r").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(39).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test47()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("okhttp3.requestbody", ";a$ realm=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "okhttp3.requestbody");
  ...
  public void test49()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put(";A ralms=", ";A ralms=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, ";A ralms=");
      assertEquals(0, list0.size());
  }
  ...
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "Ft4m0#jM9SxCgU^t3");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(headers0).when(response0).headers();
      // Undeclared exception!
  ...
  public void test54()  throws Throwable  {
      ...
      stringArray0[1] = "";
      stringArray0[2] = "jmgJBKPSt";
      stringArray0[3] = "LA\"&Z%]^m)x/'+t'Q";
      stringArray0[4] = "Content-Length";
      stringArray0[5] = "ZgQv@!?#";
      stringArray0[6] = "okhttp3.Response$Builder";
      stringArray0[7] = "Yt)U,),SZ";
      Headers headers0 = Headers.of(stringArray0);
      long long0 = HttpHeaders.contentLength(headers0);
      assertEquals((-1L), long0);
  }
