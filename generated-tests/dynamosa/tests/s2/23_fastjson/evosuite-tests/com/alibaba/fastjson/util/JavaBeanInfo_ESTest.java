...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build((Class<?>) class1, (Type) class1, propertyNamingStrategy0);
      Class<Integer> class2 = Integer.class;
      JavaBeanInfo.build((Class<?>) class2, (Type) null, propertyNamingStrategy0, false, false);
      // Undeclared exception!
      JavaBeanInfo.build(javaBeanInfo1.clazz, (Type) javaBeanInfo0.clazz, propertyNamingStrategy0, false, false);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      JavaBeanInfo.build(class2, (Type) class0, propertyNamingStrategy0, false, false);
  ...
  public void test29()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("GoIGnk$>5", class1, class0, class0, (Field) null, 38, 38, 38);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("GoIGnk$>5", fieldInfo0.fieldClass, class1, fieldInfo0.fieldClass, (Field) null, 38, 38, 38);
  ...
  public void test30()  throws Throwable  {
      ...
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("GoIGnk$>5", fieldInfo0.fieldClass, class1, fieldInfo0.fieldClass, (Field) null, 177, (-1287), 38);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
      assertTrue(boolean0);
  }
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      FieldInfo fieldInfo0 = new FieldInfo("7#j|fM()oP#XBeJ ", class0, class0, class0, (Field) null, (-1), (-1), (-1));
      JavaBeanInfo.add(linkedList0, fieldInfo0);
  ...
  public void test33()  throws Throwable  {
      ...
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<String> class0 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("!2lC8", class0, class0, class0, (Field) null, 3036, 102, 102);
  ...
  public void test35()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("getcompareToIgnoreCase").when(jSONType0).typeKey();
      doReturn("o]e").when(jSONType0).typeName();
