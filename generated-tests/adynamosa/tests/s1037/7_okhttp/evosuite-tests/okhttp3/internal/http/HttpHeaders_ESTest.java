...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", (-1656));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("\"}e* I+cB`In|8I.Gn", 478);
  ...
  public void test08()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("I4|]']AJU4[[O_}rr", 0, "I4|]']AJU4[[O_}rr");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>(1451, 1451);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test17()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>(304, 282.27805F);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds(" must not have a request body.", (-7));
      assertEquals((-7), int0);
  }
  ...
  public void test22()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>(204);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test23()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "8+?[yh72ujG3l5Rrjj");
      assertEquals(0, list0.size());
  }
  ...
  public void test25()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "BV4RIAO";
      stringArray0[1] = " must have a request body.";
      stringArray0[2] = " must have a request body.";
      stringArray0[3] = " must have a request body.";
      stringArray0[4] = " must have a request body.";
      stringArray0[5] = " must have a request body.";
      stringArray0[6] = " must have a request body.";
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, 2238);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 2886, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "ouhu[D#kOg:V$6e{ZU";
      stringArray0[1] = "&lj7q(),4,o#oF `bMF";
      stringArray0[2] = "Vary";
      stringArray0[3] = "okhttp3.Handshake";
      stringArray0[4] = "ouhu[D#kOg:V$6e{ZU";
      stringArray0[5] = "realm";
      stringArray0[6] = "Vary";
      stringArray0[7] = "http/1.1";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("8", 20);
      assertEquals(8, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("\"}e* I+cB`In|8I.Gn", 4);
      assertEquals(5, int0);
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("I4|]']AJU4[[O_}rr", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("$8su!F%", 7);
      assertEquals(7, int0);
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("chunked", 3, "x`n(]'h!");
      assertEquals(3, int0);
  }

  @Test(timeout = 4000)
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("i4|]']aju4[[o_}rr", 0, "EEE, dd MMM yy HH:mm:ss z");
  ...
  public void test45()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("0x2#D", (-2791), (String) null);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test47()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("a$d@;{VH`F6Ft").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(204);
  ...
  public void test48()  throws Throwable  {
      ...
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(1582).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test52()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "http";
      stringArray0[1] = " )|IsQ!o4#6NZR";
      stringArray0[2] = "http";
      stringArray0[3] = "^U&WpShbTR";
      stringArray0[4] = "\"}e* I+cB`In|8I.Gn";
      stringArray0[5] = "^U&WpShbTR";
      stringArray0[6] = "http";
      stringArray0[7] = "\"}e* I+cB`In|8I.Gn";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "http");
      assertEquals(0, list0.size());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      HttpUrl.parse("Vary");
      HttpHeaders.receiveHeaders((CookieJar) null, (HttpUrl) null, headers0);
      String string0 = "qB~ao|8@xUdr' ";
      HttpHeaders.parseChallenges(headers0, "Eb8m)@&*\u0002M)|");
      HttpHeaders.hasVaryAll(headers1);
      HttpHeaders.varyFields(headers1);
      headers1.getDate("Vary");
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("qB~ao|8@xUdr' ", "qB~ao|8@xUdr' ");
      Object object0 = new Object();
      hashMap0.remove((Object) "Vary", object0);
      ...
      // Undeclared exception!
      try { 
        HttpHeaders.varyMatches(response1, headers0, (Request) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test55()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Length", "u5tdQ^");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      long long0 = HttpHeaders.contentLength(headers0);
      assertEquals((-1L), long0);
  }
