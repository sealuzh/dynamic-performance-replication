...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      boolean boolean0 = okHostnameVerifier0.verify("SHA-1", sSLSession0);
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.INSTANCE.verify("<r1#c5@", sSLSession0);
        fail("Expecting exception: ClassCastException");
      
      } catch(ClassCastException e) {
         //
         // codegen.java.security.cert.Certificate$MockitoMock$1698779122 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.INSTANCE.verify("2UdB%Ha@1", x509Certificate0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ...
      doReturn(x500Principal0).when(x509Certificate0).getSubjectX500Principal();
      OkHostnameVerifier okHostnameVerifier0 = OkHostnameVerifier.INSTANCE;
      boolean boolean0 = okHostnameVerifier0.verify("SHA-1", x509Certificate0);
      assertFalse(boolean0);
  }
