...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxAge((-3180), timeUnit0);
  ...
  public void test09()  throws Throwable  {
      ...
      cacheControl_Builder0.minFresh(418, timeUnit0);
  ...
  public void test14()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      cacheControl_Builder0.maxAge(464, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
      int int0 = cacheControl0.maxAgeSeconds();
      assertEquals((-1), cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.isPublic());
      assertEquals(40089600, int0);
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.isPrivate());
      assertFalse(cacheControl0.mustRevalidate());
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-3777), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-1046), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ...
      stringArray0[4] = "y+y*(ra7^73_ll,)";
      stringArray0[5] = "/dsc\n5p";
      stringArray0[6] = "&]2T+D/G'5,1";
      stringArray0[7] = "Pragma";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.noTransform());
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[1] = "G;W/l&_A.x";
      stringArray0[2] = "no-cache, ";
      stringArray0[3] = "Cache-Control";
      stringArray0[4] = "IwJw-&@$gs{";
      stringArray0[5] = "p.19UP9Gb&d@";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.minFreshSeconds());
      assertEquals((-1), cacheControl0.maxStaleSeconds());
  ...
  public void test33()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.addLenient("cache-control", "kb=w3F0#0((");
  ...
  public void test34()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "cache-control";
      stringArray0[1] = "n,zFJ@bCu^@Gs`L";
      stringArray0[2] = "cache-control";
      stringArray0[3] = "cache-control";
      stringArray0[4] = "pragca";
      stringArray0[5] = "pragca";
      stringArray0[6] = "pragca";
