...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(2521L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(598L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(35880000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime((-2347L));
      timeout0.timeout(449L, timeUnit0);
      assertEquals(449L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(449L);
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(2146L, timeUnit0);
      timeout1.deadline(2146L, timeUnit0);
      assertEquals(2146L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-2347L));
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(598L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(35880000000000L, timeout0.timeoutNanos());
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(2784L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1061L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-693L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(417L);
      Object object0 = new Object();
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1061L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1039L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.NONE.timeout(449L, timeUnit0);
      timeout1.throwIfReached();
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.NONE.deadline(449L, timeUnit0);
      assertFalse(timeout1.equals((Object)timeout0));
  }
