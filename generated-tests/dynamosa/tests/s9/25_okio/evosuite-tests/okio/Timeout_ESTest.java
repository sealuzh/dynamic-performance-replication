...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.timeout(2663L, timeUnit0);
      timeout0.deadlineNanoTime(2663L);
      try { 
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(357L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(168652800000000000L);
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout1.timeout(168652800000000000L, timeUnit0);
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.deadline(4343L, timeUnit0);
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2829L);
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(2663L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(2663000000000L, timeout0.timeoutNanos());
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-1317L));
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(357L, timeUnit0);
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(168652800000000000L);
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-3809L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(2564L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1392409281318242L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // timeout < 0: -1392409281318242
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test25()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(357L, timeUnit0);
      Timeout timeout2 = timeout1.deadline(357L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.timeout(1000000L, (TimeUnit) null);
      assertSame(timeout0, timeout1);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(1392409281320357L, long0);
  }
