...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.deadline(526L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(288L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-3263L), timeUnit0);
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(15L);
      try { 
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(843L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      timeout0.timeout(101L, timeUnit0);
      assertEquals(101000L, timeout0.timeoutNanos());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1080L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(843L, timeUnit0);
      timeout1.deadlineNanoTime(843L);
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(288L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(288L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
