...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(5815L, timeUnit0);
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(5815L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(5815L, long0);
  }
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(5815L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(5815L, timeout0.timeoutNanos());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(1633L);
  ...
  public void test09()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout1.timeout(5815L, timeUnit0);
      try { 
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(1988L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-3092L));
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-894L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(5815L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1392409281321263L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // timeout < 0: -1392409281321263
         //
         verifyException("okio.Timeout", e);
      }
  }
