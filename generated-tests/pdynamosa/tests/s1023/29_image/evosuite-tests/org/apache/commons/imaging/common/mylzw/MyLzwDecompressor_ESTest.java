...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-3331), byteOrder0, myLzwDecompressor_Listener0);
  }
  ...
  public void test5()  throws Throwable  {
      ...
      byte[] byteArray1 = myLzwDecompressor0.decompress(bufferedInputStream0, 509);
      assertEquals(0, byteArray1.length);
  }
  ...
  public void test6()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.BIG_ENDIAN;
      MyLzwDecompressor.Listener myLzwDecompressor_Listener0 = mock(MyLzwDecompressor.Listener.class, new ViolatedAssumptionAnswer());
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(863, byteOrder0, myLzwDecompressor_Listener0);
      byte[] byteArray0 = new byte[2];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte)95, (-38));
      try { 
  ...
  public void test7()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0);
      try { 
        myLzwDecompressor0.decompress(bufferedInputStream0, 509);
        fail("Expecting exception: IOException");
