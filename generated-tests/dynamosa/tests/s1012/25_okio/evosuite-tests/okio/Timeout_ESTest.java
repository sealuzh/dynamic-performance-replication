...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.timeout(2943L, timeUnit0);
      timeout0.deadlineNanoTime((-1392409281321112L));
      try { 
        timeout0.waitUntilNotified("<FsMN%FT");
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(197L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(2465L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(212976000000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(197L, timeUnit0);
      Timeout timeout2 = timeout1.timeout(2943L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(1393346281320000L, long0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(150L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-431L));
      assertSame(timeout0, timeout1);
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3407L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2456L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(10L, timeUnit0);
      timeout1.deadline(10L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(15033600000000000L);
      timeout0.throwIfReached();
