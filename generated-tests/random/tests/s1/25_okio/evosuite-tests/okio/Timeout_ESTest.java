...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(598L, timeUnit0);
      Timeout timeout2 = timeout1.timeout(598L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(2288L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3532L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-644L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout((-2628L), timeUnit0);
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime((-686L));
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(2288L, timeUnit0);
      timeout0.throwIfReached();
