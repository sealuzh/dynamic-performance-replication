...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2079L, timeUnit0);
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        timeout0.waitUntilNotified("6vR|J#-rx4uI");
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(60000000000000000L, timeout1.timeoutNanos());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1000000L, timeUnit0);
      Timeout timeout2 = timeout1.deadlineNanoTime(1000000L);
      try { 
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2631L);
      long long0 = timeout1.deadlineNanoTime();
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2631L);
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1392409281316773L));
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout1.deadlineNanoTime();
      assertEquals((-1392409281316773L), long0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-2654L));
      timeout1.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(202L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1392409281316773L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // duration <= 0: -1392409281316773
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(8L, timeUnit0);
      Timeout timeout2 = timeout0.deadline(1L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.NONE.timeout(2079000L, timeUnit0);
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(349L, timeUnit0);
