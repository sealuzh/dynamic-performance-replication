...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime(2926L);
      try { 
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(3931L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(235860000000000L, long0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(175L);
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(3507L);
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1392409281319825L));
      long long0 = timeout0.deadlineNanoTime();
      assertEquals((-1392409281319825L), long0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1392409281319825L));
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals(8467200000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(1392469281320000L, long0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      timeout0.timeout(4829L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(object0);
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(1063L, timeUnit0);
      timeout0.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(34L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1671L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(34L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-549L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.timeout((-2179L), (TimeUnit) null);
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(151L);
      assertFalse(timeout1.equals((Object)timeout0));
  }
