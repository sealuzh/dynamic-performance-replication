...
public class SingularValueDecompositor_ESTest extends SingularValueDecompositor_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      RowMajorSparseMatrix rowMajorSparseMatrix0 = RowMajorSparseMatrix.diagonal(1918, 0.0);
  ...
  public void test7()  throws Throwable  {
      DenseMatrix denseMatrix0 = DenseMatrix.constant(12, 4, (-5744.301275637008));
      SingularValueDecompositor singularValueDecompositor0 = new SingularValueDecompositor(denseMatrix0);
      Matrix[] matrixArray0 = singularValueDecompositor0.decompose();
      assertEquals(3, matrixArray0.length);
  }
  ...
  public void test9()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          MockRandom mockRandom0 = new MockRandom();
          Matrix matrix0 = Matrix.random(4, 1000, mockRandom0);
          SingularValueDecompositor singularValueDecompositor0 = new SingularValueDecompositor(matrix0);
          singularValueDecompositor0.decompose();
          // Undeclared exception!
          singularValueDecompositor0.decompose();
