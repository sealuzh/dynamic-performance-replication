...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", (-57));
      assertEquals(0, int0);
  }
  ...
  public void test02()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("}?ub=~eyyf10a", 1179, "}?ub=~eyyf10a");
  ...
  public void test04()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Wl]<").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test07()  throws Throwable  {
      ...
      stringArray0[3] = ",(HJ'";
      stringArray0[4] = "Vary";
      stringArray0[5] = "KU;(v=Rq!@E.at@XV";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test09()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("r6d4.9|f!!5k'e\"1qa`", "realm");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 18);
  ...
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("cP.dT4/6@IKh`Ikd%dm", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 533);
      assertEquals(533, int0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", (-2173));
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-2358));
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("chunked", (-640), "chunked");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 2706, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("4", (-1886));
      assertEquals(4, int0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("qqUa)9 $;*KzL", 7);
      assertEquals(7, int0);
  }
  ...
  public void test39()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("d8b", (-1298));
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("-ttAB;tDr_'# >", 0, "HEAD");
      assertEquals(3, int0);
  }
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("cacDheresponse").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test45()  throws Throwable  {
      ...
      doReturn("cacDheresponse").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(1454).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test46()  throws Throwable  {
      ...
      stringArray0[0] = "qqUa9 $;e/=*OK";
      stringArray0[1] = "qqUa9 $;e/=*OK";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "qqUa9 $;e/=*OK");
  ...
  public void test48()  throws Throwable  {
      ...
      stringArray0[0] = ".e#6";
      stringArray0[1] = "";
      stringArray0[2] = "method == null";
      stringArray0[3] = "h9sbay4}uuxpv(a&\\";
      stringArray0[4] = "Vary";
      stringArray0[5] = "Vary";
      stringArray0[6] = "-ttAB;tDr_'# >";
      stringArray0[7] = ".e#6";
      Headers headers0 = Headers.of(stringArray0);
      Headers headers1 = HttpHeaders.varyHeaders(headers0, headers0);
  ...
  public void test49()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "h9sBaY4}uUXpV(a&\\";
      stringArray0[1] = "h9sBaY4}uUXpV(a&\\";
      stringArray0[2] = "h9sBaY4}uUXpV(a&\\";
      stringArray0[3] = "h9sBaY4}uUXpV(a&\\";
      stringArray0[4] = "h9sBaY4}uUXpV(a&\\";
      stringArray0[5] = "vary";
      Headers headers0 = Headers.of(stringArray0);
      boolean boolean0 = HttpHeaders.hasVaryAll(headers0);
      assertFalse(boolean0);
  ...
  public void test51()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "yfDkt)s?5h!H?[/";
      stringArray0[1] = "j)A)}rIb";
      stringArray0[2] = "Content-Length";
      stringArray0[3] = " EV(D2p:!8";
      stringArray0[4] = "([^ \"=]*)";
      stringArray0[5] = "F<3";
      Headers headers0 = Headers.of(stringArray0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
