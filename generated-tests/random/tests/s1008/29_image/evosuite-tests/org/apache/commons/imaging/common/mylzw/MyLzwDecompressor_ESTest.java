...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-1793), byteOrder0);
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(pipedInputStream0, (-235));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -235
         //
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        myLzwDecompressor0 = new MyLzwDecompressor((-1517), byteOrder0, myLzwDecompressor_Listener0);
  ...
  public void test3()  throws Throwable  {
      ...
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream0, 1813);
  ...
  public void test6()  throws Throwable  {
      ...
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0, 1);
      try { 
        myLzwDecompressor0.decompress(bufferedInputStream0, 2044);
        fail("Expecting exception: IOException");
  ...
  public void test7()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[8];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 1, 696);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 273);
        fail("Expecting exception: IOException");
