...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn("6X").when(jSONType0).typeKey();
      doReturn("java.lang.annotation.Annotation").when(jSONType0).typeName();
  ...
  public void test04()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build(class0, typeArray0[4], propertyNamingStrategy0, true, false);
  ...
  public void test16()  throws Throwable  {
      ...
      Class<AtomicBoolean> class0 = AtomicBoolean.class;
      Class<Void> class1 = Void.class;
      FieldInfo fieldInfo0 = new FieldInfo("can not cast to double, value : ", class1, class1, class1, (Field) null, (-166), 1263, 512);
      FieldInfo fieldInfo1 = new FieldInfo("can not cast to double, value : ", class0, class0, class0, (Field) null, 3, 3, (-531));
  ...
  public void test18()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("12UwK\"l7.", class0, class1, class0, (Field) null, 0, 0, (-2));
  ...
  public void test19()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("12UwK\"l7.").when(jSONType0).typeKey();
      doReturn("").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class1, class0, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      Class<String> class2 = String.class;
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build((Class<?>) class2, (Type) javaBeanInfo0.builderClass, propertyNamingStrategy0, false, true);
