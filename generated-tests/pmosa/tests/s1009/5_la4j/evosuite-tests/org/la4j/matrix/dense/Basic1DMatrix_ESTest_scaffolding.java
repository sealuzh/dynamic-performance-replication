...
public class Basic1DMatrix_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("org.la4j.matrix.functor.MatrixFunction", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixProcedure", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.MatrixOperation", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
