...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.verify("[hex=", (SSLSession) null);
  ...
  public void test8()  throws Throwable  {
      ...
      OkHostnameVerifier okHostnameVerifier0 = OkHostnameVerifier.INSTANCE;
      okHostnameVerifier0.verify("__,%h#O", x509Certificate0);
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("__,%h#O", x509Certificate1);
        fail("Expecting exception: NullPointerException");
