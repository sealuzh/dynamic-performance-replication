...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("3", (-314628799));
      assertEquals(3, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn(2681).when(response0).code();
  ...
  public void test07()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(".networkResponse != null", 0);
      assertEquals(0, int0);
  }
  ...
  public void test12()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("b!\"wRHP`HZ", 268, (String) null);
      assertEquals(268, int0);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 17, "");
  ...
  public void test14()  throws Throwable  {
      ...
      stringArray0[0] = "r/85HfRYOL?B";
      stringArray0[1] = "r/85HfRYOL?B";
      stringArray0[2] = "r/85HfRYOL?B";
      stringArray0[3] = "r/85HfRYOL?B";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test15()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = "h`3Ew1)A";
      stringArray0[1] = "hccxl<u)?h&hg(6uv:";
      stringArray0[2] = "I!~nj";
      stringArray0[3] = "m>!l61bUFjtl=";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test17()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-2935));
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("J>b@;DB)EBU]a~#c", (-1615));
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("Tp<m9C|%|'/@", (-732), "([^ \"=]*)");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "-@bb|dw]=_nh*tcx");
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", 177);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("unexpected url: ", 15);
      assertEquals(16, int0);
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil(".CRy9N>", 0, ".CRy9N>");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("varz: varz\n", 3, "pu_?ic,)");
  ...
  public void test44()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("#7t:4").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
  ...
  public void test48()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = "-@Bb|DW]=_nh*TCX";
      stringArray0[1] = "\"A=iOAN7}`0(7(--";
      stringArray0[2] = "G4b;";
      stringArray0[3] = "method == null";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "G4b;");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      stringArray0[4] = "G4b;";
      stringArray0[5] = "\"A=iOAN7}`0(7(--";
      stringArray0[6] = "\"A=iOAN7}`0(7(--";
      stringArray0[7] = "G4b;";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "G4b;");
  ...
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "okhttp3.internal.httphttpheaders");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(headers0).when(response0).headers();
      // Undeclared exception!
  ...
  public void test54()  throws Throwable  {
      ...
      stringArray0[2] = "uo";
      stringArray0[3] = "d](";
      stringArray0[4] = "(e77wS";
      stringArray0[5] = "[o=x3/;|l1>'y";
      Headers headers0 = Headers.of(stringArray0);
      long long0 = HttpHeaders.contentLength(headers0);
      assertEquals((-1L), long0);
  }
