...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(2451L, timeUnit0);
  ...
  public void test05()  throws Throwable  {
      ...
      timeout0.NONE.timeout((-247L), timeUnit0);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1705L), timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline((-4990L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1521L);
      try { 
        timeout0.throwIfReached();
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test13()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1249L, timeUnit0);
  ...
  public void test14()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(2570400000000000L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.deadline(1249L, timeUnit0);
      timeout1.timeout(1249L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeout0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(2570400000000000L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(2570400000000000L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1248L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
