...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1166L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(5158800000000000L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(5158800000000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      timeout0.deadline(1024L, timeUnit0);
      timeout0.timeout(1433L, timeUnit0);
      assertEquals(5158800000000000L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1433L);
  ...
  public void test07()  throws Throwable  {
      ...
      Timeout timeout2 = timeout1.deadlineNanoTime(1433L);
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-3475L));
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      timeout0.deadline(5158800000000000L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(5160192409281320000L, long0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      timeout0.timeout(2039L, timeUnit0);
      Timeout timeout1 = timeout0.deadline(1166L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified((Object) null);
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(2675L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.deadline(3150L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified("c=O");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(911L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-194L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
