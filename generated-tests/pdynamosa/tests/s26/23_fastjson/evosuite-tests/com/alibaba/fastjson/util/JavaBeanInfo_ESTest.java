...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test16()  throws Throwable  {
      Constructor<Integer>[] constructorArray0 = (Constructor<Integer>[]) Array.newInstance(Constructor.class, 24);
      Class<Object> class0 = Object.class;
      // Undeclared exception!
      try { 
  ...
  public void test32()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("Av f=J`", class0, class1, class0, (Field) null, 1724, 1724, 1724);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<AtomicInteger> class2 = AtomicInteger.class;
      FieldInfo fieldInfo1 = new FieldInfo("Av f=J`", class0, class2, fieldInfo0.declaringClass, (Field) null, 1724, (-1982477622), (-2555));
  ...
  public void test33()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Class<AtomicBoolean> class1 = AtomicBoolean.class;
      FieldInfo fieldInfo0 = new FieldInfo("Av f=J`", class0, class1, class0, (Field) null, 1748, 1748, 1748);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("Av f=J`", class0, class0, class0, (Field) null, 2, 2, 3230);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
  ...
  public void test34()  throws Throwable  {
      Class<Object> class0 = Object.class;
      Class<AtomicLong> class1 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("A f8r=JI", class1, class1, class0, (Field) null, (-156), 4, 614);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
  ...
  public void test36()  throws Throwable  {
      ...
      doReturn("o<B\"},").when(jSONType0).typeKey();
      doReturn("o<B\"},").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<String> class0 = String.class;
      Class<AtomicInteger> class1 = AtomicInteger.class;
      FieldInfo fieldInfo0 = new FieldInfo("U$O4", class0, class1, class1, (Field) null, 86, 86, (-1122406496));
  ...
  public void test37()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("+}7w>@;#QV").when(jSONType0).typeKey();
      doReturn("+}7w>@;#QV").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
  ...
  public void test38()  throws Throwable  {
      ...
      doReturn("r;(D9RL.I>E{").when(jSONType0).typeKey();
