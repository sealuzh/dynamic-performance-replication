...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(1100).when(response0).code();
  ...
  public void test04()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "vIr/p)n?,I>!,>zv");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test05()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("Z-wY{~mkaqsR", (-3650));
  ...
  public void test09()  throws Throwable  {
      ...
      stringArray0[0] = "YtaP^F60&RJ`;{g7W";
      stringArray0[1] = "beginIndex < 0: ";
      stringArray0[2] = "YtaP^F60&RJ`;{g7W";
      stringArray0[3] = "YtaP^F60&RJ`;{g7W";
      Headers headers0 = Headers.of(stringArray0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn((Headers) null).when(response0).headers();
      // Undeclared exception!
  ...
  public void test12()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 504);
      assertEquals(504, int0);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil(".", 65535, "");
  ...
  public void test16()  throws Throwable  {
      ...
      HttpUrl httpUrl1 = httpUrl0.resolve("jWHCAQ.^ICoF|?tydH");
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 1893);
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("transfer-encoding", (-21));
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("xGcv*", (-1), "xGcv*");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-4012), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "&XN");
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("9", (-1562));
      assertEquals(9, int0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("code < 0:", 4);
      assertEquals(5, int0);
  }
  ...
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("code < 0:", 0, "YtaP^F60&RJ`;{g7W");
      assertEquals(7, int0);
  }
  ...
  public void test41()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("a").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("O9T").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("XN[9").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test45()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("b#w2oq&t$`ad \",(\"a", ", taFbz=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "b#w2oq&t$`ad \",(\"a");
      assertEquals(0, list0.size());
  }
  ...
  public void test46()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("cacheResponse", "cacheResponse");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "cacheResponse");
  ...
  public void test54()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Content-Length", "ebD-");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      long long0 = HttpHeaders.contentLength(headers0);
      assertEquals((-1L), long0);
  }
