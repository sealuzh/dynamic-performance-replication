...
public class MnAlgebraicSymMatrix_ESTest extends MnAlgebraicSymMatrix_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        mnAlgebraicSymMatrix0.set((-93), 4139, 1.0E-35);
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get((-706), 3088);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get(3223, 0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      MnAlgebraicSymMatrix mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix(1318);
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get(0, 1318);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set((-1427), (-1427), (-1427));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get((-1), (-357));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test17()  throws Throwable  {
      ...
      try {
        mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix(2147481658);
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set((-841), 2, 2);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set(6, 3, 6);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test22()  throws Throwable  {
      MnAlgebraicSymMatrix mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix(5);
      mnAlgebraicSymMatrix0.set(4, 4, (-1864.0));
      try { 
        mnAlgebraicSymMatrix0.invert();
  ...
  public void test25()  throws Throwable  {
      MnAlgebraicSymMatrix mnAlgebraicSymMatrix0 = null;
      try {
        mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix((-1624));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid matrix size: -1624
         //
         verifyException("org.freehep.math.minuit.MnAlgebraicSymMatrix", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      MnAlgebraicSymMatrix mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix(1013);
      double[] doubleArray0 = mnAlgebraicSymMatrix0.data();
      assertEquals(513591, doubleArray0.length);
  }
}
