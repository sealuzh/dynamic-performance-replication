...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("h", linkedList0, (-815));
      arrayList0.add(attribute0);
      Properties properties0 = new Properties();
      ProtectedProperties protectedProperties0 = new ProtectedProperties(properties0);
      Attribute attribute1 = new Attribute("'B2of2'", protectedProperties0);
  ...
  public void test001()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      Attribute attribute0 = new Attribute((String) null, linkedList0, (-815));
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
  ...
  public void test003()  throws Throwable  {
      ...
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      Attribute attribute0 = new Attribute("3yg+BujSAEn", linkedList0, (-815));
      arrayList0.add(attribute0);
  ...
  public void test012()  throws Throwable  {
      Discretize discretize0 = new Discretize("~YVrWKhZAp");
  ...
  public void test017()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances(".wEuVi0mUzSwZX0\"", arrayList0, 1);
  ...
  public void test019()  throws Throwable  {
      ...
      discretize0.setDesiredWeightOfInstancesPerInterval(41);
  ...
  public void test029()  throws Throwable  {
      ...
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(872.31844824, intArray0, (-1330));
      // Undeclared exception!
      try { 
        discretize0.input(binarySparseInstance0);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test036()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = new double[0];
      SparseInstance sparseInstance0 = new SparseInstance(2176, doubleArray0);
      // Undeclared exception!
      try { 
  ...
  public void test038()  throws Throwable  {
      ...
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(901.3146429, intArray0, 79);
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("~YVrWKhZAp", arrayList0, 95);
  ...
  public void test044()  throws Throwable  {
      Discretize discretize0 = new Discretize("5H*,NSTw");
      // Undeclared exception!
      try { 
  ...
  public void test046()  throws Throwable  {
      ...
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Instances instances0 = new Instances("+Hw]/]g?wDA-O`h", arrayList0, 1);
      discretize0.setInputFormat(instances0);
      discretize0.batchFinished();
      // Undeclared exception!
      try { 
        discretize0.getBinRangesString((-107));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test053()  throws Throwable  {
      Discretize discretize0 = new Discretize("    super.setInputFormat(instanceInfo);\n");
      String[] stringArray0 = new String[9];
      stringArray0[0] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[1] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[2] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[3] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[4] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[5] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[6] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[7] = "    super.setInputFormat(instanceInfo);\n";
      stringArray0[8] = "    super.setInputFormat(instanceInfo);\n";
      discretize0.setOptions(stringArray0);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01);
      assertFalse(discretize0.getUseBinNumbers());
      assertFalse(discretize0.getFindNumBins());
  ...
  public void test057()  throws Throwable  {
      Discretize discretize0 = new Discretize("+]=@/+G?)UD9$&<..v");
      double double0 = discretize0.getDesiredWeightOfInstancesPerInterval();
      assertFalse(discretize0.getFindNumBins());
      assertFalse(discretize0.getUseBinNumbers());
      assertFalse(discretize0.getUseEqualFrequency());
  ...
  public void test065()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      Attribute attribute0 = new Attribute("(-inf-0],(0-0],(0-0],(0-0],(0-inf)", 1);
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Instances instances0 = new Instances(".wEuVi0mUzSwZX0\"", arrayList0, 1);
      discretize0.setInputFormat(instances0);
  ...
  public void test066()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      Attribute attribute0 = new Attribute("D", 1);
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
  ...
  public void test067()  throws Throwable  {
      ...
      discretize0.m_CutPoints = doubleArray0;
      discretize0.m_CutPoints = doubleArray0;
      Attribute attribute0 = new Attribute("D", (-256));
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
  ...
  public void test069()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // A nominal attribute (D) cannot have duplicate labels ('(0-0]').
         //
  ...
  public void test072()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      discretize0.setBins((-1706));
      Attribute attribute0 = new Attribute("(-inf-0],(0-0],(0-0],(0-0],(0-inf)");
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Instances instances0 = new Instances("@end", arrayList0, 3);
      discretize0.setInputFormat(instances0);
      discretize0.calculateCutPoints();
      assertEquals((-1706), discretize0.getBins());
  }
  ...
  public void test079()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      Attribute attribute0 = new Attribute("=JXS6a/v2n`~3|rHBM");
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Instances instances0 = new Instances(".wEuVi0mUzSwZX0\"", arrayList0, 948);
      discretize0.setInputFormat(instances0);
      discretize0.batchFinished();
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(10);
      discretize0.input(binarySparseInstance0);
  ...
  public void test082()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("_1N7\u0002@5B(=5yqU", 1196);
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      arrayList0.add(attribute0);
      Instances instances0 = new Instances("relational", arrayList0, 1196);
      boolean boolean0 = discretize0.setInputFormat(instances0);
      assertFalse(boolean0);
