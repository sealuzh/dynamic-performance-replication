...
public class Okio_ESTest extends Okio_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      MockSocket mockSocket0 = new MockSocket();
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("Failed to close timed out socket ", 1795);
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".\" `J}{]fPn_< ", ".\" `J}{]fPn_< ");
      try { 
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("z<OhN~%YBP+e");
      Path path0 = mockFile0.toPath();
      OpenOption[] openOptionArray0 = new OpenOption[1];
  ...
  public void test10()  throws Throwable  {
      MockSocket mockSocket0 = new MockSocket();
      MockInetSocketAddress mockInetSocketAddress0 = new MockInetSocketAddress("%/[~M\"+:?\"K<E", 0);
      mockSocket0.bind(mockInetSocketAddress0);
      try { 
        Okio.sink((Socket) mockSocket0);
        fail("Expecting exception: SocketException");
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile mockFile1 = new MockFile(mockFile0, "IIBrZ/.>]<i=Ki6p:");
  ...
  public void test19()  throws Throwable  {
      MockFile mockFile0 = new MockFile("CRC", ".dII>7NEi&;");
  ...
  public void test20()  throws Throwable  {
      ...
      MockFile.createTempFile("~n>Chu&w<3", "~n>Chu&w<3", (File) mockFile0);
      try { 
        Okio.appendingSink(mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test21()  throws Throwable  {
      MockFile mockFile0 = new MockFile("SS)syor.q79n_82", "SS)syor.q79n_82");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      File file0 = MockFile.createTempFile("2{QYVI{-eOn", "okio.Buffer");
      MockFile mockFile0 = new MockFile(file0, "2{QYVI{-eOn");
      try { 
        Okio.sink((File) mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test25()  throws Throwable  {
      File file0 = MockFile.createTempFile("edCd9!KVOZ4A!qhsEX", "Expected leading [0-9a-fA-F] character but was %#x");
      MockFile mockFile0 = new MockFile(file0, "edCd9!KVOZ4A!qhsEX");
      try { 
        Okio.appendingSink(mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test26()  throws Throwable  {
      AssertionError assertionError0 = new AssertionError(2287.21);
  ...
  public void test27()  throws Throwable  {
      ...
      AssertionError assertionError0 = new AssertionError("okio.GzipSource", mockException0);
  ...
  public void test32()  throws Throwable  {
      MockFile mockFile0 = new MockFile("baK@>*7", "baK@>*7");
      Path path0 = mockFile0.toPath();
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2754), (-2754));
      Source source0 = Okio.source((InputStream) byteArrayInputStream0);
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(source0);
  ...
  public void test44()  throws Throwable  {
      MockFile mockFile0 = new MockFile("a4QSf(J9E&N*&@o");
      Sink sink0 = Okio.appendingSink(mockFile0);
