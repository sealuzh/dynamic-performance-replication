...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Page page0 = new Page();
      page0.setStatusCode(2278);
      assertEquals(2278, page0.getStatusCode());
  }
  ...
  public void test20()  throws Throwable  {
      Page page0 = new Page();
      page0.setCharset("5a]@u.j;d_3|T_6");
      assertTrue(page0.isDownloadSuccess());
      assertEquals(200, page0.getStatusCode());
  }
  ...
  public void test25()  throws Throwable  {
      Page page0 = Page.fail();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("e3nJQalD~N%j:9NH");
      // Undeclared exception!
      try { 
