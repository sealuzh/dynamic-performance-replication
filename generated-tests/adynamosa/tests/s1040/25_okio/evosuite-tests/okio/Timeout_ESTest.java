...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(3310L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(3310000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(3310L);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(1011L, timeUnit0);
      timeout1.deadlineNanoTime(1011L);
      assertEquals(1011000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-239L));
  ...
  public void test09()  throws Throwable  {
      ...
      timeout0.timeout(3836L, timeUnit0);
      timeout0.deadline(3417L, timeUnit0);
      assertEquals(13809600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.timeout(235L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(235000000L, timeout0.timeoutNanos());
  }
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(3836L);
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(3836L);
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.timeout(3836L, timeUnit0);
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(13L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(476L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2885L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(139L, timeUnit0);
      // Undeclared exception!
      try { 
