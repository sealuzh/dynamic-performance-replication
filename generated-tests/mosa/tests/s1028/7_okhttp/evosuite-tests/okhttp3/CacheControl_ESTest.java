...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxStale((-86), timeUnit0);
  ...
  public void test04()  throws Throwable  {
      ...
      cacheControl_Builder0.maxAge(1114111, timeUnit0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1845289613), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(1297, timeUnit0);
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-1845289613), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minFresh < 0: -1845289613
         //
         verifyException("okhttp3.CacheControl$Builder", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.add("Pragma", ",h xW4w\"cIM");
  ...
  public void test28()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("cache-control", ">y=$j/");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.onlyIfCached());
      assertFalse(cacheControl0.isPrivate());
  ...
  public void test31()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.add("pragma", "GvkU[]8d{I3;)Q");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.noTransform());
      assertFalse(cacheControl0.noCache());
  ...
  public void test41()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.set("cache-control", "=\"[iudb^`");
      Headers.Builder headers_Builder2 = headers_Builder0.set("~Vrb", "~Vrb");
      Headers headers0 = headers_Builder0.build();
      CacheControl.parse(headers0);
      headers_Builder2.set("=\"[iudb^`", "");
