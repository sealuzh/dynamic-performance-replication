...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("S=TPMn");
  ...
  public void test3()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=,S=n");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("zYW'C=u{$u](q1E_O");
      assertNull(string0);
  }
  ...
  public void test5()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("l=hm'ym$#n");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("k");
      assertNull(string0);
  }
  ...
  public void test8()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=P =");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("s=P =");
      assertNull(string0);
  }
}
