...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("ST=SE!L#=Zm`X}d");
  ...
  public void test2()  throws Throwable  {
      ...
      assertEquals("SE!L#=Zm`X}d", string0);
  ...
  public void test4()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("T=S!L#=Zm`}d");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("T=S!L#=Zm`}d");
      assertNull(string0);
  }
}
