...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.INSTANCE.verify("fe,Yx@P`%", (SSLSession) null);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("mVW2", sSLSession0);
        fail("Expecting exception: ClassCastException");
      
      } catch(ClassCastException e) {
         //
         // codegen.java.security.cert.Certificate$MockitoMock$1999791859 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("p=*{3CDo,T>F", x509Certificate0);
        fail("Expecting exception: NullPointerException");
