...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("2", 300);
      assertEquals(2, int0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("3", 1);
      assertEquals(1, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn(2331).when(response0).code();
  ...
  public void test03()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("4m2tZ").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test06()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("vary", (-3637));
  ...
  public void test09()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = "<<Iy1Z(9ELz8zJ_cT{";
      stringArray0[1] = "9Jfa";
      stringArray0[2] = "([^ \"=]*)";
      stringArray0[3] = "9Jfa";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test14()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 44, (String) null);
  ...
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 92);
      assertEquals(92, int0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 1846);
      assertEquals(1846, int0);
  }
  ...
  public void test22()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "zk&s'gf//?^2Bh&th");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("", (-1768));
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-314));
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("E$i~", (-1428), "");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-1812), "r.`/p*");
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "nadzy8");
        fail("Expecting exception: NullPointerException");
  ...
  public void test40()  throws Throwable  {
      ...
      hashMap0.merge("vary", "@9V,DE", biFunction0);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
  ...
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", 1150);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", (-1763));
      assertEquals(0, int0);
  }
  ...
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("([^ \"=]*)", 92);
      assertEquals(92, int0);
  }

  @Test(timeout = 4000)
  public void test45()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("DELETE", 0, "DELETE");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test46()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("[\u0000-\u001F-\u009Fp{javaWhitespace}]", 0, ",");
  ...
  public void test52()  throws Throwable  {
      ...
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(110).when(response0).code();
      doReturn((Headers) null).when(response0).headers();
      doReturn(request0).when(response0).request();
      // Undeclared exception!
      try { 
  ...
  public void test55()  throws Throwable  {
      ...
      stringArray0[7] = "R.`/P*";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "R.`/P*");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test56()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      BiFunction<String, String, String> biFunction0 = (BiFunction<String, String, String>) mock(BiFunction.class, new ViolatedAssumptionAnswer());
      hashMap0.merge("vary", "@9VuDE", biFunction0);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Headers headers1 = HttpHeaders.varyHeaders(headers0, headers0);
      assertNotSame(headers0, headers1);
  }
