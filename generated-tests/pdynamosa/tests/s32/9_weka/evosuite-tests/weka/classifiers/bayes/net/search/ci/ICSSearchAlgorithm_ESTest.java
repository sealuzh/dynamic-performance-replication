...
public class ICSSearchAlgorithm_ESTest extends ICSSearchAlgorithm_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        iCSSearchAlgorithm0.existsSepSet(4036, (-1969), 0, booleanArray0);
  ...
  public void test01()  throws Throwable  {
      ...
      Instances instances0 = new Instances("When determining whether an edge exists a search is performed for a set Z that separates the nodes. MaxCardinality determines the maximum size of the set Z. This greatly influences the length of the search. Default value is 2.", arrayList0, 10023);
  ...
  public void test03()  throws Throwable  {
      ...
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains(850);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
      assertFalse(boolean0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      ICSSearchAlgorithm.SeparationSet iCSSearchAlgorithm_SeparationSet0 = iCSSearchAlgorithm0.new SeparationSet();
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains(1616);
      assertFalse(boolean0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      int int0 = iCSSearchAlgorithm0.next(858, 593, 858, booleanArray0);
  ...
  public void test07()  throws Throwable  {
      ...
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      BayesNet bayesNet0 = new BayesNet();
      Instances instances0 = new Instances("When determining whether an edge exists a search is performed for a set Z that separates the nodes. MaxCardinality determines the maximum size of the set Z. This greatly influences the length of the search. Default value is 2.", arrayList0, 10000);
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
  ...
  public void test08()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality((-1912));
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(319, iCSSearchAlgorithm0.getMaxCardinality());
  }
  ...
  public void test14()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("w=9C8Eh{]+ap=50fC!H", arrayList0, 2);
      BayesNet bayesNet0 = new BayesNet();
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next(1, 568, 117, booleanArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next((-1854), (-72), (-1854), booleanArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet((-3195), (-3195), (-2415), (boolean[][]) null);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test40()  throws Throwable  {
      ...
      stringArray0[0] = ")\n";
      stringArray0[1] = "-M <numInstances>";
      stringArray0[2] = "";
      stringArray0[3] = "-cardinality";
      stringArray0[4] = "\tUse randomly chosen initial anchors.";
      try { 
        iCSSearchAlgorithm0.setOptions(stringArray0);
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"\tUse randomly chosen initial anchors.\"
         //
  ...
  public void test43()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("The RBF kernel. K(x, y) = e^-(gamma * <x-y, x-y>^2)", arrayList0, 1351);
      LinkedList<String> linkedList0 = new LinkedList<String>();
      Attribute attribute0 = new Attribute("arizability", linkedList0);
      arrayList0.add(attribute0);
      arrayList0.add(attribute0);
      arrayList0.add(attribute0);
      arrayList0.add(attribute0);
      BayesNet bayesNet0 = new BayesNet();
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality((-3889));
      try { 
        iCSSearchAlgorithm0.search(bayesNet0, instances0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("E.aDgcCEk", arrayList0, 32);
      iCSSearchAlgorithm0.search((BayesNet) null, instances0);
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next((-4696), (-436), 4990, (boolean[][]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      ...
      BayesNet bayesNet0 = new BayesNet();
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      iCSSearchAlgorithm0.existsSepSet(859, 436, 2, (boolean[][]) null);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
  }
