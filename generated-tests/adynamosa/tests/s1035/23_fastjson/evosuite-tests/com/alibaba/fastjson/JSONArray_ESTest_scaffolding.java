...
public class JSONArray_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.function.IntBinaryOperator", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.LongBinaryOperator", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToIntBiFunction", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToLongFunction", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("sun.reflect.generics.reflectiveObjects.ParameterizedTypeImpl", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
  }
