...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.minFresh((-1970661306), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minFresh < 0: -1970661306
         //
  ...
  public void test06()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(2048, timeUnit0);
  ...
  public void test08()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      cacheControl_Builder0.maxAge(1077, timeUnit0);
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-1528351856), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // maxStale < 0: -1528351856
         //
         verifyException("okhttp3.CacheControl$Builder", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1982292595), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals("min-fresh=212400", string0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      cacheControl0.onlyIfCached();
      String string0 = cacheControl0.toString();
      //  // Unstable assertion: assertEquals("h`TIGj$0~bR]A)%sDm", string0);
      ...
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      CacheControl.Builder cacheControl_Builder2 = cacheControl_Builder1.minFresh(828, timeUnit0);
      TimeUnit timeUnit1 = TimeUnit.MILLISECONDS;
      CacheControl.Builder cacheControl_Builder3 = cacheControl_Builder2.maxStale(Integer.MAX_VALUE, timeUnit1);
      TimeUnit timeUnit2 = TimeUnit.HOURS;
      CacheControl.Builder cacheControl_Builder4 = cacheControl_Builder3.maxAge(Integer.MAX_VALUE, timeUnit2);
      cacheControl_Builder3.noTransform();
      TimeUnit timeUnit3 = TimeUnit.DAYS;
      cacheControl_Builder0.maxStale(9, timeUnit3);
  ...
  public void test33()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      cacheControl_Builder0.maxAge(57343, timeUnit0);
      CacheControl.Builder cacheControl_Builder2 = cacheControl_Builder1.noStore();
      TimeUnit timeUnit1 = TimeUnit.HOURS;
      cacheControl_Builder2.maxAge(57343, timeUnit1);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder2);
      cacheControl0.FORCE_CACHE.headerValue = "h`TIGj$0~bR]A)%sDm";
      cacheControl0.FORCE_NETWORK.toString();
      cacheControl0.toString();
      cacheControl0.isPrivate();
      cacheControl0.isPrivate();
      String[] stringArray0 = new String[8];
      stringArray0[0] = "h`TIGj$0~bR]A)%sDm";
      stringArray0[1] = "h`TIGj$0~bR]A)%sDm";
      stringArray0[2] = "h`TIGj$0~bR]A)%sDm";
      stringArray0[3] = "no-store, max-age=206434800, no-transform";
      stringArray0[4] = "no-store, max-age=206434800, no-transform";
      stringArray0[5] = "no-store, max-age=206434800, no-transform";
      stringArray0[6] = "max-stale=2147483647, only-if-cached";
      stringArray0[7] = "max-stale=2147483647, only-if-cached";
      Headers headers0 = Headers.of(stringArray0);
