...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-2078), byteOrder0);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress((InputStream) null, (-2078));
  ...
  public void test04()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-27), 1035);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 1035);
  ...
  public void test06()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor2 = new MyLzwDecompressor(564, byteOrder0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      byte[] byteArray0 = myLzwDecompressor0.decompress(dataInputStream0, 4089);
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress((InputStream) null, 3);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      MyLzwDecompressor.Listener myLzwDecompressor_Listener0 = mock(MyLzwDecompressor.Listener.class, new ViolatedAssumptionAnswer());
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(30, (ByteOrder) null, myLzwDecompressor_Listener0);
      byte[] byteArray0 = new byte[4];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      try { 
        myLzwDecompressor0.decompress(dataInputStream0, (byte)1);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Bad Code: -1 codes: 1073741826 code_size: 31, table: 4096
         //
         verifyException("org.apache.commons.imaging.common.mylzw.MyLzwDecompressor", e);
      }
  }
