...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", 112);
      assertEquals(0, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn(1881).when(response0).code();
  ...
  public void test03()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("9b(k7zE~1t0k").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "n88Xn;9K";
      stringArray0[1] = "Vary";
      stringArray0[2] = "Vary";
      stringArray0[3] = "Vary";
      stringArray0[4] = "n88Xn;9K";
      stringArray0[5] = "Vary";
      stringArray0[6] = "Vary";
      stringArray0[7] = "Vary";
  ...
  public void test06()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("xr'@et!!%>-0", 0, "xr'@et!!%>-0");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("TnA!6/$[UgcrQ+/", (-356));
  ...
  public void test10()  throws Throwable  {
      ...
      stringArray0[1] = "builder.name == null";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 4256);
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 1249, "");
        fail("Expecting exception: NullPointerException");
  ...
  public void test15()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("", (-1465802225), "HEAD");
  ...
  public void test16()  throws Throwable  {
      ...
      String[] stringArray0 = new String[4];
      stringArray0[0] = "UB!c%MdOrlfIN}N-s";
      stringArray0[1] = "4Fo:`D'Zl8(#XR~X";
      stringArray0[2] = "Q; Qt%o97Y=%d;";
      stringArray0[3] = "";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test17()  throws Throwable  {
      ...
      HttpUrl httpUrl1 = httpUrl0.resolve("v8?dnwd\"!*<");
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds(".Cy9N>R", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 4167);
      assertEquals(4167, int0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 45);
  ...
  public void test22()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "hccxl<u)?h&hg(6uv:";
      stringArray0[1] = "Z)y}lC{Jf";
      stringArray0[2] = "8?q";
      stringArray0[3] = "expected leading [0-9] or '-' character but was 0x";
      stringArray0[4] = "^";
      stringArray0[5] = "Z)y}lC{Jf";
      stringArray0[6] = "8?q";
      stringArray0[7] = "expected leading [0-9] or '-' character but was 0x";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
  ...
  public void test23()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>(4256);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test28()  throws Throwable  {
      ...
      hashMap0.merge("; realm9n=", "; realm9n=", biFunction0);
      hashMap0.put("vary", "; realm9n=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x20 at 1 in header name: ; realm9n=
         //
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("HEAD", (-1057));
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-2578));
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 2017, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "T5{E.eu PN4n!XIM!");
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", (-688));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("9", 204);
      assertEquals(9, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("public, ", 7);
      assertEquals(8, int0);
  }
  ...
  public void test42()  throws Throwable  {
      String string0 = "U_\\u[";
      int int0 = HttpHeaders.skipUntil(string0, 0, "HEAD");
      assertEquals(5, int0);
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("_Ve%J7tqs<k?i", 27, "_Ve%J7tqs<k?i");
  ...
  public void test48()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("4&kh,T(N3jKhT").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(0).when(response0).code();
      doReturn(request0).when(response0).request();
      HttpHeaders.hasBody(response0);
  ...
  public void test51()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("; 3realm)=", "; 3realm)=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "; 3realm)=");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("%2e%2e", "%2e%2e");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "%2e%2e");
      assertEquals(0, list0.size());
  }
