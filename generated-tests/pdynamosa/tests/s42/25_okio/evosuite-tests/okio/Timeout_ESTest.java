...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      timeout0.deadline(169L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(481L, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1392409281316759L));
      long long0 = timeout0.deadlineNanoTime();
      assertEquals((-1392409281316759L), long0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      timeout0.timeout(3062L, timeUnit0);
      timeout0.deadline(3062L, timeUnit0);
      assertEquals(264556800000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(3062L, timeUnit0);
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-2057L));
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.timeout(969L, timeUnit0);
      Object object0 = new Object();
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1431L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(22L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1392409281322586L), (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // timeout < 0: -1392409281322586
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.NONE.timeout(1542L, timeUnit0);
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime((-1392409281320001L));
      assertFalse(timeout1.equals((Object)timeout0));
  }
