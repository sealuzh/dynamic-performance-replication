...
public class JRip_ESTest extends JRip_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("zz", "zz");
  ...
  public void test001()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("EyJ3]cvBQmO");
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
      assertEquals(Double.NaN, jRip_NumericAntd0.getAttrValue(), 0.01);
      
      jRip_NumericAntd0.value = (double) 1;
      String string0 = jRip_NumericAntd0.toString();
      assertEquals("EyJ3]cvBQmO >= NaN", string0);
  }
  ...
  public void test002()  throws Throwable  {
      ...
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(2856, intArray0, (-62));
      Attribute attribute0 = new Attribute("EyJ3]cvBQmO");
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
      assertEquals(Double.NaN, jRip_NumericAntd0.getAttrValue(), 0.01);
  ...
  public void test005()  throws Throwable  {
      ...
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("relational", arrayList0, 1);
      jRip_NominalAntd0.splitData(instances0, 1, (-62.0));
      assertEquals(0.0, jRip_NominalAntd0.getMaxInfoGain(), 0.01);
      assertEquals(1L, jRip0.getSeed());
      assertTrue(jRip0.getCheckErrorRate());
      assertTrue(jRip0.getUsePruning());
  ...
  public void test017()  throws Throwable  {
      JRip jRip0 = new JRip();
      jRip0.setMinNo(2731.7203679439);
      assertEquals(2731.7203679439, jRip0.getMinNo(), 0.01);
  }

  @Test(timeout = 4000)
  public void test018()  throws Throwable  {
      JRip jRip0 = new JRip();
      jRip0.setMinNo((-736.2094771662479));
      double double0 = jRip0.getMinNo();
      assertEquals((-736.2094771662479), double0, 0.01);
  }
  ...
  public void test025()  throws Throwable  {
      ...
      try { 
        jRip0.rulesetForOneClass(1828.613993, instances0, 1.0, (-2946.40865748));
  ...
  public void test030()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jRip0.getMeasure("OP<gcvUdOx");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // OP<gcvUdOx not supported (RIPPER)
         //
         verifyException("weka.classifiers.rules.JRip", e);
      }
  }
  ...
  public void test031()  throws Throwable  {
      ...
      DenseInstance denseInstance0 = new DenseInstance((-283.0), doubleArray0);
      // Undeclared exception!
      try { 
  ...
  public void test032()  throws Throwable  {
      ...
      SparseInstance sparseInstance0 = new SparseInstance(4, doubleArray0, intArray0, (-74));
      // Undeclared exception!
      try { 
  ...
  public void test045()  throws Throwable  {
      ...
      jRip0.setUsePruning(false);
      try { 
        jRip0.rulesetForOneClass((byte)0, instances0, 1129.80525209273, 4.0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test049()  throws Throwable  {
      ...
      jRip0.setUsePruning(false);
      try { 
        jRip0.rulesetForOneClass((-1462.1), instances0, (-1462.1), 1828.613993);
        fail("Expecting exception: RuntimeException");
  ...
  public void test055()  throws Throwable  {
      ...
      double[] doubleArray0 = new double[1];
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance((-62.0), doubleArray0);
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute0);
      assertEquals(Double.NaN, jRip_NominalAntd0.getAttrValue(), 0.01);
  ...
  public void test056()  throws Throwable  {
      JRip jRip0 = new JRip();
      int[] intArray0 = new int[2];
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance((-1208), intArray0, (-62));
      Attribute attribute0 = new Attribute("EyJ3]cvBQm)");
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute0);
      boolean boolean0 = jRip_NominalAntd0.covers(binarySparseInstance0);
      assertEquals(Double.NaN, jRip_NominalAntd0.getCover(), 0.01);
      assertEquals(0.0, jRip_NominalAntd0.getMaxInfoGain(), 0.01);
  ...
  public void test060()  throws Throwable  {
      ...
      jRip_NumericAntd0.value = (-2931.54000790548);
      String string0 = jRip_NumericAntd0.toString();
      assertEquals("EyJ3]cvBQm) >= NaN", string0);
  }
  ...
  public void test062()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("I7");
  ...
  public void test063()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jRip_NumericAntd0.splitData(instances0, 4, 970.76100906);
        fail("Expecting exception: RuntimeException");
  ...
  public void test064()  throws Throwable  {
      ...
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("!p", arrayList0, 0);
      jRip_NumericAntd0.splitData(instances0, (-0.5), (-514.4344));
  ...
  public void test066()  throws Throwable  {
      ...
      stringArray0[1] = "BB'";
      stringArray0[2] = "\n*** Optimization: run #";
      stringArray0[3] = "little";
      stringArray0[4] = "VpR4C ,@WeCD*x:";
      stringArray0[5] = "iUH5";
      stringArray0[6] = "PS.  We have compared this implementation with the original ripper ";
      stringArray0[7] = "Mbe68n$e:LoN9%%3C!";
      stringArray0[8] = "(";
      jRip0.setOptions(stringArray0);
  ...
  public void test073()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("Zsda!325Ka:x.", (List<String>) null);
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute0);
      String string0 = jRip_NominalAntd0.toString();
      assertTrue(jRip0.getCheckErrorRate());
      assertTrue(jRip0.getUsePruning());
      assertEquals("Zsda!325Ka:x. = ", string0);
      assertEquals(2.0, jRip0.getMinNo(), 0.01);
      assertEquals(1L, jRip0.getSeed());
      assertEquals(0.0, jRip_NominalAntd0.getMaxInfoGain(), 0.01);
      assertEquals(Double.NaN, jRip_NominalAntd0.getAttrValue(), 0.01);
  ...
  public void test100()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("", "{a,", 93);
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
  ...
  public void test103()  throws Throwable  {
      ...
      Properties properties0 = new Properties();
      ProtectedProperties protectedProperties0 = new ProtectedProperties(properties0);
      Attribute attribute0 = new Attribute("eiJ8!Nf4W", list0, protectedProperties0);
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute0);
  ...
  public void test104()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("-O <number of runs>", (-765));
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
  ...
  public void test106()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("Determines the amount of data used for pruning. One fold is used for pruning, the rest for growing the rules.", linkedList0, 4296);
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
