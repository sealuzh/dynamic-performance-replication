...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      distinguishedNameParser0.findMostSpecific("ej_fib=#");
      distinguishedNameParser0.findMostSpecific("ej_fib=#");
      x500Principal0.equals(hashMap0);
      distinguishedNameParser0.findMostSpecific("<Dc%XN4bi{>[W");
      x500Principal0.getName();
      distinguishedNameParser0.findMostSpecific("6K<w");
      hashMap0.replace("", "", "RFC2253");
      distinguishedNameParser0.findMostSpecific("");
      distinguishedNameParser0.findMostSpecific("6K<w");
      distinguishedNameParser0.findMostSpecific("6K<w");
      distinguishedNameParser0.findMostSpecific("");
