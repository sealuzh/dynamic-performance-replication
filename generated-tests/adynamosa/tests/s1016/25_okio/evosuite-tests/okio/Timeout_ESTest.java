...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(3804L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(2333L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(2333000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1204L));
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout1.timeout(1512L, timeUnit0);
      assertEquals(90720000000000L, timeout1.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1198L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.deadline(415L, timeUnit0);
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1727L, timeUnit0);
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(2455L, timeUnit0);
      timeout1.deadlineNanoTime(837L);
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1294L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.deadline(881L, timeUnit0);
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(126000L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1698L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3804L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1327L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-1813L));
