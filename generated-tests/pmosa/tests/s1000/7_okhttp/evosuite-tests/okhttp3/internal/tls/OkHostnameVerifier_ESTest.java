...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      ...
      okHostnameVerifier0.INSTANCE.verify(".", x509Certificate3);
      ...
      doReturn((X500Principal) null).when(x509Certificate5).getSubjectX500Principal();
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("", x509Certificate5);
        fail("Expecting exception: NullPointerException");
  ...
  public void test4()  throws Throwable  {
      ...
      OkHostnameVerifier okHostnameVerifier0 = OkHostnameVerifier.INSTANCE;
      boolean boolean0 = okHostnameVerifier0.verify("iUmm{vMsovLuG", x509Certificate0);
      assertFalse(boolean0);
  }
}
