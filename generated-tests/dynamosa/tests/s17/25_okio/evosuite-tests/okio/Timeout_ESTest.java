...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(768L, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      timeout1.deadline(995L, timeUnit0);
      assertEquals(3582000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      timeout0.deadline(2157L, timeUnit0);
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1158L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline((-527L), timeUnit0);
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1661L);
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout2 = timeout0.timeout(1661L, timeUnit0);
      try { 
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(9223372036854775776L);
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1961L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1732L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime(1435L);
      assertSame(timeout1, timeout0);
  }
