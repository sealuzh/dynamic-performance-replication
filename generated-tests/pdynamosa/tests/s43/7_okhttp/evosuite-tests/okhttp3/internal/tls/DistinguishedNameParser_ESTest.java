...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=&H");
  ...
  public void test1()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=1H[");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
  ...
  public void test2()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=Oj|:{)U=H0[#");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("st");
      assertNotNull(string0);
      assertEquals("Oj|:{)U=H0[#", string0);
  }
  ...
  public void test3()  throws Throwable  {
      ...
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("okhttp3.internal.tls.DistinguishedNameParser");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=Oj1:(-)I=xH 0");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("s=Oj1:(-)I=xH 0");
      assertNull(string0);
  }
}
