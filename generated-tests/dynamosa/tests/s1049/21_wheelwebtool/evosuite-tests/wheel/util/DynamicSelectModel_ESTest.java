...
public class DynamicSelectModel_ESTest extends DynamicSelectModel_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      ActionExpression actionExpression0 = new ActionExpression("org.mvel.conversion.BigIntegerCH$3");
  ...
  public void test12()  throws Throwable  {
      ErrorPage errorPage0 = new ErrorPage();
      Label label0 = new Label(errorPage0, "wheel.util.DynamicSelectModel");
  ...
  public void test16()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration(":is?");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.translateValue(":is?");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // java.lang.ClassNotFoundException: Class '29.class' should be in target project, but could not be found!
         //
  ...
  public void test19()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("#;f[piI5Vp3tR");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.translateValue("#;f[piI5Vp3tR");
  ...
  public void test21()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("18,~8");
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("~>V~Dib.vM|/nT7L");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.translateValue("~>V~Dib.vM|/nT7L");
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("/+Q\"ON");
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getValue(1263);
        fail("Expecting exception: RuntimeException");
  ...
  public void test26()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("ae]4MF");
      // Undeclared exception!
      dynamicSelectModel1.getValue(1065);
  }

  @Test(timeout = 4000)
  public void test27()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("*YXt1q[");
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getValue(229);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("?gIm.Sr84P6--->");
      // Undeclared exception!
      try { 
  ...
  public void test33()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("/w]B[YQNYVc-!j>EKm");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.getOptionCount();
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test35()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection(" ?Jv{\"*dnE@S");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.getOptionCount();
        fail("Expecting exception: ClassCastException");
  ...
  public void test36()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("%0,$9<");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getOptionCount();
        fail("Expecting exception: ArithmeticException");
  ...
  public void test37()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("C[@4");
      // Undeclared exception!
  ...
  public void test40()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("?m\"pxC={%=='K7T;6");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getObjects();
        fail("Expecting exception: ClassCastException");
  ...
  public void test41()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("%0,$9<");
      // Undeclared exception!
      try { 
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getLabel((-1186));
        fail("Expecting exception: RuntimeException");
  ...
  public void test43()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("Qap^$jI .V*.8jzaeb");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getLabel((-2732));
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Could not evaluate expression Qap^$jI .V*.8jzaeb.values() to create a dynamic ISelectModel.
         //
         verifyException("wheel.components.ElExpression", e);
      }
  }
  ...
  public void test44()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("3F[?, TkZRIVqNIx8");
      // Undeclared exception!
  ...
  public void test45()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("*YXt1q[");
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel1.getLabel((-2490));
        fail("Expecting exception: NullPointerException");
  ...
  public void test47()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("y.=&2:?~iA^O_]f");
      // Undeclared exception!
      try { 
  ...
  public void test68()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("#;f[piI5Vp3tR");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.getObjects();
        fail("Expecting exception: StringIndexOutOfBoundsException");
