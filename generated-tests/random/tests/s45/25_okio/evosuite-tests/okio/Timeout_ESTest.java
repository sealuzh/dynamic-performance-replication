...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-754L));
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime(543L);
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(1532L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(1532L, timeout0.timeoutNanos());
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(543L, timeUnit0);
      timeout0.timeout(1L, timeUnit0);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(543L, timeUnit0);
      timeout1.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1998L, (TimeUnit) null);
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-464L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3295L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2229L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
