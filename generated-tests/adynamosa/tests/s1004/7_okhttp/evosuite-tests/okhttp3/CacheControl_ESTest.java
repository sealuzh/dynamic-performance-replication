...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxStale((-1311), timeUnit0);
  ...
  public void test10()  throws Throwable  {
      ...
      cacheControl_Builder0.minFresh(2705, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      int int0 = cacheControl0.minFreshSeconds();
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.mustRevalidate());
      assertEquals((-1), cacheControl0.maxAgeSeconds());
      assertEquals(233712000, int0);
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertFalse(cacheControl0.isPublic());
  }
  ...
  public void test13()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      cacheControl_Builder0.maxAge(2751, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-312), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      cacheControl_Builder0.minFresh(152, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      String string0 = cacheControl0.toString();
  ...
  public void test23()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      cacheControl_Builder0.maxAge(748, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      String string0 = cacheControl0.toString();
  ...
  public void test25()  throws Throwable  {
      ...
      Headers.Builder headers_Builder1 = headers_Builder0.add("cache-control", "0000ffff");
      Headers.Builder headers_Builder2 = headers_Builder1.addLenient("cache-control", "cache-control");
      headers_Builder0.add("0000ffff", "only-if-cached");
      Headers.Builder headers_Builder3 = new Headers.Builder();
      Headers.Builder headers_Builder4 = headers_Builder2.addLenient("cache-control", "only-if-cached");
      headers_Builder2.removeAll("only-if-cached");
      headers_Builder1.add("max-age=", "no-store, ");
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[0] = "no-cache, no-store, max-age=2640";
      stringArray0[1] = "no-cache, no-store, max-age=2640";
      stringArray0[2] = "5u#|y*p1r4ql_)!p<0";
      stringArray0[3] = "5u#|y*p1r4ql_)!p<0";
      stringArray0[4] = "no-cache, no-store, max-age=2640";
      stringArray0[5] = "5u#|y*p1r4ql_)!p<0";
      stringArray0[6] = "cache-control";
      stringArray0[7] = "no-cache, no-store, max-age=2640";
      ...
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.noTransform());
      assertEquals(2640, cacheControl0.maxAgeSeconds());
  ...
  public void test32()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.add("cache-control", "S\"euJr<P`dY@;");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.maxAgeSeconds());
      assertFalse(cacheControl0.noStore());
  ...
  public void test33()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "no-cache, max-age=2640, min-fresh=2640";
      stringArray0[1] = "no-cache, max-age=2640, min-fresh=2640";
      stringArray0[2] = "5u#|y*p1r4ql_)!p<0";
      stringArray0[3] = "5u#|y*p1r4ql_)!p<0";
      stringArray0[4] = "no-cache, max-age=2640, min-fresh=2640";
      stringArray0[5] = "5u#|y*p1r4ql_)!p<0";
      stringArray0[6] = "cache-control";
      stringArray0[7] = "no-cache, max-age=2640, min-fresh=2640";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.onlyIfCached());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      ...
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertFalse(cacheControl0.noStore());
      assertEquals(2640, cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.mustRevalidate());
      assertFalse(cacheControl0.isPrivate());
      assertTrue(cacheControl0.noCache());
      assertFalse(cacheControl0.isPublic());
  ...
  public void test34()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.add("cache-control", "[text=");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.maxAgeSeconds());
      assertFalse(cacheControl0.noStore());
  ...
  public void test35()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.add("pragma", "(MW-ul^5.g?hwz");
