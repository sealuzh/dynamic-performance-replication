...
public class JSState_ESTest extends JSState_ESTest_scaffolding {
  ...
  public void test5()  throws Throwable  {
      ...
      jSPlan0.add((Object) "<STATE>.apply(<JSPlan>) not implemented yet");
      jSState0.addElement(jSPlan0);
      JSSubstitution jSSubstitution0 = new JSSubstitution();
      jSState0.addElementsToState(jSPlan0);
      jSState0.apply(jSPlan0);
      assertEquals("[<STATE>.apply(<JSPlan>) not implemented yet, [<STATE>.apply(<JSPlan>) not implemented yet]]", jSState0.toString());
  }
