...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2718000000000000L);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.timeout(3054L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(263865600000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(3054L, timeUnit0);
      timeout0.deadlineNanoTime(1213L);
      assertEquals(263865600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      timeout0.deadline(775L, timeUnit0);
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(1438909281320000L, long0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2504L, timeUnit0);
      timeout1.deadline(1462L, timeUnit0);
      assertEquals(2504000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(399L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(23940000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1490L), timeUnit0);
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2836L);
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout2 = timeout1.timeout(2836L, timeUnit0);
      try { 
  ...
  public void test20()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2718000000000000L);
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(193L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3600000000000000000L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2089L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.timeout(1448L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeout0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.NONE.timeout((-997L), timeUnit0);
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-697L));
