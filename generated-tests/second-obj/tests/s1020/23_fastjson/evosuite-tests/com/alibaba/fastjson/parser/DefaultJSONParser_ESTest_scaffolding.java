...
public class DefaultJSONParser_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("com.alibaba.fastjson.parser.deserializer.ExtraProcessor", false, DefaultJSONParser_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("java.util.function.BiFunction", false, DefaultJSONParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, DefaultJSONParser_ESTest_scaffolding.class.getClassLoader()));
  }
