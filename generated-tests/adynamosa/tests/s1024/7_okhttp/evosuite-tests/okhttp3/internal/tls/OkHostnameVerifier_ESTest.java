...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.INSTANCE.verify((String) null, (SSLSession) null);
  ...
  public void test6()  throws Throwable  {
      ...
      doReturn((Collection) null, (Collection) null, (Collection) null).when(x509Certificate2).getSubjectAlternativeNames();
      OkHostnameVerifier.allSubjectAltNames(x509Certificate2);
      LinkedList<List<String>> linkedList4 = new LinkedList<List<String>>();
      ...
      okHostnameVerifier1.INSTANCE.verify("..", x509Certificate3);
      LinkedList<List<Object>> linkedList5 = new LinkedList<List<Object>>();
      Certificate[] certificateArray0 = new Certificate[6];
      certificateArray0[0] = (Certificate) x509Certificate2;
      certificateArray0[1] = (Certificate) x509Certificate3;
      certificateArray0[2] = (Certificate) x509Certificate2;
      certificateArray0[3] = (Certificate) x509Certificate0;
      certificateArray0[4] = (Certificate) x509Certificate1;
      certificateArray0[5] = (Certificate) x509Certificate2;
      SSLSession sSLSession0 = mock(SSLSession.class, new ViolatedAssumptionAnswer());
      ...
      okHostnameVerifier0.verify("..", x509Certificate4);
      boolean boolean0 = okHostnameVerifier1.verify("..", sSLSession0);
  ...
  public void test7()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("oX3X6v&Mb", x509Certificate0);
        fail("Expecting exception: NullPointerException");
