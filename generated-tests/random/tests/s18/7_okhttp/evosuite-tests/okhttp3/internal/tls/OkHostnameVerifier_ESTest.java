...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.INSTANCE.verify("#1I/Lm-jE,NEz", (X509Certificate) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("byteString == null", x509Certificate0);
        fail("Expecting exception: NullPointerException");
