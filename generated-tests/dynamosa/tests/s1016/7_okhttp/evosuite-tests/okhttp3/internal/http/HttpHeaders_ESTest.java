...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("sink == null", 12);
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn("1k").when(request0).method();
  ...
  public void test03()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("WLl@|(*$^BP,@Qf").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "; httponly";
      stringArray0[1] = "; httponly";
      stringArray0[2] = "; httponly";
      stringArray0[3] = "; httponly";
      stringArray0[4] = "; httponly";
      stringArray0[5] = "; httponly";
      stringArray0[6] = "; httponly";
      stringArray0[7] = "; httponly";
  ...
  public void test05()  throws Throwable  {
      ...
      stringArray0[1] = "Y%aXBk=?YG1b ,7wEUu";
      stringArray0[2] = "byteCount > Integer.MAX_VALUE: ";
      stringArray0[3] = "%K6]]HkQuxQMGEW";
      stringArray0[4] = "Vary";
      stringArray0[5] = "Xj8Q +0E/7lp,$A";
      Headers headers0 = Headers.of(stringArray0);
      Headers headers1 = HttpHeaders.varyHeaders(headers0, headers0);
  ...
  public void test06()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("#bx%_1Yt(g*", 0);
      assertEquals(0, int0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      doReturn((Headers) null).when(response0).headers();
      String[] stringArray0 = new String[8];
      stringArray0[0] = "Q1;|drV%Kt1t6_;U";
      stringArray0[1] = "Q1;|drV%Kt1t6_;U";
      stringArray0[2] = "Q1;|drV%Kt1t6_;U";
      stringArray0[3] = "3e+q#n<|";
      stringArray0[4] = "3e+q#n<|";
      stringArray0[5] = "Q1;|drV%Kt1t6_;U";
      stringArray0[6] = "Q1;|drV%Kt1t6_;U";
      stringArray0[7] = "Q1;|drV%Kt1t6_;U";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("", (-685));
  ...
  public void test15()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("#b%_1Yt(gv*", 0, "#b%_1Yt(gv*");
      assertEquals(0, int0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      HttpUrl httpUrl1 = httpUrl0.resolve("6_D8Pg'{W?#AN");
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test20()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("k#jU gL0C}k", 0);
      assertEquals(0, int0);
  }
  ...
  public void test22()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", (-425));
  ...
  public void test25()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, " +([^ \"=]*)=(:?\"([^\"]*)\"|([^ %=]*)) D(:?,|$)");
  ...
  public void test27()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("unexpected path segment:", "unexpected path segment:");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test32()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x20 at 6 in header name: method == null
         //
  ...
  public void test34()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-1550));
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("doma+in", (-2441), "doma+in");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test36()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 122, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "(t`MKD%uDb<Zhv~Ru");
        fail("Expecting exception: NullPointerException");
  ...
  public void test41()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = ",";
      stringArray0[1] = "-2)q?#;}i1M/caj";
      stringArray0[2] = "Vary";
      stringArray0[3] = "-2)q?#;}i1M/caj";
      stringArray0[4] = "Vary";
      stringArray0[5] = "-2)q?#;}i1M/caj";
      Headers headers0 = Headers.of(stringArray0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertTrue(set0.contains("-2)q?#;}i1M/caj"));
  }
  ...
  public void test43()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-2", (-2075974720));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("1", (-19));
      assertEquals(1, int0);
  }
  ...
  public void test46()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("yWd", 832);
      assertEquals(832, int0);
  }

  @Test(timeout = 4000)
  public void test47()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("+15M`QdGXgQT1~v", 5, "(");
  ...
  public void test48()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("-K2T").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test50()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("; httponly").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(1279).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test51()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("= Lttp0nly").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test52()  throws Throwable  {
      ...
      stringArray0[0] = "#bx%_1Yt(g*";
      stringArray0[1] = "#bx%_1Yt(g*";
      stringArray0[2] = "#bx%_1Yt(g*";
      stringArray0[3] = "#bx%_1Yt(g*";
      Headers headers0 = Headers.of(stringArray0);
      CookieJar cookieJar0 = mock(CookieJar.class, new ViolatedAssumptionAnswer());
  ...
  public void test53()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.putIfAbsent("X1-&A/(*`<e|be:$Y", "|([^ <=v]*)");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "X1-&A/(*`<e|be:$Y");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test54()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.putIfAbsent("X1-&+/(*`<e|be:$Y", "X1-&+/(*`<e|be:$Y");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "X1-&+/(*`<e|be:$Y");
      assertEquals(0, list0.size());
  }
  ...
  public void test55()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("`; realml=", "`; realml=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "`; realml=");
      assertEquals(0, list0.size());
  }
