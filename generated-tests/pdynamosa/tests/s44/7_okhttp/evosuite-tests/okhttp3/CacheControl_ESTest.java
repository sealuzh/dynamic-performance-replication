...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-544), timeUnit0);
  ...
  public void test20()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      cacheControl_Builder0.maxAge(2390, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
      int int0 = cacheControl0.maxAgeSeconds();
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertEquals((-1), cacheControl0.minFreshSeconds());
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1346), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      hashMap0.put("9ximg#o',", "9ximg#o',");
      Headers.of((Map<String, String>) hashMap0);
      String string0 = cacheControl0.toString();
      //  // Unstable assertion: assertNotNull(string0);
      //  // Unstable assertion: assertEquals("public, ", string0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      cacheControl0.FORCE_CACHE.headerValue = "max-stale=2147483647, only-if-cached";
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.addLenient("H?\u0007T;SX]@W", "only-if-cached, ");
      Headers.Builder headers_Builder2 = headers_Builder1.set("iR\"_}{E=^MlO", ";vDdyN'oo`XH");
      Headers.Builder headers_Builder3 = headers_Builder2.removeAll("only-if-cached, ");
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder1.minFresh((-107), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      ...
      String string0 = cacheControl0.toString();
      assertEquals("no-cache, must-revalidate", string0);
  }
  ...
  public void test35()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.add("cache-control", "ir\"_}{e=^mlo");
      Headers headers0 = new Headers(headers_Builder1);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.mustRevalidate());
      assertEquals((-1), cacheControl0.maxAgeSeconds());
