...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      timeout0.timeout(523L, timeUnit0);
      assertEquals(31380000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1141L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.deadline(952L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(1090L, timeUnit0);
      Timeout timeout2 = timeout1.deadline(1090L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1392409962320000L);
      timeout0.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(373L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
