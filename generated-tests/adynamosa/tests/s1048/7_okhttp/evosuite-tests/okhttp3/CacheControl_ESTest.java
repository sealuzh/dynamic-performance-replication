...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxStale((-1351), timeUnit0);
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[1] = "no-store, max-stale=3801600, min-fresh=0, only-if-cached";
  ...
  public void test10()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      cacheControl_Builder0.minFresh(1767, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
  ...
  public void test11()  throws Throwable  {
      ...
      cacheControl_Builder0.minFresh(1346, timeUnit0);
  ...
  public void test12()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxStale(44, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder1.build();
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-100), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1419), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      assertEquals("no-cache, no-store, max-age=0, no-transform", string0);
      
      String string1 = cacheControl0.toString();
      assertEquals("no-store", string1);
      
      cacheControl1.minFreshSeconds();
      String[] stringArray0 = new String[4];
      stringArray0[0] = "no-cache, no-store, max-age=0, no-transform";
      stringArray0[1] = "max-stale=2147483647, only-if-cached";
      stringArray0[2] = "pragma";
      stringArray0[3] = "no-cache, no-store, max-age=0, no-transform";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test27()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = "no-cache, no-store, max-age=3801600, max-stale=0, min-fresh=3801600, only-if-cached, no-transform";
      stringArray0[1] = "ac9#lk(yzxj{\"ox";
      stringArray0[2] = "pragma";
      stringArray0[3] = "no-cache, no-store, max-age=3801600, max-stale=0, min-fresh=3801600, only-if-cached, no-transform";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertTrue(cacheControl0.noStore());
  ...
  public void test30()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("cache-control", "; charset=utf-8");
      Headers.Builder headers_Builder1 = headers_Builder0.addLenient("cache-control", "must-revalidate");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[0] = "0H{a.m~yjQ{>";
      stringArray0[1] = "cache-control";
      stringArray0[2] = "0H{a.m~yjQ{>";
      stringArray0[3] = "0H{a.m~yjQ{>";
      stringArray0[4] = "cache-control";
      stringArray0[5] = "l =\"TT42";
      stringArray0[6] = "l =\"TT42";
