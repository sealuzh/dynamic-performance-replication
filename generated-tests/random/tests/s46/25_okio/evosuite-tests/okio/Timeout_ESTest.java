...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(29L, timeUnit0);
      TimeUnit timeUnit1 = TimeUnit.DAYS;
      timeout1.deadline(2153L, timeUnit1);
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1980L);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1401L));
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-2162L));
      try { 
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.deadline(1980L, timeUnit0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(3098L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1133L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(2153L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(object0);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3098L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.NONE.timeout(1308L, timeUnit0);
