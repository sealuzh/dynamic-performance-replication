...
public class Site_ESTest extends Site_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Site site0 = Site.me();
      Site site1 = site0.setCharset("QqIQ");
      site1.getAllCookies();
      assertEquals(0, site1.getCycleRetryTimes());
      assertFalse(site1.isDisableCookieManagement());
      assertEquals(0, site1.getRetryTimes());
  ...
  public void test10()  throws Throwable  {
      Site site0 = new Site();
      site0.setRetrySleepTime((-1795));
      site0.getCookies();
      assertEquals((-1795), site0.getRetrySleepTime());
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Site site0 = Site.me();
      site0.setUserAgent("zd9!INBK#3+[@l");
      site0.hashCode();
      assertEquals(0, site0.getRetryTimes());
      assertEquals(0, site0.getCycleRetryTimes());
      assertFalse(site0.isDisableCookieManagement());
  ...
  public void test15()  throws Throwable  {
      Site site0 = Site.me();
      Site site1 = site0.setDomain("-'mJ7+!`");
      site0.hashCode();
      int int0 = site1.getRetryTimes();
      assertEquals(0, int0);
      
      String string0 = site0.toString();
      assertEquals("Site{domain='-'mJ7+!`', userAgent='null', cookies={}, charset='null', sleepTime=5000, retryTimes=0, cycleRetryTimes=0, timeOut=5000, acceptStatCode=[200], headers={}}", string0);
      assertEquals(1000, site0.getRetrySleepTime());
  }
  ...
  public void test21()  throws Throwable  {
      Site site0 = new Site();
      site0.addCookie("}X7^qE9e~h", "}X7^qE9e~h", "}X7^qE9e~h");
      Site site1 = site0.addCookie("}X7^qE9e~h", "}X7^qE9e~h", (String) null);
      assertFalse(site1.isDisableCookieManagement());
      assertEquals(0, site1.getCycleRetryTimes());
      assertEquals(0, site1.getRetryTimes());
      assertEquals(5000, site1.getSleepTime());
  ...
  public void test27()  throws Throwable  {
      Site site0 = new Site();
      Site site1 = Site.me();
      site1.setSleepTime((-627));
      boolean boolean0 = site0.equals(site1);
      assertEquals((-627), site1.getSleepTime());
      assertFalse(boolean0);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Site site2 = site0.setDomain("#\"b+4:O,yNH1bF:6D");
      boolean boolean0 = site0.equals(site1);
      assertFalse(boolean0);
  ...
  public void test35()  throws Throwable  {
      ...
      Site site2 = site1.setUserAgent(", userAgent='");
      site0.equals(site2);
      site0.hashCode();
      assertEquals(5000, site0.getSleepTime());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      Site site2 = site1.setDomain(", userAgent='");
      boolean boolean0 = site0.equals(site2);
      assertFalse(boolean0);
  ...
  public void test38()  throws Throwable  {
      Site site0 = new Site();
      Site site1 = Site.me();
      Site site2 = site0.setCharset("uvXj;'3arlb'q&y>C");
      assertFalse(site2.equals((Object)site1));
      
      site1.setCharset("uvXj;'3arlb'q&y>C");
      boolean boolean0 = site0.equals(site1);
  ...
  public void test39()  throws Throwable  {
      Site site0 = new Site();
      Site site1 = site0.setUserAgent(", userAgZnt='");
      Site site2 = new Site();
      assertFalse(site2.equals((Object)site1));
      
      Site site3 = site2.setUserAgent(", userAgZnt='");
      site1.equals(site3);
      site2.hashCode();
  ...
  public void test40()  throws Throwable  {
      ...
      site0.toString();
      Site site1 = new Site();
      Site site2 = site0.addCookie("Site{domain='null', userAgent='null', cookies={}, charset='null', sleepTime=5000, retryTimes=0, cycleRetryTimes=0, timeOut=5000, acceptStatCode=[200], headers={}}", "Site{domain='null', userAgent='null', cookies={}, charset='null', sleepTime=5000, retryTimes=0, cycleRetryTimes=0, timeOut=5000, acceptStatCode=[200], headers={}}", (String) null);
      assertTrue(site0.equals((Object)site1));
  ...
  public void test41()  throws Throwable  {
      ...
      site2.getRetrySleepTime();
      site1.getUserAgent();
      assertFalse(site1.equals((Object)site4));
  }
}
