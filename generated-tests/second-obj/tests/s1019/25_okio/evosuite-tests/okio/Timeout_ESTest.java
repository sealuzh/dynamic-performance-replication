...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.NONE.deadlineNanoTime((-1233L));
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-2394L));
      try { 
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1561L));
      try { 
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.timeout(2299L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(107L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2299L);
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout1.timeout(2299L, timeUnit0);
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1951L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
