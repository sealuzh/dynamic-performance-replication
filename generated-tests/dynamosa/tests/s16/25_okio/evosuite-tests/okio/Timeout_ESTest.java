...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        timeout1.waitUntilNotified("k62FJ.");
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      timeout0.timeout(2158L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(2158000L, long0);
  }
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      timeout0.deadline(2158L, timeUnit0);
  ...
  public void test05()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(874L, timeUnit0);
      timeout1.deadlineNanoTime(874L);
      assertEquals(874000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1963L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test08()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(920L, timeUnit0);
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(920L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(79488000000000000L, timeout0.timeoutNanos());
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-1392409281318396L));
      assertSame(timeout0, timeout1);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1450L), timeUnit0);
  ...
  public void test15()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(982L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.deadline(2158L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(4980L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(4980L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.timeout(2158L, timeUnit0);
      timeout1.deadline(2158L, timeUnit0);
      assertEquals(2158000L, timeout0.timeoutNanos());
  }
  ...
  public void test29()  throws Throwable  {
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.timeout(5364L, timeUnit0);
  ...
  public void test33()  throws Throwable  {
      ...
      assertEquals(1392409283478000L, long0);
  }
