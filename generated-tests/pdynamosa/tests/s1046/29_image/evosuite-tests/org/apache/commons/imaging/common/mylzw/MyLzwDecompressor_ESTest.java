...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)1, (byte)1, (byte)0}, byteArray1);
  }
  ...
  public void test5()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      ByteOrder byteOrder0 = ByteOrder.LITTLE_ENDIAN;
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((byte)8, byteOrder0, (MyLzwDecompressor.Listener) null);
  ...
  public void test8()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 1125);
        fail("Expecting exception: IOException");
  ...
  public void test9()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress((InputStream) null, (-714));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -714
         //
