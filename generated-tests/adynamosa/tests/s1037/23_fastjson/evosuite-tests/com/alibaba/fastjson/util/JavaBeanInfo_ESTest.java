...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test16()  throws Throwable  {
      ...
      doReturn(class0).when(jSONType0).builder();
      Class<?> class1 = JavaBeanInfo.getBuilderClass(class0, jSONType0);
      FieldInfo fieldInfo0 = new FieldInfo("laz", class0, class1, class1, (Field) null, 28, (-1877), 28);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      doReturn(".000000").when(jSONType0).typeKey();
      ...
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build(javaBeanInfo0.builderClass, (Type) class2, propertyNamingStrategy0, false, false);
  ...
  public void test23()  throws Throwable  {
      ...
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
      JavaBeanInfo.build(class2, (Type) class0, propertyNamingStrategy0, false, true);
  ...
  public void test25()  throws Throwable  {
      ...
      try {
        javaBeanInfo1 = new JavaBeanInfo(class2, class2, (Constructor<?>) null, javaBeanInfo0.creatorConstructor, (Method) null, (Method) null, (JSONType) null, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("andIncrement").when(jSONType0).typeKey();
      doReturn("andIncrement").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      FieldInfo fieldInfo0 = new FieldInfo("illegal json creator", class0, class0, class0, (Field) null, 8, 8, 8);
  ...
  public void test32()  throws Throwable  {
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Integer> class0 = Integer.class;
      FieldInfo fieldInfo0 = new FieldInfo("JJ=5LS0 \"~@k|g", class0, class0, class0, (Field) null, (-1968943022), 90, 200);
  ...
  public void test35()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("andIncrement", (String) null).when(jSONType0).typeKey();
      doReturn("andIncrement", (String) null).when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class0, class1, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      JavaBeanInfo javaBeanInfo1 = null;
      try {
        javaBeanInfo1 = new JavaBeanInfo(class0, class1, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, javaBeanInfo0.jsonType, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      doReturn(".000000", "").when(jSONType0).typeKey();
      doReturn("", "!#)~=$C{K>1").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      ...
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(class3, class1, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, javaBeanInfo0.jsonType, linkedList0);
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.KebabCase;
      JavaBeanInfo javaBeanInfo2 = JavaBeanInfo.build(javaBeanInfo1.clazz, (Type) javaBeanInfo0.clazz, propertyNamingStrategy0, true, true);
