...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.deadline(2445L, timeUnit0);
      Timeout timeout1 = timeout0.timeout(2445L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified("2hhotjw'jJyB");
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(1158L, timeUnit0);
      timeout1.deadlineNanoTime((-1L));
      assertEquals(1158000000L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(718L);
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-900L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals(211248000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test20()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(1968L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(4352400000000000L);
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-591L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(410L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-127L), (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(2156000000L, timeUnit0);
  ...
  public void test33()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime(6L);
      assertSame(timeout1, timeout0);
  }
