...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test7()  throws Throwable  {
      ...
      LinkedList<List<List<Integer>>> linkedList1 = new LinkedList<List<List<Integer>>>();
  ...
  public void test9()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("[TPCPv*@P", x509Certificate0);
        fail("Expecting exception: NullPointerException");
