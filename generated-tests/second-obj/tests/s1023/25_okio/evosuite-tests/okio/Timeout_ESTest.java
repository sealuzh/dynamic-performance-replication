...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.NONE.deadlineNanoTime((-1126L));
  ...
  public void test05()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.NONE.timeout(550L, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2117L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(2038L, timeUnit0);
  ...
  public void test12()  throws Throwable  {
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2022L);
      try { 
