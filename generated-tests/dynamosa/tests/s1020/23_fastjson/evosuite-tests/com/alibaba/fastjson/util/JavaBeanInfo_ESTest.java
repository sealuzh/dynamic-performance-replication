...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test27()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("serialze_features", class1, class1, class0, (Field) null, 3044, 3044, 3044);
      ...
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(class0, class3, javaBeanInfo0.creatorConstructor, (Constructor<?>) null, (Method) null, (Method) null, (JSONType) null, linkedList0);
  ...
  public void test28()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("equ", class1, class0, class0, (Field) null, 240, 240, (-194));
      linkedList0.add(fieldInfo0);
      linkedList0.add(fieldInfo0);
      String[] stringArray0 = new String[1];
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("Jr").when(jSONType0).typeKey();
      doReturn("Jr").when(jSONType0).typeName();
  ...
  public void test32()  throws Throwable  {
      ...
      Class<FieldInfo> class0 = FieldInfo.class;
      Class<String> class1 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("a", class1, class1, class0, (Field) null, 598, 598, 598);
      linkedList0.add(fieldInfo0);
      Class<Integer> class2 = Integer.class;
      FieldInfo fieldInfo1 = new FieldInfo("a", class1, class2, fieldInfo0.fieldType, (Field) null, 598, 598, 598);
  ...
  public void test33()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      FieldInfo fieldInfo0 = new FieldInfo("z", class0, class0, class0, (Field) null, 21, 21, 21);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<Void> class1 = Void.class;
      FieldInfo fieldInfo1 = new FieldInfo("z", class0, class1, class0, (Field) null, 21, 21, 21);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
      assertTrue(boolean0);
  }
  ...
  public void test34()  throws Throwable  {
      Class<FieldInfo> class0 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("fieldAnnotation", class0, class0, class0, (Field) null, (-2687), (-2687), (-2687));
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
  ...
  public void test38()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("*rqC}").when(jSONType0).typeKey();
      doReturn("*rqC}").when(jSONType0).typeName();
  ...
  public void test39()  throws Throwable  {
      ...
      doReturn("FQ`8ry:xY<3K^_yL").when(jSONType0).typeKey();
      doReturn("FQ`8ry:xY<3K^_yL").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo javaBeanInfo0 = null;
      try {
        javaBeanInfo0 = new JavaBeanInfo(class0, class0, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
