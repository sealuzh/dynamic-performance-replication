...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(103161600000000000L);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(3600000000000L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(3600000000000000L, long0);
  }
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1520L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test08()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1033L, timeUnit0);
      timeout1.deadline(1000000000000L, timeUnit0);
      assertEquals(89251200000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      timeout0.timeout(1185L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(1185L, timeout0.timeoutNanos());
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.timeout(344L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1787L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-675L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-638L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout((-1422L), timeUnit0);
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime(282000000000L);
