...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(788L, timeUnit0);
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-728L));
  ...
  public void test17()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime((-728L));
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(7333200000000000L, timeUnit0);
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1392409281320000L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // duration <= 0: -1392409281320000
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.NONE.deadline(1813L, timeUnit0);
