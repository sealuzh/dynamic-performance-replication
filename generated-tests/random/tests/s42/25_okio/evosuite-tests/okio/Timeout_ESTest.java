...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.timeout(870L, timeUnit0);
      timeout0.deadlineNanoTime(870L);
      try { 
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1257L));
  ...
  public void test10()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2119L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.deadlineNanoTime((-1257L));
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(4894L, (TimeUnit) null);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1393L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.deadline(2594L, timeUnit0);
      timeout0.throwIfReached();
      assertSame(timeout0, timeout1);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(547L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2520L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.timeout(2943L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(2943000L, timeout0.timeoutNanos());
  }
  ...
  public void test22()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(1741L);
