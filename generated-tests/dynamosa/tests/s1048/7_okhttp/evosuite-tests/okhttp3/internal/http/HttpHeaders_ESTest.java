...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(",", 64);
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn("[Twl~4c;5<>J47G").when(request0).method();
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "vary";
      stringArray0[1] = "fZ-9Scx";
      stringArray0[2] = "unexpected host: ";
      stringArray0[3] = "";
      stringArray0[4] = "fZ-9Scx";
  ...
  public void test12()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "=8RB]`FP#";
      stringArray0[1] = "=8RB]`FP#";
      stringArray0[2] = "=8RB]`FP#";
      stringArray0[3] = "=8RB]`FP#";
      stringArray0[4] = "=8RB]`FP#";
      stringArray0[5] = "=8RB]`FP#";
      Headers headers0 = Headers.of(stringArray0);
      Headers headers1 = HttpHeaders.varyHeaders(headers0, headers0);
      Set<String> set0 = HttpHeaders.varyFields(headers1);
      assertFalse(set0.contains("=8RB]`FP#"));
  }
  ...
  public void test15()  throws Throwable  {
      ...
      URL uRL1 = MockURL.URL(uRL0, "QC8TQh2?[#$}!IoO]6");
  ...
  public void test17()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("%ch", (-1739));
      assertEquals((-1739), int0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 11);
  ...
  public void test27()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Vary", "value == null");
      hashMap0.put("value == null", "value == null");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x20 at 5 in header name: value == null
         //
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("v,%#fbko", (-1995));
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-549), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "; ht?Jtponl]");
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      ...
      Headers headers0 = Headers.of(stringArray0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertFalse(set0.contains("%ch"));
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("8", 1243);
      assertEquals(8, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", 1101);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("; ht?Jtponl]", 1);
      assertEquals(2, int0);
  }
  ...
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("OetS+CF", 1, "; httponly");
      assertEquals(2, int0);
  }
  ...
  public void test43()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("okio.ByteString", (-24), "okio.ByteString");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("*", 204, "[Twl~4c;5<>J47G");
  ...
  public void test49()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("VsYknJ2Pn7bQ", "; realmol=]");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "VsYknJ2Pn7bQ");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test50()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("QNSu", "QNSu");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "QNSu");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test51()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("; ?Jponol=]", "; ?Jponol=]");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "; ?Jponol=]");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test56()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("6WZ8F>e").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
