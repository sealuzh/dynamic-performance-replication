...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      X500Principal x500Principal0 = new X500Principal("c=KQ%", map0);
  ...
  public void test1()  throws Throwable  {
      ...
      X500Principal x500Principal0 = new X500Principal("c=KQ%", map0);
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("c=KQ%");
      assertNull(string0);
  }
  ...
  public void test2()  throws Throwable  {
      ...
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("]g");
      assertNull(string0);
  }
