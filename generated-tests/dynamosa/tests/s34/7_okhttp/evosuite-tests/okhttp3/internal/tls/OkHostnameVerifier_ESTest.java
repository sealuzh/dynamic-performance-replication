...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.verify("\u0001Q~x`>CA", (SSLSession) null);
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // codegen.java.security.cert.Certificate$MockitoMock$161294994 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify(")(WMIu/Ms", (X509Certificate) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      ...
      doReturn(x500Principal0).when(x509Certificate0).getSubjectX500Principal();
      OkHostnameVerifier okHostnameVerifier0 = OkHostnameVerifier.INSTANCE;
      boolean boolean0 = okHostnameVerifier0.verify("cn", x509Certificate0);
      assertFalse(boolean0);
  }
