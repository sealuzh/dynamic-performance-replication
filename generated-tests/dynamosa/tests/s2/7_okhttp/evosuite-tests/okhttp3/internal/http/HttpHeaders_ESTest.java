...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("8", (-400));
      assertEquals(8, int0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "Vary";
      stringArray0[1] = "K+jZg8U,c$Iv4e?8x ";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test04()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("\"([^\"]*)\"", (-1218));
  ...
  public void test12()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil(".E9=i", 0, "");
      assertEquals(5, int0);
  }

  @Test(timeout = 4000)
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 12, "Content-Length");
  ...
  public void test14()  throws Throwable  {
      String[] stringArray0 = new String[2];
      stringArray0[0] = "?^YUKOLrt8bPn";
      stringArray0[1] = "?^YUKOLrt8bPn";
      Headers headers0 = Headers.of(stringArray0);
      CookieJar cookieJar0 = mock(CookieJar.class, new ViolatedAssumptionAnswer());
      URI uRI0 = MockURI.aHttpURI;
      HttpUrl httpUrl0 = HttpUrl.get(uRI0);
      HttpUrl httpUrl1 = httpUrl0.resolve("?^YUKOLrt8bPn");
  ...
  public void test17()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 2771);
  ...
  public void test20()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "unexpected path segment: ");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("_{+Px", (-26));
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("\"p:;G.Wo/^{", (-584), "\"p:;G.Wo/^{");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 248, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", (-2108));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("G'J?Hda ", 7);
      assertEquals(8, int0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("+Px", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("G3p/%;)aSK/", 0, "realm");
      assertEquals(7, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("_Fmx#tf-e8`.fa", 0, "_Fmx#tf-e8`.fa");
      assertEquals(0, int0);
  }
  ...
  public void test41()  throws Throwable  {
      ...
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(197).when(response0).code();
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("v/ay").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(197).when(response0).code();
      doReturn("v/ay").when(response0).header(anyString());
      doReturn(headers0).when(response0).headers();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertFalse(boolean0);
  ...
  public void test44()  throws Throwable  {
      ...
      doReturn("\"([^\"]*)\"").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(329).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test45()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("_Fmx#tf-e8`.fa").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test46()  throws Throwable  {
      CookieJar cookieJar0 = mock(CookieJar.class, new ViolatedAssumptionAnswer());
      String[] stringArray0 = new String[2];
      stringArray0[0] = "aorK`St/,rZwrgS8au]";
      stringArray0[1] = "aorK`St/,rZwrgS8au]";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test49()  throws Throwable  {
      ...
      stringArray0[3] = "+Px";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "+Px");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test53()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("content-length", "Ag-i8*CYL^?W");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
