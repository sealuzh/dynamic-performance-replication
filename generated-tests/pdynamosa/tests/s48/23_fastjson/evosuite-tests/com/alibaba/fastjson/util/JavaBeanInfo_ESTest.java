...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test21()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("SnakeCase", class2, class0, class0, (Field) null, 2266, (-1717), 9);
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("|%", class0, class1, class1, (Field) null, (-373), (-26), 16);
      linkedList0.add(fieldInfo1);
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(fieldInfo1.alternateNames).when(jSONType0).orders();
      doReturn("").when(jSONType0).typeKey();
      doReturn("I&k\\*oh T").when(jSONType0).typeName();
  ...
  public void test29()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      Class<AtomicLong> class1 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("|%", class0, class1, class1, (Field) null, 2293, 4, 16);
      linkedList0.add(fieldInfo0);
      Class<AtomicBoolean> class2 = AtomicBoolean.class;
      FieldInfo fieldInfo1 = new FieldInfo("|%", class2, class2, class0, (Field) null, (-552), 4, 4);
  ...
  public void test30()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      Class<AtomicLong> class1 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("|%", class0, class1, class1, (Field) null, 2293, (-4), 2293);
      Class<AtomicBoolean> class2 = AtomicBoolean.class;
      FieldInfo fieldInfo1 = new FieldInfo("|%", class2, class2, class0, (Field) null, (-577), (-4), (-4));
  ...
  public void test32()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      Class<AtomicLong> class1 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("|%", class0, class1, class1, (Field) null, (-373), (-26), 16);
      linkedList0.add(fieldInfo0);
