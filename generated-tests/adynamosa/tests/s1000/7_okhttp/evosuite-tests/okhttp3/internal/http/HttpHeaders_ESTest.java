...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("1", (-3059));
      assertEquals(1, int0);
  }
  ...
  public void test02()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("PATCH", 0, "realm");
      assertEquals(5, int0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn("7o]DG>4b5?ZYbrASZx").when(request0).method();
  ...
  public void test05()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "7o]DG>4b5?ZYbrASZx");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Headers headers1 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test07()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("PATCH", 0, "PATCH");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("bEOLx", 3);
      assertEquals(3, int0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      stringArray0[0] = "c;^2TbXo8^";
      stringArray0[1] = "c;^2TbXo8^";
      stringArray0[2] = "XrAr";
      stringArray0[3] = "*";
      stringArray0[4] = "Vary";
      stringArray0[5] = "*";
  ...
  public void test11()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("httponly", "/'cGxFKrHA~Jiv");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn((Headers) null).when(response0).headers();
  ...
  public void test14()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 2319);
  ...
  public void test15()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-418), "Vary");
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      ...
      stringArray0[0] = "!I&o V>}xG51)iGH";
      stringArray0[1] = "H{SfO@{9'E?";
      Headers headers0 = Headers.of(stringArray0);
      HttpUrl httpUrl1 = httpUrl0.resolve("H{SfO@{9'E?");
      HttpHeaders.receiveHeaders(cookieJar0, httpUrl1, headers0);
      assertEquals("http://foo.bar/H%7BSfO@%7B9'E?", httpUrl1.toString());
  }
  ...
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("t4", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-734));
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "!K^P\"U?_4,e1[z");
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("str'ng ja== null", (-961));
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-1500));
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("9moyM21*>ps", 0, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", 182);
      assertEquals(0, int0);
  }
  ...
  public void test46()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("d7XVBX4V<ZQU,f?P>oG", 2, "9moyM21*>ps");
      assertEquals(16, int0);
  }

  @Test(timeout = 4000)
  public void test47()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("okhttp3.RequestBody$3", 2087, "UTF-32LE");
  ...
  public void test49()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("o@<k").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test50()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("5tl").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(0).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
  ...
  public void test54()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("JA.[},tC@*Y=B", "S tZTS=ZE");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "JA.[},tC@*Y=B");
  ...
  public void test55()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("httponly", "/'cGKrHAiv");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "httponly");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test56()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("S tZTS=ZE", "builder.domain == null");
      hashMap0.put("vary", "S tZTS=ZE");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x20 at 1 in header name: S tZTS=ZE
         //
