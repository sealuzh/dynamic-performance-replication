...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.timeout(4103L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.deadline(4103L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(1253L, timeUnit0);
      Timeout timeout2 = timeout1.deadlineNanoTime(1253L);
      try { 
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1783L));
  ...
  public void test10()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2605L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(225072000000000000L, timeout0.timeoutNanos());
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-3104L));
  ...
  public void test14()  throws Throwable  {
      ...
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(1638589281320000L, long0);
  }
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      timeout0.deadline(1145L, timeUnit0);
      timeout0.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1392409281319448L), (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // duration <= 0: -1392409281319448
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test24()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.deadline(1145L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified("wP+)*#B");
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(650L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.timeout(463L, timeUnit0);
      Timeout timeout2 = timeout1.deadline(1145L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout2.waitUntilNotified("wP+)*#B");
        fail("Expecting exception: IllegalMonitorStateException");
