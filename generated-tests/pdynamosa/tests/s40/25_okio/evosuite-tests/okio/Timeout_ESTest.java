...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(322L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(322000000000L, long0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.timeout(322L, timeUnit0);
      assertEquals(322000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      timeout0.timeout(1635L, timeUnit0);
      timeout0.deadline(2352L, timeUnit0);
      assertEquals(5886000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(1635L, timeUnit0);
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(682L);
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1223L));
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(16L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(3905L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-850L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(4782L, timeUnit0);
      timeout1.deadlineNanoTime((-769L));
      try { 
        timeout0.waitUntilNotified("[w^{LD}yx9:DW)KE5_x");
        fail("Expecting exception: InterruptedIOException");
