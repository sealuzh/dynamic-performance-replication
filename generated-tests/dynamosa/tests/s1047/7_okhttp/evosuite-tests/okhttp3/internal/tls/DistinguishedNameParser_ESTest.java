...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("c=e&3Tw5-Z");
  ...
  public void test2()  throws Throwable  {
      ...
      assertEquals("e&3Tw5-Z", string0);
      assertNotNull(string0);
  }

  @Test(timeout = 4000)
  public void test3()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("S=&~H$C");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("S=&~H$C");
      assertNull(string0);
  }
  ...
  public void test5()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("c==!$O&-");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("L{3B#qVuB\"Q*");
      assertNull(string0);
  }
}
