...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test16()  throws Throwable  {
      ...
      try {
        javaBeanInfo1 = new JavaBeanInfo(class1, javaBeanInfo0.builderClass, javaBeanInfo0.creatorConstructor, javaBeanInfo0.creatorConstructor, javaBeanInfo0.buildMethod, javaBeanInfo0.factoryMethod, javaBeanInfo0.jsonType, list0);
        fail("Expecting exception: ConcurrentModificationException");
  ...
  public void test26()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("ewY4HErh@~4U", class2, class2, class2, (Field) null, (-179), (-1795232734), (-179));
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("ewY4HErh@~4U", class1, class1, class1, (Field) null, (-791), (-791), (-791));
      linkedList0.add(fieldInfo1);
      JSONType jSONType1 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(fieldInfo1.alternateNames).when(jSONType1).orders();
      doReturn("ewY4HErh@~4U").when(jSONType1).typeKey();
      doReturn("ewY4HErh@~4U").when(jSONType1).typeName();
  ...
  public void test31()  throws Throwable  {
      ...
      Class<AtomicLong> class0 = AtomicLong.class;
      Class<FieldInfo> class1 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("getsubSequence", class0, class1, class1, (Field) null, 32, 32, 32);
      linkedList0.add(fieldInfo0);
      Class<String> class2 = String.class;
      FieldInfo fieldInfo1 = new FieldInfo("getsubSequence", class2, class0, fieldInfo0.fieldType, (Field) null, 32, 32, 32);
  ...
  public void test32()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("g'jb5ukU-s*Y", class0, class1, class0, (Field) null, 81, 81, 81);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
      Class<FieldInfo> class2 = FieldInfo.class;
      FieldInfo fieldInfo1 = new FieldInfo("g'jb5ukU-s*Y", class0, class2, fieldInfo0.declaringClass, (Field) null, 81, 81, 81);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
      assertTrue(boolean0);
  }
  ...
  public void test33()  throws Throwable  {
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<String> class0 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("ewY4 Erhu4", class0, class0, class0, (Field) null, (-1311), (-1311), (-1311));
      linkedList0.add(fieldInfo0);
  ...
  public void test35()  throws Throwable  {
      ...
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<AtomicBoolean> class1 = AtomicBoolean.class;
      FieldInfo fieldInfo0 = new FieldInfo("com.alibaba.fastjson.util.ParameterizedTypeImpl", class1, class1, class1, (Field) null, (-1964), (-1), (-1));
      linkedList0.add(fieldInfo0);
  ...
  public void test36()  throws Throwable  {
      ...
      Class<?> class1 = JavaBeanInfo.getBuilderClass(jSONType0);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      FieldInfo fieldInfo0 = new FieldInfo("ewY4HErh@~4U", class1, class1, class1, (Field) null, (-791), (-791), (-791));
      Class<Annotation> class2 = Annotation.class;
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      String[] stringArray0 = new String[16];
      stringArray0[0] = "ewY4HErh@~4U";
      JSONType jSONType1 = mock(JSONType.class, new ViolatedAssumptionAnswer());
  ...
  public void test37()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("javax.persistence.OneToMany").when(jSONType0).typeKey();
      doReturn("javax.persistence.OneToMany").when(jSONType0).typeName();
