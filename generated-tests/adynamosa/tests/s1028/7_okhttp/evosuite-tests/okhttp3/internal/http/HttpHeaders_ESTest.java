...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("5", (-1847327875));
      assertEquals(5, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn("/4(QWQ,6K!*e").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(2570).when(response0).code();
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "nch|";
      stringArray0[1] = "W'OhRMtkaVsD3)RY/'%";
      stringArray0[2] = "unexpected encodedpath:";
      stringArray0[3] = "unexpected encodedpath:";
  ...
  public void test06()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("]}Wj", 107, (String) null);
      assertEquals(107, int0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 774, "min-fresh=");
  ...
  public void test08()  throws Throwable  {
      ...
      hashMap0.put("Kl<lnv{~L:n58ce", "nCH|");
  ...
  public void test09()  throws Throwable  {
      ...
      HttpUrl httpUrl1 = httpUrl0.resolve("l3%?'*");
      CookieJar cookieJar0 = mock(CookieJar.class, new ViolatedAssumptionAnswer());
  ...
  public void test11()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 3153);
      assertEquals(3153, int0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", (-2790));
  ...
  public void test16()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("W@._agH[wf8m2BT^~#", "[^ =]cxU*");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test22()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("", (-254));
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-1932735281));
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("[J9~7,|%ty", (-465), "[J9~7,|%ty");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 356, "* :JzBSF5pm+$p83_@");
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "+) A");
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      ...
      stringArray0[0] = "Vary";
      stringArray0[1] = "K2cQ)h%UdULzK";
      stringArray0[2] = "K2cQ)h%UdULzK";
  ...
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", 700);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" !*8H=Utu/mfSL#Fjh", 0);
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("W@._agH[wf8m2BT^~#", 12);
      assertEquals(12, int0);
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(":W4wN9xwSw=Hb-3W gf", 1343);
  ...
  public void test43()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil(":W4wN9xwSw=Hb-3W gf", 9, "");
  ...
  public void test46()  throws Throwable  {
      ...
      doReturn(" +([^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(19).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test48()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("K4'O").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test49()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("7_*n OXi", "S%dy,B}*\"/DW*U'/5.");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "7_*n OXi");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test50()  throws Throwable  {
      ...
      hashMap0.put("W@._agH[wf8m2BT^~#", "[^ =]cxU*");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "W@._agH[wf8m2BT^~#");
      assertTrue(list0.isEmpty());
  }
