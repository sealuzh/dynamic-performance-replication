...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(5595L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(335700000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(5595L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(424L);
  ...
  public void test08()  throws Throwable  {
      ...
      timeout0.deadline(5595L, timeUnit0);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(5595L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(335700000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(3072L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeout1);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1544L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      timeout0.deadline(1442L, timeUnit0);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(2584L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2042L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      Timeout timeout2 = timeout0.deadlineNanoTime(12L);
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.timeout((-455L), timeUnit0);
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(1442L);
