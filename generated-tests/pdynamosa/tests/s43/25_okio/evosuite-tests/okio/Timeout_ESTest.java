...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(285L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.timeout(475L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(167L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(14428800000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      timeout1.deadlineNanoTime(1926L);
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(167L, timeUnit0);
      timeout1.deadline(167L, timeUnit0);
      assertEquals(14428800000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1392409281319974L));
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout1.deadlineNanoTime();
      assertEquals((-1392409281319974L), long0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      timeout1.timeout(17629200000000000L, timeUnit0);
  ...
  public void test20()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(2791L, timeUnit0);
      timeout1.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1311L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-551L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.NONE.deadline(1136L, timeUnit0);
      assertSame(timeout0, timeout1);
  }
