...
public class MnAlgebraicSymMatrix_ESTest extends MnAlgebraicSymMatrix_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        mnAlgebraicSymMatrix0.set((-1), 0, 4512.221);
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set((-3087), 712, 0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set(1, 1, 1427.3225630215572);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get((-3481), 43);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set(0, (-2825), (-1.0));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get(0, 334);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set((-183), 0, 1.0E-35);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get(1, 750);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get(1357, 1357);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test22()  throws Throwable  {
      ...
      try {
        mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix((-1272));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid matrix size: -1272
         //
         verifyException("org.freehep.math.minuit.MnAlgebraicSymMatrix", e);
      }
  }
