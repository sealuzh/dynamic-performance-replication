...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test24()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build((Class<?>) class0, (Type) class0, propertyNamingStrategy0, false, false);
      Class<AtomicInteger> class1 = AtomicInteger.class;
      JavaBeanInfo.build((Class<?>) class1, (Type) javaBeanInfo0.clazz, (PropertyNamingStrategy) null, true, false);
      assertEquals(0, javaBeanInfo0.defaultConstructorParameterSize);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo(",d.{\"bW8", class1, class1, class0, (Field) null, (-1), (-1), (-1400));
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
      Class<String> class2 = String.class;
      Class<Object> class3 = Object.class;
      FieldInfo fieldInfo1 = new FieldInfo(",d.{\"bW8", class3, class2, class2, (Field) null, 31, (-1), 31);
  ...
  public void test30()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("clazz", class2, class2, class2, (Field) null, 1827, 31, (-1));
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("clazz", class2, class0, class1, (Field) null, (-1), 1494, 31);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
  ...
  public void test31()  throws Throwable  {
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<AtomicBoolean> class0 = AtomicBoolean.class;
      FieldInfo fieldInfo0 = new FieldInfo("upd", class0, class0, class0, (Field) null, (-1), 755, (-4952));
      linkedList0.add(fieldInfo0);
  ...
  public void test33()  throws Throwable  {
      ...
      stringArray0[0] = "d(ZVd7T/:t!yW";
      JSONType jSONType1 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType1).orders();
      doReturn("d(ZVd7T/:t!yW").when(jSONType1).typeKey();
      doReturn("d(ZVd7T/:t!yW").when(jSONType1).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Object> class2 = Object.class;
      FieldInfo fieldInfo0 = new FieldInfo("d(ZVd7T/:t!yW", class2, class0, class1, (Field) null, (-1272), 95, (-1272));
  ...
  public void test34()  throws Throwable  {
      ...
      doReturn("fjdy").when(jSONType0).typeKey();
      doReturn("fjdy").when(jSONType0).typeName();
      Class<AtomicInteger> class0 = AtomicInteger.class;
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<FieldInfo> class1 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("create", class1, class0, (Type) null, (Field) null, 2, 2, 2);
      linkedList0.add(fieldInfo0);
