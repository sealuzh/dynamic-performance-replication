...
public class ASMUtils_ESTest extends ASMUtils_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Type type0 = ASMUtils.getMethodType(class0, "5 E=%),-==%Y/QRg5]");
      assertNull(type0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // codegen.java.lang.reflect.AccessibleObject$MockitoMock$1345118478 cannot be cast to java.lang.reflect.Constructor
         //
         verifyException("com.alibaba.fastjson.util.ASMUtils", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      boolean boolean0 = ASMUtils.checkName("}/\r.XHs{v/AB{=$");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      boolean boolean0 = ASMUtils.checkName("5 E=%),-==%Y/QRg5]");
      assertTrue(boolean0);
  }
