...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxStale((-3091), timeUnit0);
  ...
  public void test10()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(977, timeUnit0);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-1791728220), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minFresh < 0: -1791728220
         //
         verifyException("okhttp3.CacheControl$Builder", e);
      }
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-779), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      cacheControl_Builder0.minFresh(51, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      String string0 = cacheControl0.toString();
      assertEquals("min-fresh=51", string0);
  ...
  public void test20()  throws Throwable  {
      ...
      cacheControl0.FORCE_NETWORK.headerValue = "no-cache, ";
      ...
      cacheControl0.FORCE_CACHE.headerValue = "min-fresh=";
  }
  ...
  public void test31()  throws Throwable  {
      ...
      headers_Builder1.add("Cache-Control", "k=_D0^ReT");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertFalse(cacheControl0.isPublic());
