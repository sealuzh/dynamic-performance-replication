...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(4650L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(3418L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(3418000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(5690L, timeUnit0);
      timeout1.deadlineNanoTime(0L);
      assertEquals(491616000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(786L);
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals(601200000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline((-1392409281319697L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // duration <= 0: -1392409281319697
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-364L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test16()  throws Throwable  {
      ...
      timeout0.timeout(134006400000000000L, timeUnit0);
      try { 
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(1035L, timeUnit0);
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.deadline(1035L, timeUnit0);
      timeout0.throwIfReached();
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(3026L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-3176L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.NONE.timeout((-4030L), timeUnit0);
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(3987L);
      assertFalse(timeout1.equals((Object)timeout0));
  }
