...
public class Spider_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, Spider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.concurrent.ForkJoinPool$ForkJoinWorkerThreadFactory", false, Spider_ESTest_scaffolding.class.getClassLoader()));
  }
