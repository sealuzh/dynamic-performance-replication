...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        timeout1.waitUntilNotified("jxd#:&)Vo'd=$");
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1358L, timeUnit0);
      timeout0.timeout(571L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.deadline(1358L, timeUnit0);
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(118723609281320000L, long0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2120L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(127200000000000L, timeout0.timeoutNanos());
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1392409281321343L));
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout1.deadlineNanoTime();
      assertEquals((-1392409281321343L), long0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(3693L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-3557L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-5246L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(2720L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(2720L, timeUnit0);
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-4584L));
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(225072000000000000L);
