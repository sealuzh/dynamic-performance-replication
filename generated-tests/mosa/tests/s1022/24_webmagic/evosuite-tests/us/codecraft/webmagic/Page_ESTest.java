...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      Page page0 = Page.fail();
      page0.setStatusCode(578);
      assertEquals(578, page0.getStatusCode());
  }
  ...
  public void test17()  throws Throwable  {
      Page page0 = new Page();
      page0.putField(",mt;U6 2@2+", ",mt;U6 2@2+");
      assertTrue(page0.isDownloadSuccess());
      assertEquals(200, page0.getStatusCode());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0, (-1221L));
        fail("Expecting exception: NoClassDefFoundError");
