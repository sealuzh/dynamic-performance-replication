...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2769000L, timeUnit0);
      assertSame(timeout1, timeout0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        timeout0.deadline((-2011L), timeUnit0);
  ...
  public void test09()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(139L, timeUnit0);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(3818L);
      try { 
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1392L);
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout2 = timeout1.timeout(1392L, timeUnit0);
      try { 
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2169L);
      try { 
        timeout0.throwIfReached();
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(39139200000000000L);
      timeout0.throwIfReached();
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(166579200000000000L);
      // Undeclared exception!
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(139L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
