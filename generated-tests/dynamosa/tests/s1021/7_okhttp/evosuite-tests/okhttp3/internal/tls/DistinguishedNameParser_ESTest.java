...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("t=yeblro3'ktd~cw'(");
  ...
  public void test2()  throws Throwable  {
      ...
      X500Principal x500Principal0 = new X500Principal("T=yEblRO3'ktd~Cw'(", map0);
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("2.5.4.12");
      assertNotNull(string0);
      assertEquals("#0c107945626c524f33276b74647e43772728", string0);
  }
  ...
  public void test4()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("t=yeblro3'ktd~cw'(");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("t=yeblro3'ktd~cw'(");
      assertNull(string0);
  }
}
