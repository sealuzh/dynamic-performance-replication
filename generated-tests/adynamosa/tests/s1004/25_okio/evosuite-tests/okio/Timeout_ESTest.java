...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(256L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(0L);
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(1935L, timeUnit0);
      try { 
        timeout1.waitUntilNotified(timeUnit0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.timeout(2092L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(2092000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(726L, timeUnit0);
      timeout1.deadlineNanoTime((-117L));
      assertEquals(62726400000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-306L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(69L, timeUnit0);
      timeout1.deadline(726L, timeUnit0);
      assertEquals(5961600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(2361L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(203990400000000000L, timeout0.timeoutNanos());
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline((-117L), timeUnit0);
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(726L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(64118809281320000L, long0);
  }
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2361L);
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(2478L, timeUnit0);
      timeout1.timeout(1574L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(2361L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(object0);
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.deadline(726L, timeUnit0);
      timeout0.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(2073L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2839L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout2 = timeout1.deadline(920L, timeUnit0);
