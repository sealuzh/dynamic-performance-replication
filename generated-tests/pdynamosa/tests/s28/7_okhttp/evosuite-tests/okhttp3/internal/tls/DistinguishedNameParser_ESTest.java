...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("S=V'yPi]QM=pjF()a}");
  ...
  public void test2()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=v'^ypi]qm=jjf()a}");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("st");
      assertNotNull(string0);
      assertEquals("v'^ypi]qm=jjf()a}", string0);
  }
  ...
  public void test4()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=v'^ypi]qm=jjf()a}");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific(".pIHP4?uIr6X6/(U");
      assertNull(string0);
  }
}
