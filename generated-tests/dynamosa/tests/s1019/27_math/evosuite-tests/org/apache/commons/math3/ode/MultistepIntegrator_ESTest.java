...
public class MultistepIntegrator_ESTest extends MultistepIntegrator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(4, 0.0, 0.0, 0.2, 0.0);
  ...
  public void test01()  throws Throwable  {
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(4, 4, 4, (-2590.881728020565), (-2590.881728020565));
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
  ...
  public void test04()  throws Throwable  {
      double[] doubleArray0 = new double[0];
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(1, 1, 2903.852748, doubleArray0, doubleArray0);
      assertEquals(0.9, adamsMoultonIntegrator0.getSafety(), 0.01);
  ...
  public void test05()  throws Throwable  {
      ...
      adamsMoultonIntegrator0.setSafety((-2590.881728020565));
      double double0 = adamsMoultonIntegrator0.getSafety();
      assertEquals((-2590.881728020565), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, (-1.0), 2, 425.89251644, 0.0);
      adamsBashforthIntegrator0.setMinReduction((-2590.881728020565));
  ...
  public void test08()  throws Throwable  {
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(4, 4, 4, (-2590.881728020565), (-8.695575234339838));
      adamsMoultonIntegrator0.setMaxGrowth((-2590.881728020565));
      double double0 = adamsMoultonIntegrator0.getMaxGrowth();
      assertEquals((-2590.881728020565), double0, 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      double[] doubleArray0 = new double[0];
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(2, 0.0, 2, doubleArray0, doubleArray0);
      DormandPrince853Integrator dormandPrince853Integrator0 = new DormandPrince853Integrator(0.0, 0.0, (-986.91889966), (-1080.8687));
  ...
  public void test10()  throws Throwable  {
      double[] doubleArray0 = new double[0];
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(1, 1, 2903.852748, doubleArray0, doubleArray0);
      HighamHall54Integrator highamHall54Integrator0 = new HighamHall54Integrator((-1372.007843143746), 1569.6, 0.0, 0.0);
  ...
  public void test11()  throws Throwable  {
      double[] doubleArray0 = new double[0];
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(2, 0.0, 2, doubleArray0, doubleArray0);
      adamsMoultonIntegrator0.setSafety(658.6);
      assertEquals(658.6, adamsMoultonIntegrator0.getSafety(), 0.01);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals(4.0, adamsBashforthIntegrator0.getMinReduction(), 0.01);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      try {
        adamsBashforthIntegrator0 = new AdamsBashforthIntegrator((-2215), (-2215), (-2215), (-2215), (-2215));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // multistep method needs at least -2,215 previous steps, got 2
         //
