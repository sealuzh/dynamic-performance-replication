...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.NONE.deadlineNanoTime(2117L);
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.deadline(51L, timeUnit0);
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.NONE.timeout(898L, timeUnit0);
      timeout0.throwIfReached();
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.deadline(2348L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-1L));
      try { 
        timeout1.waitUntilNotified("v?G=^");
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      timeout0.timeout(2348L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.deadline(2348L, timeUnit0);
      timeout1.timeout(2348L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeUnit0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(918L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.NONE.deadlineNanoTime(1374L);
      // Undeclared exception!
      try { 
        timeout0.deadline(1374L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
