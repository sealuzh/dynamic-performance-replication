...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("T=_s2nN 6D");
  ...
  public void test2()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("ST=nN#D");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("ST=nN#D");
      assertNull(string0);
  }

  @Test(timeout = 4000)
  public void test3()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("ST=");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
  ...
  public void test5()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("T=_s2n 6D");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("2.5.4.12");
      assertNotNull(string0);
      assertEquals("#0c075f73326e203644", string0);
  }
}
