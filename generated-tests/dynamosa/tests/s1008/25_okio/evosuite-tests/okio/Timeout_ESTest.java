...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(386L, timeUnit0);
  ...
  public void test05()  throws Throwable  {
      ...
      timeout0.deadline(391L, timeUnit0);
      timeout0.timeout(391L, timeUnit0);
      assertEquals(1407600000000000L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-451L));
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2536L);
  ...
  public void test09()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(5151L, timeUnit0);
      timeout1.deadline(5151L, timeUnit0);
      assertEquals(5151000L, timeout0.timeoutNanos());
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.timeout(2795L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2794L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(271L, timeUnit0);
      Timeout timeout2 = timeout1.deadlineNanoTime(271L);
      Object object0 = new Object();
      try { 
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(5178L);
