...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("Transfer-Encoding", 17);
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn("E(bs[jT^zrO").when(request0).method();
  ...
  public void test03()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("([^ \"=]*)", (-4436));
  ...
  public void test11()  throws Throwable  {
      ...
      HttpUrl httpUrl1 = httpUrl0.resolve("Oa%(rT?SE8/1");
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 8);
      assertEquals(8, int0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      stringArray0[0] = "Vary";
      stringArray0[1] = "; e2pkres=";
      stringArray0[2] = "; e2pkres=";
      stringArray0[3] = "'h4x";
      stringArray0[4] = "'h4x";
      stringArray0[5] = "; e2pkres=";
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x20 at 1 in header name: ; e2pkres=
         //
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("success", (-1088581770));
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, 8);
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("0]G^CX4`xu8'uJ8S@", (-419), "0]G^CX4`xu8'uJ8S@");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-1846195653), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "[_pe:zyS2cQn]5");
        fail("Expecting exception: NullPointerException");
  ...
  public void test35()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("I?|O%?%/`:3g+v6O/", "; realmes=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertFalse(set0.contains("; realmes="));
  }
  ...
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("2", (-429));
      assertEquals(2, int0);
  }
  ...
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 38);
      assertEquals(38, int0);
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("Tr1nsfer-E3codi(R", 8, "0]G^CX4`xu8'uJ8S@");
      assertEquals(17, int0);
  }
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("H'^K").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
  ...
  public void test44()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("HEAg").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test47()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("m<`p]").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test49()  throws Throwable  {
      ...
      doReturn("chunked").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(1677).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test50()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("s realm=", "s realm=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "s realm=");
  ...
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("&n)DkO@MTs'c4qQ9", "&n)DkO@MTs'c4qQ9");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "&n)DkO@MTs'c4qQ9");
      assertTrue(list0.isEmpty());
  }
