...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(141523200000000000L);
  ...
  public void test07()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(3600000000000000000L, timeUnit0);
      long long0 = timeout1.deadlineNanoTime();
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(3383L, timeUnit0);
      timeout0.deadline(1L, timeUnit0);
      assertEquals(202980000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(3383L, timeUnit0);
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(1392409281320834L, long0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(2909L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-9221979627573455809L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // duration <= 0: -9221979627573455809
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1437L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(834L, timeUnit0);
      // Undeclared exception!
      try { 
