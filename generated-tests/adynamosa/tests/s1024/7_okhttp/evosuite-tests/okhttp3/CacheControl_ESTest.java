...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      ...
      cacheControl_Builder0.maxStale(890, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
  ...
  public void test14()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(1882, timeUnit0);
  ...
  public void test15()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(2688, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder1.build();
      int int0 = cacheControl0.maxAgeSeconds();
      assertEquals(2, int0);
      assertEquals((-1), cacheControl0.minFreshSeconds());
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-2970), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-1543), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
      assertEquals("min-fresh=600", string0);
  }
  ...
  public void test25()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(1459, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
  ...
  public void test37()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.add("Cache-Control", "Y/Vu}(=&v");
      headers_Builder0.addLenient("Cache-Control", "no-store, max-age=0, max-stale=0, only-if-cached");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
  ...
  public void test38()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.set("Y/Vu}(=&v", "Cache-Control");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.noTransform());
      assertFalse(cacheControl0.noCache());
