...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("&m:*n|stm]<|t", 3180);
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn(842).when(response0).code();
  ...
  public void test02()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("oaFy").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test06()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "6";
      stringArray0[1] = "a<H`=fP[E67mja";
      stringArray0[2] = "a<H`=fP[E67mja";
      stringArray0[3] = "6";
      stringArray0[4] = "a<H`=fP[E67mja";
      stringArray0[5] = "I2!wnr(8 ||N";
      Headers headers0 = Headers.of(stringArray0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test14()  throws Throwable  {
      ...
      HttpUrl httpUrl1 = httpUrl0.resolve("+?J!BH");
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test17()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("method.length() == 0", (-760));
      assertEquals((-760), int0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 136);
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("FK)=;6yjgdrom", (-3582));
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, 4161);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("byteCount > Integer.MX_VALUE:", (-1), "byteCount > Integer.MX_VALUE:");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-3681), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "method.length() == 0");
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      ...
      Headers headers0 = Headers.of(stringArray0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertFalse(set0.contains("&o !yP"));
  }
  ...
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil(".uTQ1a{In&o][", 1, ".uTQ1a{In&o][");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test45()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("vary", 1, "O\fGU");
      assertEquals(4, int0);
  }
  ...
  public void test46()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("souX =nul").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(136).when(response0).code();
      doReturn((Headers) null).when(response0).headers();
      doReturn(request0).when(response0).request();
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("&o !yP").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>(3202);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test53()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("souX =nul", "souX =nul");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "souX =nul");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      stringArray0[5] = "I2!wnr(8 ||N";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "a<H`=fP[E67mja");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "vary");
      hashMap0.put("vary", "lk\"C<N~'C[<#-A)n}");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(headers0).when(response0).headers();
