...
public class MultistepIntegrator_ESTest extends MultistepIntegrator_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      int int0 = 2;
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, 361.903882, 2, 361.903882, 2);
      ...
      try { 
        adamsBashforthIntegrator0.integrate(expandableStatefulODE0, (-625.4232));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minimal step size (3.62E02) reached, integration needs 2.83E00
         //
  ...
  public void test3()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, (-1628.7420235366033), 0.0, 361.903882, 2);
      double double0 = adamsBashforthIntegrator0.getMaxGrowth();
      assertEquals(1.4142135623730951, double0, 0.01);
  ...
  public void test6()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, 2, 2, (-660.68109531001), (-660.68109531001));
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
  ...
  public void test7()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(9, (-391.8669107498677), 9, (-738.0), (-738.0));
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      ...
      expandableStatefulODE0.getCompleteState();
      // Undeclared exception!
      adamsBashforthIntegrator0.integrate(expandableStatefulODE0, (-738.0));
  }
}
