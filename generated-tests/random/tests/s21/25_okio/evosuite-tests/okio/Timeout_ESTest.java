...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-5814L));
      timeout1.timeout(1613L, timeUnit0);
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(1613L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(1613000000L, long0);
  }
  ...
  public void test02()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.timeout(1613L, timeUnit0);
      timeout0.deadlineNanoTime(2613L);
      assertEquals(1613000000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-5814L));
      Object object0 = new Object();
      try { 
        timeout0.waitUntilNotified(object0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.deadline(3721L, timeUnit0);
      timeout1.timeout(1613L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(3721L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1744L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.deadline(3721L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(object0);
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1613L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1392409281317277L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // timeout < 0: -1392409281317277
         //
         verifyException("okio.Timeout", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.deadline(397L, timeUnit0);
