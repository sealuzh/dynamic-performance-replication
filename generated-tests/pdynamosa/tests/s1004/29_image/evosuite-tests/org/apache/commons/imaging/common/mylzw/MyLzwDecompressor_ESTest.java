...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(1574, byteOrder0, myLzwDecompressor_Listener0);
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      try { 
        myLzwDecompressor0.decompress(pipedInputStream0, 1574);
  ...
  public void test01()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(4125, byteOrder0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream0, 25);
      assertEquals(0, byteArrayInputStream0.available());
      assertArrayEquals(new byte[] {(byte)68, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray1);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      myLzwDecompressor0.setTiffLZWMode();
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 25);
        fail("Expecting exception: IOException");
  ...
  public void test08()  throws Throwable  {
      ...
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(enumeration0);
      try { 
        myLzwDecompressor0.decompress(sequenceInputStream0, 2882);
        fail("Expecting exception: IOException");
  ...
  public void test09()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(8, byteOrder0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 545);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Bad Code: 451 codes: 258 code_size: 9, table: 4096
         //
         verifyException("org.apache.commons.imaging.common.mylzw.MyLzwDecompressor", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, (byte)36);
        fail("Expecting exception: IOException");
