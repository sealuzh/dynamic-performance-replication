...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Page page0 = new Page();
      Page page1 = page0.setRawText("5;l8QHJ)8=");
  ...
  public void test09()  throws Throwable  {
      Page page0 = new Page();
      page0.putField("ug=YIJAL^ySCM&K_.>M", "ug=YIJAL^ySCM&K_.>M");
      assertTrue(page0.isDownloadSuccess());
      assertEquals(200, page0.getStatusCode());
  }
  ...
  public void test23()  throws Throwable  {
      Page page0 = Page.fail();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      page0.addTargetRequests((List<String>) linkedList0, 4153L);
      assertEquals(200, page0.getStatusCode());
      assertFalse(page0.isDownloadSuccess());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0, 127L);
        fail("Expecting exception: NoClassDefFoundError");
