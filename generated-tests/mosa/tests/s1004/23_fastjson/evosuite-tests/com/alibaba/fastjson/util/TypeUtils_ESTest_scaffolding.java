...
public class TypeUtils_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.awt.RenderingHints$Key", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.lang.reflect.GenericArrayType", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiConsumer", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.IntBinaryOperator", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToDoubleBiFunction", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToIntFunction", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
  }
