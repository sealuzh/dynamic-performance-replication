...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1392409281319998457L);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(1200L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.deadline(1762L, timeUnit0);
      timeout0.timeout(811L, timeUnit0);
      assertEquals(48660000000000L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1200L);
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(1498129281320000L, long0);
  }
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(811L, timeUnit0);
      timeout1.deadline(1762L, timeUnit0);
      assertEquals(48660000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1969L));
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(1200L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(1200L, timeout0.timeoutNanos());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      timeout0.timeout(2784L, timeUnit0);
      Timeout timeout1 = timeout0.deadlineNanoTime(2784L);
      try { 
        timeout0.waitUntilNotified(timeout1);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test22()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1391016872038678507L);
      timeout0.throwIfReached();
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2736L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
