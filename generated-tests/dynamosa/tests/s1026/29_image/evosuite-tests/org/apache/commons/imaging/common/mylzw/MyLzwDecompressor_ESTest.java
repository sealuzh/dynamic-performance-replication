...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(100, byteOrder0);
      PipedInputStream pipedInputStream0 = new PipedInputStream(100);
      try { 
        myLzwDecompressor0.decompress(pipedInputStream0, 100);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 992);
        fail("Expecting exception: IOException");
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, (byte)23);
        fail("Expecting exception: IOException");
  ...
  public void test04()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.BIG_ENDIAN;
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-3267), byteOrder0);
  }
  ...
  public void test06()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.BIG_ENDIAN;
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-897), byteOrder0);
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(pipedInputStream0, (-897));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -897
         //
  ...
  public void test07()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-25), 61);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      try {
        myLzwDecompressor0 = new MyLzwDecompressor(491, byteOrder0, myLzwDecompressor_Listener0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test09()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = null;
      try {
        myLzwDecompressor0 = new MyLzwDecompressor(14, byteOrder0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      byte[] byteArray0 = myLzwDecompressor0.decompress(sequenceInputStream0, 257);
