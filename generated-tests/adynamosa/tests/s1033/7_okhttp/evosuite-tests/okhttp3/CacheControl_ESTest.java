...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxStale((-223), timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      headers_Builder0.addLenient("Pragma", "no-store, max-stale=0, no-transform");
  ...
  public void test11()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("Pragma", "min-fresh=0, only-if-cached");
      Headers headers0 = new Headers(headers_Builder0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
  ...
  public void test13()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxStale(462, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
  ...
  public void test15()  throws Throwable  {
      ...
      cacheControl_Builder0.maxAge(40, timeUnit0);
  ...
  public void test16()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(1224, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      int int0 = cacheControl0.maxAgeSeconds();
      assertFalse(cacheControl0.mustRevalidate());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1771), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(1936, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
  ...
  public void test26()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(1936, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      String string0 = cacheControl0.toString();
  ...
  public void test29()  throws Throwable  {
      ...
      stringArray0[0] = "=,;";
      stringArray0[1] = "Gi.!*qtQ";
      stringArray0[2] = "?k0}J21H%>ys(";
      stringArray0[3] = "Pragma";
      stringArray0[4] = "=,;";
      stringArray0[5] = "?k0}J21H%>ys(";
  ...
  public void test33()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("Pragma", "max-age=1");
  ...
  public void test35()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "no-store, only-if-cached";
      stringArray0[1] = "";
      stringArray0[2] = "no-cache, ";
      stringArray0[3] = "no-cache, ";
      stringArray0[4] = "Pragma";
      stringArray0[5] = "no-store, only-if-cached";
      stringArray0[6] = "Pragma";
      stringArray0[7] = "max-stale=";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.noCache());
      assertFalse(cacheControl0.noTransform());
  ...
  public void test37()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("Pragma", "min-fresh=1");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.noTransform());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
  ...
  public void test38()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("cache-control", "privae,");
      Headers.Builder headers_Builder1 = headers_Builder0.add("cache-control", "Gi|J*qVQ");
  ...
  public void test54()  throws Throwable  {
      ...
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.addLenient("=5c");
      Headers.Builder headers_Builder2 = headers_Builder1.addLenient("rE^{y pqWWAj'", "min-fresh=0, only-if-cached");
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = headers_Builder2.build();
      String[] stringArray0 = new String[8];
      stringArray0[0] = "=5c";
      stringArray0[1] = "o-transform";
      stringArray0[2] = "=5c";
      stringArray0[3] = "min-fresh=0, only-if-cached";
      stringArray0[4] = "Pragma";
      stringArray0[5] = "=5c";
      stringArray0[6] = "o-transform";
      stringArray0[7] = "rE^{y pqWWAj'";
      ...
      cacheControl2.headerValue = "=5c";
      cacheControl2.headerValue = "public";
      Headers.Builder headers_Builder3 = headers_Builder2.add("Pragma", "public");
      ...
      assertTrue(cacheControl3.isPublic());
