...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(1728000000000000L);
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(3658L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(219480000000000L, long0);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1506L));
  ...
  public void test05()  throws Throwable  {
      ...
      timeout0.timeout(734L, timeUnit0);
      timeout0.deadlineNanoTime((-1L));
      assertEquals(2642400000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-889L));
  ...
  public void test08()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(717L, timeUnit0);
      timeout1.deadline(717L, timeUnit0);
      assertEquals(61948800000000000L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1335L);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(570L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(49248000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(717L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(63341209281320000L, long0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      timeout0.timeout(1335L, timeUnit0);
      try { 
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.deadline(717L, timeUnit0);
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-328L), (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(4714L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeout1);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(4737L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1654L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(4714L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeout1);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout((-2035L), timeUnit0);
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime((-2269L));
