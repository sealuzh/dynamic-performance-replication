...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("o=lg");
  ...
  public void test3()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("o=lg=");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("o=lg=");
      assertNull(string0);
  }
  ...
  public void test6()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("o=GI{#g");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("n");
      assertNull(string0);
  }
}
