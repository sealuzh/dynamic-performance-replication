...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("9", 607);
      assertEquals(9, int0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn(" Atext=").when(request0).method();
  ...
  public void test03()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-4603));
  ...
  public void test10()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 607, "");
  ...
  public void test15()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 122);
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("lx >d~OB", (-406));
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("*", (-2333), (String) null);
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 1779, "");
        fail("Expecting exception: NullPointerException");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "endIndex > string.length: ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", (-222337257));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", 76);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" Atext=", 0);
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("Response{protocol=", 2147483645);
      assertEquals(2147483645, int0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("G@F)Z", 0, "6Atext=");
      assertEquals(5, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil(" Atext=", 0, " Atext=");
      assertEquals(0, int0);
  }
  ...
  public void test40()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Kr\u0000").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test41()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Jr\u0000").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("6Atext=").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("okhttp3.RequestBody$1").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test44()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("x_uodivuwydiey").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test48()  throws Throwable  {
      ...
      stringArray0[0] = " Atext=";
      stringArray0[1] = " Atext=";
      stringArray0[2] = "/";
      stringArray0[3] = "r 0!uQbp|q";
      stringArray0[4] = "/";
      stringArray0[5] = "XtXix =";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "/");
      assertEquals(0, list0.size());
  }
