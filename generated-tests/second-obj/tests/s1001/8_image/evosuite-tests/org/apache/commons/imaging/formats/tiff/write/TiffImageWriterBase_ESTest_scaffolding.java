...
public class TiffImageWriterBase_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.image.TileObserver", false, TiffImageWriterBase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, TiffImageWriterBase_ESTest_scaffolding.class.getClassLoader()));
  }
