...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(191L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(415L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(415000000L, long0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.timeout(415L, timeUnit0);
      assertEquals(35856000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(415L, timeUnit0);
      timeout0.deadlineNanoTime(3970L);
      try { 
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(415L, timeUnit0);
      timeout0.throwIfReached();
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(2145L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1267L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(415L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.NONE.timeout(477L, timeUnit0);
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.NONE.deadline(2200L, timeUnit0);
      assertFalse(timeout1.equals((Object)timeout0));
  }
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(2031L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(176870809281320000L, long0);
  }
