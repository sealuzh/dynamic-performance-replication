...
public class MyLzwCompressor_ESTest extends MyLzwCompressor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor((-2072), byteOrder0, false, myLzwCompressor_Listener0);
  ...
  public void test1()  throws Throwable  {
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(585, (ByteOrder) null, false);
      byte[] byteArray0 = new byte[2];
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
  ...
  public void test2()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor((-2560), byteOrder0, true);
      // Undeclared exception!
      try { 
  ...
  public void test3()  throws Throwable  {
      ...
      MyLzwCompressor.Listener myLzwCompressor_Listener0 = mock(MyLzwCompressor.Listener.class, new ViolatedAssumptionAnswer());
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(353, byteOrder0, false, myLzwCompressor_Listener0);
      byte[] byteArray0 = new byte[7];
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
      assertEquals(664, byteArray1.length);
  }

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(2313, byteOrder0, true);
      byte[] byteArray0 = new byte[3];
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
      assertEquals(1157, byteArray1.length);
  }
  ...
  public void test8()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.BIG_ENDIAN;
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(4065, byteOrder0, false);
