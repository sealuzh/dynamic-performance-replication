...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Page page0 = new Page();
      page0.setCharset("zL&hWMkEU+k>(aHy@O");
      assertTrue(page0.isDownloadSuccess());
      assertEquals(200, page0.getStatusCode());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      page0.addTargetRequests((List<String>) linkedList0, (-458L));
      assertEquals(200, page0.getStatusCode());
      assertTrue(page0.isDownloadSuccess());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        page0.addTargetRequests(list0, (long) (-5));
        fail("Expecting exception: NoClassDefFoundError");
