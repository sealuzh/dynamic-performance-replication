...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(34L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2038L, timeUnit0);
      Object object0 = new Object();
      Timeout timeout2 = timeout1.deadlineNanoTime(2038L);
      try { 
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(34L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(2937600000000000L, long0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1228L));
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-1281L));
      assertSame(timeout0, timeout1);
  }
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(4862L);
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(21L, timeUnit0);
      timeout1.deadline(21L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(34L, timeUnit0);
      timeout1.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1281L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(2034L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-30L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout((-594L), timeUnit0);
      assertSame(timeout0, timeout1);
  }
