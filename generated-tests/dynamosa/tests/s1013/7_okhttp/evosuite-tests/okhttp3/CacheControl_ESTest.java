...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.minFresh((-1739596407), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minFresh < 0: -1739596407
         //
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-66), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-3297), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(680, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
      assertEquals("min-fresh=2448000", string0);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      Headers.Builder headers_Builder2 = headers_Builder1.removeAll("private, ");
      Headers.Builder headers_Builder3 = headers_Builder2.add("s-maxage", "[?4T6yO!:Vw7wW>94");
      Headers.Builder headers_Builder4 = headers_Builder3.addLenient("s-maxage");
      headers_Builder4.set("[?4T6yO!:Vw7wW>94", "s-maxage");
  ...
  public void test33()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.addLenient("Pragma", "no-store, max-age=224467200, min-fresh=224467200, only-if-cached, no-transform");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertFalse(cacheControl0.isPrivate());
      ...
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.noCache());
      assertEquals(224467200, cacheControl0.maxAgeSeconds());
      assertTrue(cacheControl0.noStore());
      assertTrue(cacheControl0.noTransform());
      assertEquals(224467200, cacheControl0.minFreshSeconds());
  ...
  public void test34()  throws Throwable  {
      ...
      stringArray0[1] = "no-cache, no-store, min-fresh=2448000";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertTrue(cacheControl0.noCache());
      assertEquals((-1), cacheControl0.maxAgeSeconds());
      assertFalse(cacheControl0.isPublic());
      assertEquals(2448000, cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.onlyIfCached());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.isPrivate());
      assertFalse(cacheControl0.mustRevalidate());
  ...
  public void test35()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.set("Pragma", "[he$x=");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.minFreshSeconds());
  ...
  public void test36()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.set("Pragma", "~15%;Ps!9Bh!>M(");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.minFreshSeconds());
  ...
  public void test37()  throws Throwable  {
      ...
      stringArray0[0] = "Pragma";
      stringArray0[1] = "no-cache, min-fresh=0, no-transform";
      stringArray0[2] = "okhttp3.ResponseBody$1";
      stringArray0[3] = "no-cache, min-fresh=0, no-transform";
      stringArray0[4] = "no-cache, min-fresh=0, no-transform";
      stringArray0[5] = "hymk?(e]$t";
      stringArray0[6] = ";G";
      stringArray0[7] = "p}uragma";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertTrue(cacheControl0.noTransform());
      assertFalse(cacheControl0.mustRevalidate());
