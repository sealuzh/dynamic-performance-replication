...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("Uql5!1|DWJhE", 13);
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn(1583).when(response0).code();
  ...
  public void test03()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("-,SQ").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test04()  throws Throwable  {
      ...
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Ina&liE hs;%:").when(request0).method();
  ...
  public void test05()  throws Throwable  {
      ...
      stringArray0[0] = "v(Ia{L/[`kH<gFw(<";
      stringArray0[1] = "SW}@}_eSoLkkX>sq";
      stringArray0[2] = "v(Ia{L/[`kH<gFw(<";
      stringArray0[3] = "vary";
      stringArray0[4] = "vary";
      stringArray0[5] = "vary";
      stringArray0[6] = "v(Ia{L/[`kH<gFw(<";
      stringArray0[7] = "vary";
  ...
  public void test07()  throws Throwable  {
      ...
      stringArray0[0] = "okhttp3.Response$Builder";
      stringArray0[1] = "v(Ia{L/[`kH<gFw(<";
      stringArray0[2] = "vary";
      stringArray0[3] = "v(Ia{L/[`kH<gFw(<";
      Headers headers0 = Headers.of(stringArray0);
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[0] = "gH7GICu0BsLzhR8r";
      stringArray0[1] = "G7LkG|Jb*z^ltp2BO";
      stringArray0[2] = "gH7GICu0BsLzhR8r";
      stringArray0[3] = "vary";
      stringArray0[4] = "vary";
      stringArray0[5] = "SW}@}_eSoLkkX>sq";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test09()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "vary";
      stringArray0[1] = "yK,5fT-r}=isF>;";
      stringArray0[2] = "vary";
      stringArray0[3] = "okhttp3.Headers";
      stringArray0[4] = "vary";
      stringArray0[5] = "vary";
      stringArray0[6] = "bc<<<am(vqq'3`(=";
      stringArray0[7] = "vary";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test10()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 0, "okhttp3.internal.http.HttpHeaders");
      assertEquals(0, int0);
  }
  ...
  public void test17()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("N`", 1);
      assertEquals(1, int0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      HttpUrl httpUrl1 = httpUrl0.resolve("J3@?p<WbC+jkTABjy");
      String[] stringArray0 = new String[4];
      stringArray0[0] = "J3@?p<WbC+jkTABjy";
      stringArray0[1] = "J3@?p<WbC+jkTABjy";
      stringArray0[2] = "J3@?p<WbC+jkTABjy";
      stringArray0[3] = "J3@?p<WbC+jkTABjy";
      Headers headers0 = Headers.of(stringArray0);
  ...
  public void test23()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 19);
      assertEquals(19, int0);
  }

  @Test(timeout = 4000)
  public void test24()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-1643));
  ...
  public void test33()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = "Vary";
      stringArray0[1] = "Pyw !=W8I1)oK`1";
      stringArray0[2] = "Pyw !=W8I1)oK`1";
      stringArray0[3] = "Pyw !=W8I1)oK`1";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x20 at 3 in header name: Pyw !=W8I1)oK`1
         //
  ...
  public void test35()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("epB -SGa", (-26));
  ...
  public void test36()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-1330));
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("J,Cl.{I@g~FO9.1Rxz", (-1845), "J,Cl.{I@g~FO9.1Rxz");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test43()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("xl realmd=", "xl realmd=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertFalse(set0.contains("xl realmd="));
  }

  @Test(timeout = 4000)
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("3", (-18));
      assertEquals(3, int0);
  }
  ...
  public void test47()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("Pyi2!W8I1)LK`", 5, "Pyi2!W8I1)LK`");
      assertEquals(5, int0);
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("MEd_po%!G", 1, "");
      assertEquals(9, int0);
  }
  ...
  public void test50()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("YBJI1[").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test53()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("GMT", "xl realmd=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "GMT");
      assertEquals(0, list0.size());
  }
  ...
  public void test54()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("(xD Pmaid=", "(xD Pmaid=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "(xD Pmaid=");
  ...
  public void test55()  throws Throwable  {
      ...
      stringArray0[0] = "HEAD";
      stringArray0[1] = "\"([^\"]*)\"";
      stringArray0[2] = "okhttp3.Response$Builder";
      stringArray0[3] = "vary";
      stringArray0[4] = "*";
      stringArray0[5] = "SW}@}_eSoLkkX>sq";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "okhttp3.response$builder");
      assertTrue(list0.isEmpty());
  }
