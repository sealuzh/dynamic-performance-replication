...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1393L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      ...
      timeout0.timeout(1070L, timeUnit0);
      timeout0.deadlineNanoTime(1070L);
      assertEquals(92448000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2530L, timeUnit0);
      timeout1.deadline(2530L, timeUnit0);
      assertEquals(2530000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(1070L, timeUnit0);
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline((-1550L), timeUnit0);
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-3906L));
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-199L));
  ...
  public void test19()  throws Throwable  {
      ...
      timeout0.deadline(222L, timeUnit0);
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-979L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout((-2375L), timeUnit0);
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.NONE.deadline(3598607590718680000L, timeUnit0);
