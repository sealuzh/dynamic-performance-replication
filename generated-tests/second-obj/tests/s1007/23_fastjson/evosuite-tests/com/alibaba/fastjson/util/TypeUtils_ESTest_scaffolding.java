...
public class TypeUtils_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.function.IntUnaryOperator", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.LongBinaryOperator", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToLongFunction", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
  }
