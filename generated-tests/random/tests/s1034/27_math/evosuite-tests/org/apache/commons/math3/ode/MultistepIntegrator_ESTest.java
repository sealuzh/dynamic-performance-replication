...
public class MultistepIntegrator_ESTest extends MultistepIntegrator_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, 880.89680951431, 0.0, 1.0267509648109748E-7, 1.0267509648109748E-7);
      adamsBashforthIntegrator0.setSafety(880.89680951431);
      assertEquals(880.89680951431, adamsBashforthIntegrator0.getSafety(), 0.01);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, 880.89680951431, 0.0, 1.0267509648109748E-7, 1.0267509648109748E-7);
      adamsBashforthIntegrator0.setMinReduction((-1745.618029165));
      double double0 = adamsBashforthIntegrator0.getMinReduction();
      assertEquals((-1745.618029165), double0, 0.01);
  }

  @Test(timeout = 4000)
  public void test04()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, 880.89680951431, 0.0, 1.0267509648109748E-7, 1.0267509648109748E-7);
      adamsBashforthIntegrator0.setMaxGrowth(1957.865313);
      assertEquals(1957.865313, adamsBashforthIntegrator0.getMaxGrowth(), 0.01);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      try {
        adamsMoultonIntegrator0 = new AdamsMoultonIntegrator((-807), (-807), (-807), (-1.0), (-1.0));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // multistep method needs at least -807 previous steps, got 2
         //
  ...
  public void test11()  throws Throwable  {
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(5, (-3343.117550505776), (-3343.117550505776), 1410.5352628701223, (-3343.117550505776));
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      doReturn(5).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      ExpandableStatefulODE expandableStatefulODE0 = new ExpandableStatefulODE(firstOrderConverter0);
      // Undeclared exception!
      adamsBashforthIntegrator0.integrate(expandableStatefulODE0, (-3343.117550505776));
  }
