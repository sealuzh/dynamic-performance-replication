...
public class ASMUtils_ESTest extends ASMUtils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      boolean boolean0 = ASMUtils.checkName(" CUo\"(: N^NXZLqRmE(");
      assertTrue(boolean0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      boolean boolean0 = ASMUtils.isAndroid("^<vmhS+y`@D");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // codegen.java.lang.reflect.AccessibleObject$MockitoMock$2035251573 cannot be cast to java.lang.reflect.Constructor
         //
         verifyException("com.alibaba.fastjson.util.ASMUtils", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      boolean boolean0 = ASMUtils.checkName("_x{.`");
      assertFalse(boolean0);
  }
