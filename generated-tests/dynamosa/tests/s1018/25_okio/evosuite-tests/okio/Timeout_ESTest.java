...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(2680000000L, timeUnit0);
      Timeout timeout2 = timeout1.deadlineNanoTime(726L);
      try { 
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-275L));
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.timeout(1182L, timeUnit0);
      timeout0.deadline(1182L, timeUnit0);
      assertEquals(4255200000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(1182L, timeUnit0);
  ...
  public void test13()  throws Throwable  {
      ...
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(1392409282320000L, long0);
  }
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(726L);
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(1176L, timeUnit0);
      Timeout timeout2 = timeout0.timeout(1176L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout2.waitUntilNotified(timeout1);
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(27L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1326L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1671L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1815L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(21600000000000000L);
      timeout0.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
}
