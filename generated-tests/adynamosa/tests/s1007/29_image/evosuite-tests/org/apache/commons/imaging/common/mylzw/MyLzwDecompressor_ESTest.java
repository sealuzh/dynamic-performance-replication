...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 1200);
        fail("Expecting exception: IOException");
  ...
  public void test02()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-35), byteOrder0, myLzwDecompressor_Listener0);
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      MyLzwDecompressor.Listener myLzwDecompressor_Listener0 = mock(MyLzwDecompressor.Listener.class, new ViolatedAssumptionAnswer());
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(10, (ByteOrder) null, myLzwDecompressor_Listener0);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(sequenceInputStream0, (-1579));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -1579
         //
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        myLzwDecompressor0 = new MyLzwDecompressor((byte) (-9), byteOrder0);
  ...
  public void test08()  throws Throwable  {
      ...
      byteArray0[0] = (byte) (-1);
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream0, 1087);
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress((InputStream) null, 4076);
        fail("Expecting exception: IOException");
  ...
  public void test10()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = null;
      try {
        myLzwDecompressor0 = new MyLzwDecompressor((byte) (-9), byteOrder0, myLzwDecompressor_Listener0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test11()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 4052);
        fail("Expecting exception: IOException");
