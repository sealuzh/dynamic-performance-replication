...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1337L, timeUnit0);
      System.setCurrentTimeMillis(0L);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(735L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(44100000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      timeout0.deadlineNanoTime((-1040L));
      timeout0.timeout(2798L, timeUnit0);
      assertEquals(2798L, timeout0.timeoutNanos());
  }
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-2523L));
  ...
  public void test08()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(2798L, timeUnit0);
      timeout0.deadline(2798L, timeUnit0);
      assertEquals(2798L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.deadline(1291L, timeUnit0);
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1040L));
  ...
  public void test15()  throws Throwable  {
      ...
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(1393700281320000L, long0);
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(2798L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1293L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1291L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(12L, timeUnit0);
      Timeout timeout2 = timeout0.deadlineNanoTime(1918L);
      try { 
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(2798L);
