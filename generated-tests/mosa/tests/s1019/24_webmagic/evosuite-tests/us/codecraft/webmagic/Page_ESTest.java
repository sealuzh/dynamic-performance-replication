...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Page page0 = new Page();
      Page page1 = page0.setRawText("WFB[[~k");
  ...
  public void test04()  throws Throwable  {
      Page page0 = Page.fail();
      page0.setCharset("zWTNF+]Lh<P|O5dL");
      assertFalse(page0.isDownloadSuccess());
      assertEquals(200, page0.getStatusCode());
  }
  ...
  public void test11()  throws Throwable  {
      Page page0 = new Page();
      page0.setStatusCode(1919);
      assertEquals(1919, page0.getStatusCode());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0, (-21L));
        fail("Expecting exception: NoClassDefFoundError");
