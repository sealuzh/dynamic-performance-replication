...
public class Utf8_ESTest extends Utf8_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      long long0 = Utf8.size("`q?b%F,k9'IIi!./`c", 0, 0);
  ...
  public void test5()  throws Throwable  {
      long long0 = Utf8.size("endIndex < beginIndex ", 19, 22);
  ...
  public void test6()  throws Throwable  {
      // Undeclared exception!
      try { 
        Utf8.size("@5", 2048, (-3459));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // endIndex < beginIndex: -3459 < 2048
         //
         verifyException("okio.Utf8", e);
      }
  }
