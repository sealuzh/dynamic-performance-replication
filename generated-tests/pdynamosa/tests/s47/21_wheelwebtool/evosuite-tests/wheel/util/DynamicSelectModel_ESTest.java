...
public class DynamicSelectModel_ESTest extends DynamicSelectModel_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ErrorPage errorPage0 = new ErrorPage();
      ActionExpression actionExpression0 = new ActionExpression("kzKL");
  ...
  public void test04()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.value("&uj5.'w~@[");
      assertSame(dynamicSelectModel0, dynamicSelectModel1);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        dynamicSelectModel0.getValue((-239));
  ...
  public void test18()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("Could not evaluate finder expression ' ");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.getValue(1619);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Could not evaluate expression Could not evaluate finder expression ' .values() to create a dynamic ISelectModel.
         //
  ...
  public void test19()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("k<i:K]D<d.&:u!< ");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Could not evaluate expression k<i:K]D<d.&:u!<  to create a dynamic ISelectModel.
         //
         verifyException("wheel.components.ElExpression", e);
      }
  }
  ...
  public void test26()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("ZLyWw%u|Z/.jl\"jN");
      DynamicSelectModel dynamicSelectModel2 = dynamicSelectModel1.label("ZLyWw%u|Z/.jl\"jN");
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("ZLyWw%u|Z/.jl\"jN");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.validate();
        fail("Expecting exception: RuntimeException");
  ...
  public void test28()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("9.:iTNZ]SW%0y,]");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expression 9.:iTNZ]SW%0y,].values() evaluated to an object that is not an instance of Collection or Object[]. Can't build a dynamic ISelectModel
         //
         verifyException("wheel.util.DynamicSelectModel", e);
      }
  }
  ...
  public void test30()  throws Throwable  {
      ...
      Any any0 = new Any(errorPage0, actionExpression0);
      DynamicSelectModel dynamicSelectModel0 = any0.selectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.translator("kzKL");
      assertSame(dynamicSelectModel0, dynamicSelectModel1);
  }
  ...
  public void test37()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("=s!w4-:M#4Kp*W");
      // Undeclared exception!
      try { 
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel1.translateValue("LDC ");
        fail("Expecting exception: RuntimeException");
