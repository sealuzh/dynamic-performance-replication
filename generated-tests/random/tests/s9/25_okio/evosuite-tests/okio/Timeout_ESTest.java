...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      timeout0.deadline(2561L, timeUnit0);
      timeout0.timeout(662L, timeUnit0);
      assertEquals(662L, timeout0.timeoutNanos());
  }
  ...
  public void test02()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(2561L, timeUnit0);
  ...
  public void test08()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1655L, timeUnit0);
      timeout1.deadlineNanoTime(1655L);
      try { 
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.deadline(1977L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(object0);
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1392409281321000L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.deadline(1977L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(1394386281320000L, long0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(618000000L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1011L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.timeout(1977L, timeUnit0);
      timeout0.deadline(1977L, timeUnit0);
      assertEquals(1977000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout((-2866L), timeUnit0);
      assertSame(timeout0, timeout1);
  }
