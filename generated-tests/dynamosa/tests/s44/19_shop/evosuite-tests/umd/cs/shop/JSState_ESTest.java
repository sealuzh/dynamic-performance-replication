...
public class JSState_ESTest extends JSState_ESTest_scaffolding {
  ...
  public void test31()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Expecting name for the method if/then pair.");
      StreamTokenizer streamTokenizer0 = new StreamTokenizer(stringReader0);
  ...
  public void test33()  throws Throwable  {
      ...
      JSSubstitution jSSubstitution0 = new JSSubstitution();
      jSState0.addElementsToState(jSPlan0);
      StringReader stringReader0 = new StringReader("Ed\"YpmX?e");
      StreamTokenizer streamTokenizer0 = new StreamTokenizer(stringReader0);
      JSTerm jSTerm0 = new JSTerm(streamTokenizer0);
      jSState0.satisfiesTAm(jSTerm0, jSSubstitution0);
      assertFalse(jSState0.isEmpty());
  ...
  public void test38()  throws Throwable  {
      StringReader stringReader0 = new StringReader("?8w8Sv^c(1c,,]v&EY");
      StreamTokenizer streamTokenizer0 = new StreamTokenizer(stringReader0);
