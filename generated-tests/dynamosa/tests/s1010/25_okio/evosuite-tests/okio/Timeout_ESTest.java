...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        timeout1.waitUntilNotified("timeout");
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout2 = timeout1.timeout(729L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(157075200000000000L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(157075200000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.timeout(1042L, timeUnit0);
      timeout1.deadlineNanoTime(1042L);
      assertEquals(1042000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1042L);
      long long0 = timeout1.deadlineNanoTime();
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.timeout(729L, timeUnit0);
      timeout0.deadline(98L, timeUnit0);
      assertEquals(729000000L, timeout0.timeoutNanos());
  }
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-594L));
  ...
  public void test21()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1019L, timeUnit0);
      timeout1.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(590L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(5587L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-585L));
