...
public class DefaultWebSecurityManager_ESTest extends DefaultWebSecurityManager_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      defaultWebSecurityManager1.setModularAuthenticationStrategy((ModularAuthenticationStrategy) null);
  ...
  public void test02()  throws Throwable  {
      FileSystemHandling.appendLineToFile((EvoSuiteFile) null, "wSEK?`<~:#Xg");
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm();
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
      // Undeclared exception!
      try { 
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionIdCookiePath("`&!k");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test07()  throws Throwable  {
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm("]`)f]&N6wl\"l]B");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
  ...
  public void test08()  throws Throwable  {
      ...
      defaultWebSecurityManager0.setRememberMeCookiePath("m$dU?");
  ...
  public void test09()  throws Throwable  {
      ...
      try {
        simplePrincipalCollection0 = new SimplePrincipalCollection((Collection) linkedHashSet0, "org.jsecurity.web.DefaultWebSecurityManager_PRINCIPALS_SESSION_KEY");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      String string0 = "] has been invalidated (stopped)";
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm("] has been invalidated (stopped)");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
      LinkedHashSet<WebRememberMeManager> linkedHashSet0 = new LinkedHashSet<WebRememberMeManager>();
      SimplePrincipalCollection simplePrincipalCollection0 = null;
      try {
        simplePrincipalCollection0 = new SimplePrincipalCollection((Collection) linkedHashSet0, "] has been invalidated (stopped)");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      simpleAccountRealm0.addAccount("org.jsecurity.web.DefaultWebSecurityManager_PRINCIPALS_SESSION_KEY", "jsecurity");
      defaultWebSecurityManager0.isHttpSessionMode();
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionMode("xogU+TrUaOK3yEnRP");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid sessionMode [xogU+TrUaOK3yEnRP].  Allowed values are public static final String constants in the org.jsecurity.web.DefaultWebSecurityManager class: 'http' or 'jsecurity', with 'http' being the default.
         //
         verifyException("org.jsecurity.web.DefaultWebSecurityManager", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      String string0 = "}cywDBg\\hDwr r,|,,H";
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm("}cywDBghDwr r,|,,H");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
      DefaultWebSecurityManager defaultWebSecurityManager1 = new DefaultWebSecurityManager(simpleAccountRealm0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      SimplePrincipalCollection simplePrincipalCollection0 = new SimplePrincipalCollection(allPermission0, "jsecurity");
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.getSession(false);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test19()  throws Throwable  {
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm("C5+N.cx#");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
  ...
  public void test20()  throws Throwable  {
      FileSystemHandling fileSystemHandling0 = new FileSystemHandling();
      String string0 = "xCp0b @TllI)";
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm("xCp0b @TllI)");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
