...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      Page page0 = Page.fail();
      Page page1 = page0.setRawText("4,3`E5j");
      assertEquals(200, page1.getStatusCode());
  ...
  public void test24()  throws Throwable  {
      Page page0 = new Page();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add(", targetRequests=");
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0, 24L);
        fail("Expecting exception: NoClassDefFoundError");
