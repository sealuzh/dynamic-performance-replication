...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(1344L, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2137L);
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-10L));
  ...
  public void test09()  throws Throwable  {
      ...
      timeout0.timeout(5074L, timeUnit0);
      timeout0.deadline(5074L, timeUnit0);
      assertEquals(18266400000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      timeout0.timeout(82L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(82000000L, timeout0.timeoutNanos());
  }
  ...
  public void test17()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(775L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.deadline(3866L, timeUnit0);
      timeout0.throwIfReached();
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1344L);
      try { 
        timeout0.throwIfReached();
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(265151590718680000L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1539L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-2080L));
      assertSame(timeout1, timeout0);
  }
