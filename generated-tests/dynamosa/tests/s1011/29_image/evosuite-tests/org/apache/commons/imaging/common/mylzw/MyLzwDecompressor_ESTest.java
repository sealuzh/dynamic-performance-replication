...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream1, 0);
  ...
  public void test01()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, (byte)5);
  ...
  public void test03()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.BIG_ENDIAN;
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(4067, byteOrder0);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress((InputStream) null, 4067);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress((InputStream) null, (-1827));
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-68), (byte)82);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      MyLzwDecompressor myLzwDecompressor0 = null;
      try {
        myLzwDecompressor0 = new MyLzwDecompressor(692, (ByteOrder) null);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test09()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream0, 1093);
      assertEquals(0, byteArray1.length);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(pipedInputStream0, 4084);
        fail("Expecting exception: IOException");
  ...
  public void test12()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 1993);
        fail("Expecting exception: IOException");
