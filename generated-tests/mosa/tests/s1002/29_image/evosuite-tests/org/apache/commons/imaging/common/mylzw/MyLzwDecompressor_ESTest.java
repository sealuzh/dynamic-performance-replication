...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((byte) (-128), byteOrder0);
      PipedInputStream pipedInputStream0 = new PipedInputStream();
      try { 
        myLzwDecompressor0.decompress(pipedInputStream0, 4);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Bad Code: -1 codes: 3 code_size: -127, table: 4096
         //
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Bad Code: -1 codes: 132 code_size: 8, table: 4096
         //
         verifyException("org.apache.commons.imaging.common.mylzw.MyLzwDecompressor", e);
      }
  }
  ...
  public void test5()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(1, byteOrder0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 832);
        fail("Expecting exception: IOException");
  ...
  public void test7()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 960);
        fail("Expecting exception: IOException");
