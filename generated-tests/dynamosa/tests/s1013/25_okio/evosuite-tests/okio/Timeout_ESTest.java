...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1909L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(910L);
      try { 
        timeout0.waitUntilNotified(timeout1);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test04()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1148L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(99187200000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(1148L, timeUnit0);
      timeout1.deadlineNanoTime(1148L);
      assertEquals(99187200000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(1148L, timeUnit0);
      timeout1.deadline(1148L, timeUnit0);
      assertEquals(99187200000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(3350L);
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(4064L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(243840000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      Timeout timeout2 = timeout1.timeout(910L, timeUnit0);
      try { 
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-5779L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1881L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-704L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.NONE.timeout((-545L), timeUnit0);
