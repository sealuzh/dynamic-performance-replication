...
public class ICSSearchAlgorithm_ESTest extends ICSSearchAlgorithm_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Instances instances0 = new Instances("\tOnly outputs cumulative margin distribution.\n", arrayList0, 2);
      BayesNet bayesNet0 = new BayesNet();
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      boolean[][] booleanArray0 = new boolean[4][9];
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next((-925), 2, 0, booleanArray0);
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet(2948, 2948, 0, booleanArray0);
  ...
  public void test02()  throws Throwable  {
      ...
      Instances instances0 = new Instances("i4rhQ5%", arrayList0, 2);
      arrayList0.add(attribute0);
      arrayList0.add(attribute0);
      BayesNet bayesNet0 = new BayesNet();
      try { 
  ...
  public void test03()  throws Throwable  {
      ...
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains((-2154));
  ...
  public void test04()  throws Throwable  {
      ...
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains(81);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
      assertFalse(boolean0);
  }
  ...
  public void test05()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ICSSearchAlgorithm.SeparationSet iCSSearchAlgorithm_SeparationSet0 = iCSSearchAlgorithm0.new SeparationSet();
      iCSSearchAlgorithm0.setMaxCardinality((-1946));
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains(358);
      assertEquals((-1946), iCSSearchAlgorithm0.getMaxCardinality());
      assertFalse(boolean0);
  }
  ...
  public void test06()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("QOnly outputs cumulative margin distributi-n.\n", arrayList0, 2);
      BayesNet bayesNet0 = new BayesNet();
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      boolean[][] booleanArray0 = new boolean[2][1];
      int int0 = iCSSearchAlgorithm0.next((-1), 10001, 65, booleanArray0);
      assertEquals(0, int0);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      int int0 = iCSSearchAlgorithm0.next(1555, 1555, 1555, booleanArray0);
  ...
  public void test08()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("_@", arrayList0, 1639);
  ...
  public void test09()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality((-1161));
  ...
  public void test13()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("+6=-", arrayList0, 1250);
      double[] doubleArray0 = new double[3];
      SparseInstance sparseInstance0 = new SparseInstance(1250, doubleArray0);
  ...
  public void test14()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("QOnly outpus cumulative margiG Aistributi-n.\n", arrayList0, 2);
      BayesNet bayesNet0 = new BayesNet();
  ...
  public void test15()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("E)P:j?}#b*cx", arrayList0, 1541);
      BayesNet bayesNet0 = new BayesNet();
  ...
  public void test16()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Attribute attribute0 = new Attribute("hZaj;XB~M@", "+");
      arrayList0.add(attribute0);
      Instances instances0 = new Instances("0d*T)b\u0003B}y?I5I)? ", arrayList0, 1555);
      BayesNet bayesNet0 = new BayesNet();
      bayesNet0.m_Instances = instances0;
      try { 
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.next(2, 747, 3, (boolean[][]) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet(1188, (-1998), (-1998), booleanArray0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test27()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      boolean[][] booleanArray0 = new boolean[23][1];
  ...
  public void test35()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"\tPath to a model to load. If set, this model
         // \twill be used for prediction and any base classifier
         // \tspecification will be ignored. Environment variables
         // \tmay be used in the path (e.g. ${HOME}/myModel.model)\"
         //
  ...
  public void test38()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("QOnly outputs cumulative margiG Aistributi-n.\n", arrayList0, 18);
      BayesNet bayesNet0 = new BayesNet();
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.name(18);
  ...
  public void test39()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("", arrayList0, 1726);
      BayesNet bayesNet0 = new BayesNet();
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      // Undeclared exception!
  ...
  public void test41()  throws Throwable  {
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality((-1427));
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet((-2892), (-2892), (-2892), (boolean[][]) null);
  ...
  public void test42()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        iCSSearchAlgorithm0.existsSepSet(33, 33, 33, booleanArray0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test50()  throws Throwable  {
      ...
      arrayList0.add(attribute0);
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality((-8));
      try { 
        iCSSearchAlgorithm0.search(bayesNet0, instances0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test51()  throws Throwable  {
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("yZW&)l<^tH", arrayList0, 2);
      BayesNet bayesNet0 = new BayesNet();
      ICSSearchAlgorithm iCSSearchAlgorithm0 = new ICSSearchAlgorithm();
      iCSSearchAlgorithm0.setMaxCardinality(3082);
      iCSSearchAlgorithm0.search(bayesNet0, instances0);
      iCSSearchAlgorithm0.existsSepSet(3082, 2, 947, (boolean[][]) null);
      assertEquals(3082, iCSSearchAlgorithm0.getMaxCardinality());
  }
  ...
  public void test54()  throws Throwable  {
      ...
      intArray0[0] = (-1);
      iCSSearchAlgorithm_SeparationSet0.m_set = intArray0;
      boolean boolean0 = iCSSearchAlgorithm_SeparationSet0.contains(231);
      assertEquals(2, iCSSearchAlgorithm0.getMaxCardinality());
      assertFalse(boolean0);
  }
