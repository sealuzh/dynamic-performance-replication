...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("t=bzP5?1gmeY");
  ...
  public void test2()  throws Throwable  {
      ...
      X500Principal x500Principal0 = new X500Principal("t=bzP?1gmeY[?", map0);
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("2.5.4.12");
      assertNotNull(string0);
      assertEquals("#0c0b627a503f31676d65595b3f", string0);
  }
  ...
  public void test4()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("t=bzP?1gmeY[?");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("t=bzP?1gmeY[?");
      assertNull(string0);
  }
}
