...
public class Utf8_ESTest extends Utf8_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      long long0 = Utf8.size("endIndex > string.length: ", 0, 22);
  ...
  public void test5()  throws Throwable  {
      // Undeclared exception!
      try { 
        Utf8.size("]$|9ekQ](vD{_", 763, 128);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // endIndex < beginIndex: 128 < 763
         //
         verifyException("okio.Utf8", e);
      }
  }
  ...
  public void test7()  throws Throwable  {
      // Undeclared exception!
      try { 
        Utf8.size((String) null, (-3489), (-3489));
        fail("Expecting exception: IllegalArgumentException");
