...
public class MultistepIntegrator_ESTest extends MultistepIntegrator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        adamsBashforthIntegrator0 = new AdamsBashforthIntegrator((-808), (-808), (-808), (-808), (-808));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // multistep method needs at least -808 previous steps, got 2
         //
  ...
  public void test2()  throws Throwable  {
      ...
      doubleArray0[4] = 123.0605;
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(1, 123.0605, 123.0605, doubleArray0, doubleArray0);
      DormandPrince853Integrator dormandPrince853Integrator0 = new DormandPrince853Integrator(0.0, 1, 1, 1);
  ...
  public void test3()  throws Throwable  {
      ...
      AdamsBashforthIntegrator adamsBashforthIntegrator0 = new AdamsBashforthIntegrator(2, (-328.37291204621), 2, doubleArray0, doubleArray0);
  ...
  public void test6()  throws Throwable  {
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(2, 2, (-1.8124135273572568E-8), (-1.8124135273572568E-8), (-1.8124135273572568E-8));
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      doReturn(2).when(secondOrderDifferentialEquations0).getDimension();
      FirstOrderConverter firstOrderConverter0 = new FirstOrderConverter(secondOrderDifferentialEquations0);
      ExpandableStatefulODE expandableStatefulODE0 = new ExpandableStatefulODE(firstOrderConverter0);
      expandableStatefulODE0.setTime((-1744.4203244));
      try { 
        adamsMoultonIntegrator0.integrate(expandableStatefulODE0, (-1.8124135273572568E-8));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minimal step size (2.00E00) reached, integration needs 2.28E-08
         //
  ...
  public void test7()  throws Throwable  {
      ...
      double[] doubleArray0 = new double[0];
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(2, (-1.8124135273572568E-8), 2, doubleArray0, doubleArray0);
      SecondOrderDifferentialEquations secondOrderDifferentialEquations0 = mock(SecondOrderDifferentialEquations.class, new ViolatedAssumptionAnswer());
      ...
      double double1 = (-595.0);
      // Undeclared exception!
      try { 
        adamsMoultonIntegrator0.integrate(expandableStatefulODE0, (-595.0));
        fail("Expecting exception: IllegalArgumentException");
