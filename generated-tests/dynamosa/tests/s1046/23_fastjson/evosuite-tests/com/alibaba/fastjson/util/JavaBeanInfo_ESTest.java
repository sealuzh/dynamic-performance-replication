...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo2 = JavaBeanInfo.build(javaBeanInfo0.clazz, (Type) javaBeanInfo1.clazz, propertyNamingStrategy0);
      Class<Object> class1 = Object.class;
      Class<Integer> class2 = Integer.class;
      JavaBeanInfo.build((Class<?>) class2, (Type) class1, propertyNamingStrategy0, false, true);
      // Undeclared exception!
      JavaBeanInfo.build(javaBeanInfo2.clazz, (Type) class0, propertyNamingStrategy0, false, false);
  }
  ...
  public void test29()  throws Throwable  {
      Class<AtomicLong> class0 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("MitYhod", class0, class0, class0, (Field) null, 80, 80, 80);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      ...
      doReturn("AllowArbitraryCommas").when(jSONType0).typeKey();
  ...
  public void test34()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("eto1", class1, class1, class1, (Field) null, 65, 65, 65);
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("eto1", class0, class0, class0, (Field) null, 3152, 3152, 3152);
  ...
  public void test35()  throws Throwable  {
      ...
      Class<Integer> class0 = Integer.class;
      Class<AtomicLong> class1 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("eto1", class1, class1, class1, (Field) null, 3152, 3152, 3152);
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("eto1", class0, class0, class0, (Field) null, 3152, 3152, 3152);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
  ...
  public void test36()  throws Throwable  {
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<AtomicLong> class0 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("eto1", class0, class0, class0, (Field) null, 63, 63, 63);
      linkedList0.add(fieldInfo0);
  ...
  public void test38()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("&>6zT").when(jSONType0).typeKey();
      doReturn("&>6zT").when(jSONType0).typeName();
  ...
  public void test39()  throws Throwable  {
      ...
      doReturn("MitYhod").when(jSONType0).typeKey();
      doReturn("").when(jSONType0).typeName();
      JavaBeanInfo javaBeanInfo0 = null;
      try {
