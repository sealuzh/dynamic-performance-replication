...
public class Okio_ESTest extends Okio_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      File file0 = MockFile.createTempFile(";{0u4}gC6^I*4H", ";{0u4}gC6^I*4H");
      Source source0 = Okio.source(file0);
      Sink sink0 = Okio.blackhole();
      RealBufferedSink realBufferedSink0 = new RealBufferedSink(sink0);
      realBufferedSink0.writeHexadecimalUnsignedLong((-1318L));
      try { 
        realBufferedSink0.write(source0, 410L);
  ...
  public void test03()  throws Throwable  {
      ...
      InetSocketAddress inetSocketAddress0 = MockInetSocketAddress.createUnresolved("+]BoWM*T9", 0);
  ...
  public void test05()  throws Throwable  {
      ...
      mockPrintStream0.format(locale0, "getsockname failed", objectArray0);
  ...
  public void test06()  throws Throwable  {
      File file0 = MockFile.createTempFile(".2TX&J", ".2TX&J");
      Source source0 = Okio.source(file0);
      assertNotNull(source0);
  }
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", " {T5jG1K6@%");
      MockFile.createTempFile("1. =R}tXeEQAmoy", "1. =R}tXeEQAmoy", (File) mockFile0);
      try { 
  ...
  public void test12()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("W@F:2CeO!LG");
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile("r=jF>l+f-", "9ts");
      MockFile mockFile0 = new MockFile(file0, "8\"YGa$e-[|kGdt1");
      try { 
  ...
  public void test14()  throws Throwable  {
      File file0 = MockFile.createTempFile("zZ0", "zZ0");
      file0.setReadOnly();
      try { 
        Okio.sink(file0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test15()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("v]dvwU8V");
      byte[] byteArray0 = new byte[9];
      FileSystemHandling.appendDataToFile(evoSuiteFile0, byteArray0);
      MockFile mockFile0 = new MockFile("v]dvwU8V");
  ...
  public void test16()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile(".K9", "", (File) mockFile0);
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("zZ0", "zZ0");
      MockFile mockFile0 = new MockFile(file0, "Zv");
      try { 
        Okio.appendingSink(mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("v].vwUV");
      try { 
        Okio.source((File) mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test27()  throws Throwable  {
      MockException mockException0 = new MockException("umber too large: ");
      AssertionError assertionError0 = new AssertionError("umber too large: ", mockException0);
      boolean boolean0 = Okio.isAndroidGetsocknameError(assertionError0);
      assertFalse(boolean0);
  }
  ...
  public void test42()  throws Throwable  {
      File file0 = MockFile.createTempFile(";{0u4}gC6^I*4H", "1x0ak\"}m<hA");
      Source source0 = Okio.source(file0);
  ...
  public void test44()  throws Throwable  {
      MockFile mockFile0 = new MockFile("C^q0B.Kl!-Z4\">+E", "C^q0B.Kl!-Z4\">+E");
      Sink sink0 = Okio.appendingSink(mockFile0);
