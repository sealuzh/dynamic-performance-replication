...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(718L, timeUnit0);
  ...
  public void test01()  throws Throwable  {
      ...
      timeout0.deadline(1992L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      timeout0.timeout(234L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(234000000000L, long0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.timeout(234L, timeUnit0);
      timeout0.deadlineNanoTime((-330L));
      assertEquals(234000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-619L));
  ...
  public void test12()  throws Throwable  {
      ...
      timeout0.timeout(2567L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(2567000L, timeout0.timeoutNanos());
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(3212L);
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(3212L, timeUnit0);
      try { 
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      timeout0.deadline(3814L, timeUnit0);
      timeout0.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(122L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-2159L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(478L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1737L), (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
