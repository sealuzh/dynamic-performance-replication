...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      cacheControl_Builder0.minFresh(16, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      cacheControl_Builder0.minFresh(1632, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
      int int0 = cacheControl0.minFreshSeconds();
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.maxStaleSeconds());
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-1857), timeUnit0);
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-1068), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1388), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
      assertEquals("max-stale=5097600", string0);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[1] = "no-store, max-age=0, max-stale=0, min-fresh=0, only-if-cached";
      stringArray0[2] = "private";
      stringArray0[3] = "no-store, max-age=0, max-stale=0, min-fresh=0, only-if-cached";
      stringArray0[4] = "no-store, max-age=0, max-stale=0, min-fresh=0, only-if-cached";
  ...
  public void test32()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "Cache-Control";
      stringArray0[1] = "no-store, max-stale=5097600, min-fresh=5097600, only-if-cached";
      stringArray0[2] = "private";
      stringArray0[3] = "no-store, max-stale=5097600, min-fresh=5097600, only-if-cached";
      stringArray0[4] = "no-store, max-stale=5097600, min-fresh=5097600, only-if-cached";
      stringArray0[5] = "Cache-Control";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertTrue(cacheControl0.noStore());
      assertEquals(5097600, cacheControl0.maxStaleSeconds());
      assertFalse(cacheControl0.noTransform());
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
  ...
  public void test33()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.add("Cache-Control", "%NI:gYi|=\"zJ?lAQ");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.onlyIfCached());
  ...
  public void test34()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("cache-control", "~Yh_)&;]");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.mustRevalidate());
