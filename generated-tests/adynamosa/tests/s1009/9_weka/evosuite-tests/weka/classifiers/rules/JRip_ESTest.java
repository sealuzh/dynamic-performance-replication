...
public class JRip_ESTest extends JRip_ESTest_scaffolding {
  ...
  public void test000()  throws Throwable  {
      ...
      try { 
        jRip0.rulesetForOneClass(104.965, instances0, 0.2, Double.NaN);
  ...
  public void test001()  throws Throwable  {
      ...
      SparseInstance sparseInstance0 = new SparseInstance((-1.0), doubleArray0, intArray0, 3);
      Attribute attribute0 = new Attribute("", (-2857));
      sparseInstance0.setValue(attribute0, (-6318.0));
  ...
  public void test002()  throws Throwable  {
      ...
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("YcunWm<G\"Fo{|Nyow.c", arrayList0, 1);
      ...
      jRip_NominalAntd0.splitData(instances0, 1416.82831, (-1793.71292090742));
      assertEquals(Double.NaN, jRip_NominalAntd0.getCover(), 0.01);
      assertTrue(jRip0.getCheckErrorRate());
      assertEquals(2.0, jRip0.getMinNo(), 0.01);
      assertEquals(Double.NaN, jRip_NominalAntd0.getAttrValue(), 0.01);
  ...
  public void test003()  throws Throwable  {
      ...
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute1);
      instances0.add((Instance) binarySparseInstance0);
      jRip_NominalAntd0.splitData(instances0, 5, 12);
      assertEquals(Double.NaN, jRip_NominalAntd0.getAttrValue(), 0.01);
      assertEquals(Double.NaN, jRip_NominalAntd0.getCover(), 0.01);
      assertEquals(1L, jRip0.getSeed());
      assertFalse(jRip0.getDebug());
  ...
  public void test005()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("(", 985);
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
      assertEquals(Double.NaN, jRip_NumericAntd0.getAttrValue(), 0.01);
      
      jRip_NumericAntd0.value = (double) 1;
      double[] doubleArray0 = new double[5];
      jRip_NumericAntd0.value = (-3209.996973489);
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(1122.0639, doubleArray0);
  ...
  public void test006()  throws Throwable  {
      ...
      jRip_NumericAntd0.splitData(instances0, (-2130.0), 0);
      assertEquals(2.0, jRip0.getMinNo(), 0.01);
  }
  ...
  public void test007()  throws Throwable  {
      ...
      JRip jRip0 = new JRip();
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
      jRip_NumericAntd0.splitData(instances0, 3, (-136.3822649));
  ...
  public void test008()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("", 35);
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute0);
  ...
  public void test010()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("V~\"^`Th(@q");
  ...
  public void test024()  throws Throwable  {
      JRip jRip0 = new JRip();
      jRip0.setFolds(262);
      assertEquals(262, jRip0.getFolds());
  }
  ...
  public void test026()  throws Throwable  {
      JRip jRip0 = new JRip();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("relational", arrayList0, 35);
      try { 
        jRip0.rulesetForOneClass((-2754.1845), instances0, (-1.0), 0.0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test035()  throws Throwable  {
      JRip jRip0 = new JRip();
      double[] doubleArray0 = new double[5];
      SparseInstance sparseInstance0 = new SparseInstance((-10.79265817), doubleArray0);
      // Undeclared exception!
      try { 
  ...
  public void test036()  throws Throwable  {
      ...
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(1L, intArray0, (-366));
      // Undeclared exception!
      try { 
        jRip0.distributionForInstance(binarySparseInstance0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test037()  throws Throwable  {
      JRip jRip0 = new JRip();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("V~\"^`Th(@q", arrayList0, 3);
  ...
  public void test044()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute("UeMd}*", "");
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute0);
  ...
  public void test049()  throws Throwable  {
      ...
      jRip0.setUsePruning(false);
      try { 
        jRip0.rulesetForOneClass(1158.1476892749283, instances0, (-1145.3932688), 83);
        fail("Expecting exception: NullPointerException");
  ...
  public void test050()  throws Throwable  {
      ...
      Properties properties0 = new Properties();
      ProtectedProperties protectedProperties0 = new ProtectedProperties(properties0);
      Attribute attribute0 = new Attribute("-F <number of folds>", instances0, protectedProperties0);
      JRip.RipperRule jRip_RipperRule0 = jRip0.new RipperRule();
  ...
  public void test052()  throws Throwable  {
      JRip jRip0 = new JRip();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances(")1.IO_;WyBnMqvvcu", arrayList0, 7);
      Properties properties0 = new Properties();
      ProtectedProperties protectedProperties0 = new ProtectedProperties(properties0);
      ...
      jRip0.setUsePruning(false);
      try { 
        jRip0.rulesetForOneClass((-1987.6343615), instances0, 64.0, (-52.0));
  ...
  public void test053()  throws Throwable  {
      JRip jRip0 = new JRip();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances((String) null, arrayList0, 1422);
      jRip0.setUsePruning(false);
      Attribute attribute0 = new Attribute(".bsi", 1422);
      instances0.setClass(attribute0);
      SparseInstance sparseInstance0 = new SparseInstance(12);
      instances0.add((Instance) sparseInstance0);
      try { 
        jRip0.rulesetForOneClass(1, instances0, 4, (-1772.17035187692));
  ...
  public void test058()  throws Throwable  {
      ...
      int[] intArray0 = new int[7];
      SparseInstance sparseInstance0 = new SparseInstance((-1.0), doubleArray0, intArray0, 3);
      sparseInstance0.setValue((-2857), (double) 70);
      Attribute attribute0 = new Attribute("", (-2857));
      JRip.NominalAntd jRip_NominalAntd0 = jRip0.new NominalAntd(attribute0);
      boolean boolean0 = jRip_NominalAntd0.covers(sparseInstance0);
      assertEquals(0.0, jRip_NominalAntd0.getMaxInfoGain(), 0.01);
  ...
  public void test062()  throws Throwable  {
      JRip jRip0 = new JRip();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("The size of the cache (a prime number), 0 for full cache and -1 to turn it off.", arrayList0, 7);
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("1o3g2okcZQ~2<");
      Attribute attribute0 = new Attribute("@data", linkedList0, 0);
      arrayList0.add(attribute0);
      Utils.SMALL = (-52.0);
      jRip0.setUsePruning(false);
      try { 
        jRip0.rulesetForOneClass((-2130L), instances0, 0, (-52.0));
        fail("Expecting exception: RuntimeException");
  ...
  public void test064()  throws Throwable  {
      ...
      jRip_NumericAntd0.value = (-2130.0);
      String string0 = jRip_NumericAntd0.toString();
      assertEquals(" >= NaN", string0);
  }
  ...
  public void test065()  throws Throwable  {
      JRip jRip0 = new JRip();
      Attribute attribute0 = new Attribute(" |dl = ", 985);
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
      assertEquals(Double.NaN, jRip_NumericAntd0.getAttrValue(), 0.01);
  ...
  public void test066()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("-F <number of folds>", instances0, protectedProperties0);
      arrayList0.add(attribute0);
      Instances instances1 = new Instances("V~\"^`Th(@q", arrayList0, 2);
      JRip.NumericAntd jRip_NumericAntd0 = jRip0.new NumericAntd(attribute0);
      SparseInstance sparseInstance0 = new SparseInstance(184);
      boolean boolean0 = jRip_NumericAntd0.covers(sparseInstance0);
      assertEquals(0.0, jRip_NumericAntd0.getMaxInfoGain(), 0.01);
      assertFalse(jRip0.getDebug());
      assertEquals(Double.NaN, jRip_NumericAntd0.getAttrValue(), 0.01);
  ...
  public void test108()  throws Throwable  {
      JRip jRip0 = new JRip();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("V~\"^`Th(@q", arrayList0, 1);
      try { 
        jRip0.buildClassifier(instances0);
        fail("Expecting exception: Exception");
