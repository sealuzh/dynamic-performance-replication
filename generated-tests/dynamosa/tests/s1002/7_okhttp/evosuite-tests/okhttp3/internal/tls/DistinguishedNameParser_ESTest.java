...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=an");
  ...
  public void test2()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=:&Xa");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
  ...
  public void test4()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("l=4  -U4!jAyl");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("l=4  -U4!jAyl");
      assertNull(string0);
  }
  ...
  public void test7()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("s=94y#Y$_");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("");
      assertNull(string0);
  }
