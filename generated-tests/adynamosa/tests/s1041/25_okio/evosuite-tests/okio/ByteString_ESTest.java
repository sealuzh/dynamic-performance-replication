...
public class ByteString_ESTest extends ByteString_ESTest_scaffolding {
  ...
  public void test004()  throws Throwable  {
      ...
      ByteBuffer byteBuffer0 = charset0.encode("`iUP_I  Jo");
      ByteString byteString0 = ByteString.of(byteBuffer0);
      ByteString byteString1 = byteString0.toAsciiLowercase();
      ByteString byteString2 = ByteString.decodeBase64("Dqot csx");
  ...
  public void test005()  throws Throwable  {
      Charset charset0 = Charset.defaultCharset();
      ByteString byteString0 = ByteString.encodeString("Z~]K6>T#,&6i~", charset0);
      ByteString byteString1 = byteString0.toAsciiLowercase();
      assertNotSame(byteString1, byteString0);
  }
  ...
  public void test010()  throws Throwable  {
      // Undeclared exception!
      try { 
        ByteString.decodeHex("29U] H!yAX>]");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test011()  throws Throwable  {
      // Undeclared exception!
      try { 
        ByteString.decodeHex("0`A,/pTIep@d!'");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test019()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      boolean boolean0 = byteString0.rangeEquals(1292, byteString0, 1292, (-3704));
      assertTrue(boolean0);
  }
  ...
  public void test020()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      ByteString byteString1 = ByteString.encodeUtf8("Z}<TsAy");
  ...
  public void test024()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      ByteString byteString1 = byteString0.sha512();
      int int0 = byteString1.indexOf(byteString0, (int) (byte)16);
  ...
  public void test025()  throws Throwable  {
      ...
      Charset charset0 = Charset.defaultCharset();
      ByteString byteString1 = ByteString.encodeString(",X=i$\"3TU,", charset0);
  ...
  public void test028()  throws Throwable  {
      ByteBuffer byteBuffer0 = ByteBuffer.allocate(3095);
      ByteString byteString0 = ByteString.of(byteBuffer0);
      byte byte0 = byteString0.getByte(16);
  ...
  public void test030()  throws Throwable  {
      int int0 = ByteString.codePointIndexToCharIndex("D!-)", (byte) (-13));
      assertEquals((-1), int0);
  }
  ...
  public void test035()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        byteString0.substring((-1332), (-1332));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test040()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      byte[] byteArray0 = new byte[3];
      boolean boolean0 = byteString0.rangeEquals(11, byteArray0, (int) (byte)0, (-1284));
      assertTrue(boolean0);
  }
  ...
  public void test041()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      boolean boolean0 = byteString0.rangeEquals((-3696), (byte[]) null, (-3696), (-3696));
      assertFalse(boolean0);
  }
  ...
  public void test042()  throws Throwable  {
      ByteString byteString0 = ByteString.encodeUtf8("[size=");
      boolean boolean0 = byteString0.rangeEquals(81, byteString0, 227, 0);
      assertFalse(boolean0);
  }
  ...
  public void test043()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      boolean boolean0 = byteString0.rangeEquals(752, byteString0, (int) (byte)0, 12);
      assertFalse(boolean0);
  }
  ...
  public void test044()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      ByteString byteString1 = ByteString.decodeHex("C6");
      boolean boolean0 = byteString0.rangeEquals(6, byteString1, 2003, 5);
      assertFalse(boolean0);
  }
  ...
  public void test045()  throws Throwable  {
      ...
      ByteBuffer byteBuffer0 = charset0.encode("");
      ByteString byteString0 = ByteString.of(byteBuffer0);
      boolean boolean0 = byteString0.EMPTY.rangeEquals(0, byteString0, 46, 46);
      assertFalse(boolean0);
  }
  ...
  public void test048()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ByteString.of(byteArray0, (int) (byte)0, (-1841));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
      
      } catch(ArrayIndexOutOfBoundsException e) {
         //
         // size=1 offset=0 byteCount=-1841
         //
  ...
  public void test049()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ByteString.of(byteArray0, (-940), 10);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
      
      } catch(ArrayIndexOutOfBoundsException e) {
         //
         // size=0 offset=-940 byteCount=10
         //
         verifyException("okio.Util", e);
      }
  }
  ...
  public void test053()  throws Throwable  {
      ByteString byteString0 = ByteString.decodeBase64("89R");
      byte[] byteArray0 = new byte[1];
  ...
  public void test064()  throws Throwable  {
      ByteString byteString0 = ByteString.decodeBase64("");
      int int0 = byteString0.lastIndexOf(byteString0, (int) (byte) (-5));
      assertEquals((-1), int0);
  }

  @Test(timeout = 4000)
  public void test065()  throws Throwable  {
      int int0 = ByteString.codePointIndexToCharIndex("", 9);
      assertEquals(0, int0);
  }
  ...
  public void test067()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        byteString0.EMPTY.rangeEquals(15, (ByteString) null, 213, 15);
        fail("Expecting exception: NullPointerException");
  ...
  public void test068()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        byteString0.lastIndexOf((byte[]) null, (-1786));
        fail("Expecting exception: NullPointerException");
  ...
  public void test070()  throws Throwable  {
      ByteString byteString0 = ByteString.decodeBase64("S4wlu$vlLJQW(UC");
      // Undeclared exception!
      try { 
  ...
  public void test074()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        byteString0.indexOf((ByteString) null, 675);
        fail("Expecting exception: NullPointerException");
  ...
  public void test085()  throws Throwable  {
      ...
      int int0 = byteString0.indexOf(byteArray0, (int) (byte)27);
  ...
  public void test086()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      byte[] byteArray0 = new byte[1];
      boolean boolean0 = byteString0.rangeEquals(11, byteArray0, (int) (byte)125, (-1284));
      assertTrue(boolean0);
  }
  ...
  public void test087()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      byte[] byteArray0 = new byte[0];
      boolean boolean0 = byteString0.rangeEquals(17, byteArray0, 4006, 1727);
      assertFalse(boolean0);
  }
  ...
  public void test088()  throws Throwable  {
      ...
      ByteString byteString2 = byteString1.substring((int) (byte)14, (int) (byte)14);
  ...
  public void test090()  throws Throwable  {
      ...
      assertEquals("606955505f4920204a6f", string0);
  }

  @Test(timeout = 4000)
  public void test091()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      ByteString byteString1 = ByteString.encodeUtf8("\"xU");
      FileSystemHandling fileSystemHandling0 = new FileSystemHandling();
      byteString1.base64Url();
      byteString1.lastIndexOf(byteString0, 5);
      byteString0.utf8();
      byteString1.compareTo(byteString0);
      String string0 = "!Yr|ym:X";
      // Undeclared exception!
      try { 
        Charset.forName("!Yr|ym:X");
  ...
  public void test094()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("[hex=f0d4]", string0);
  }
  ...
  public void test096()  throws Throwable  {
      int int0 = ByteString.codePointIndexToCharIndex("`iUP_I  Jo", (-1));
      assertEquals(10, int0);
  }

  @Test(timeout = 4000)
  public void test097()  throws Throwable  {
      int int0 = ByteString.codePointIndexToCharIndex("F_Xgn_Yt}x.,pHQh", 0);
      assertEquals(0, int0);
  }
  ...
  public void test102()  throws Throwable  {
      ByteString byteString0 = ByteString.encodeUtf8("=");
      Charset charset0 = Charset.defaultCharset();
      ByteBuffer byteBuffer0 = charset0.encode("V3");
      ByteString byteString1 = ByteString.of(byteBuffer0);
      int int0 = byteString0.compareTo(byteString1);
      assertEquals((-1), int0);
  }
  ...
  public void test105()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      ByteString byteString1 = ByteString.encodeUtf8("Z}=WisAy");
  ...
  public void test110()  throws Throwable  {
      ByteString byteString0 = ByteString.encodeUtf8("yF0=MA?)KmS;|~");
      ByteString byteString1 = byteString0.toAsciiLowercase();
  ...
  public void test111()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[6];
      boolean boolean0 = byteString0.rangeEquals((int) (byte)0, byteArray0, (int) (byte)19, (int) (byte)0);
      assertFalse(boolean0);
  }
  ...
  public void test116()  throws Throwable  {
      ByteString byteString0 = ByteString.EMPTY;
      ByteString byteString1 = byteString0.sha256();
      ByteString byteString2 = byteString1.substring((int) (byte)16);
  ...
  public void test120()  throws Throwable  {
      ...
      ByteString byteString0 = ByteString.of(byteBuffer0);
      ByteString byteString1 = byteString0.toAsciiLowercase();
      int int0 = byteString1.indexOf(byteString0, (-675));
      assertEquals((-1), int0);
  }
  ...
  public void test122()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        ByteString.read(dataInputStream0, (-957));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test124()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        byteString0.EMPTY.substring((int) (byte)0, 87);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test125()  throws Throwable  {
      ByteString byteString0 = ByteString.decodeHex("C6");
      byte[] byteArray0 = new byte[0];
      int int0 = byteString0.lastIndexOf(byteArray0);
      assertEquals(1, int0);
  }
  ...
  public void test126()  throws Throwable  {
      // Undeclared exception!
      try { 
        ByteString.decodeHex("$M](DH+hs$jOErwuo\"%");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Unexpected hex string: $M](DH+hs$jOErwuo\"%
         //
         verifyException("okio.ByteString", e);
      }
  }
  ...
  public void test132()  throws Throwable  {
      // Undeclared exception!
      try { 
        ByteString.encodeString("Ej7y-g", (Charset) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test136()  throws Throwable  {
      // Undeclared exception!
      try { 
        ByteString.of((byte[]) null, 65, 2673);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test152()  throws Throwable  {
      ...
      ByteString byteString1 = byteString0.sha1();
      byte[] byteArray0 = new byte[0];
      int int0 = byteString1.lastIndexOf(byteArray0, 6);
      assertEquals(6, int0);
  }
