...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      cacheControl_Builder0.maxAge(973, timeUnit0);
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-1272), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1058), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxStale(116, timeUnit0);
      assertSame(cacheControl_Builder1, cacheControl_Builder0);
  }
  ...
  public void test12()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      cacheControl_Builder0.minFresh(116, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      String string0 = cacheControl0.toString();
      assertEquals("min-fresh=6960", string0);
      assertNotNull(string0);
  }
  ...
  public void test13()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(973, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
      assertEquals("max-age=84067200", string0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      stringArray0[6] = "#aEpF}k";
      stringArray0[7] = "j[g{l>p#ba";
  ...
  public void test18()  throws Throwable  {
      ...
      stringArray0[4] = "no-store";
      stringArray0[5] = "n`zsEn#*";
      stringArray0[6] = "must-revalidate, ";
      stringArray0[7] = "j[g{l>p#ba";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.noStore());
  ...
  public void test19()  throws Throwable  {
      ...
      stringArray0[3] = "r]4mb'ua$'/%id$jt?";
      stringArray0[4] = "size < 8: ";
      stringArray0[5] = "EEE MMM d HH:mm:ss yyyy";
      stringArray0[6] = " #%/:?@[]";
      stringArray0[7] = "X<mDP_uh?v*(TPJmcn";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
  ...
  public void test25()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "G6\u0002ihEe7^";
      stringArray0[1] = "%iu";
      stringArray0[2] = "r]4Mb'uA$'/%id$Jt?";
      stringArray0[3] = "7oqki\"'r";
      stringArray0[4] = "vC/iN 7ci;4[i3Wk9fw";
      stringArray0[5] = "no-store";
      stringArray0[6] = "pragma";
      stringArray0[7] = "dtw;&)jc\"v ta vh";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertFalse(cacheControl0.noStore());
