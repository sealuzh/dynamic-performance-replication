...
public class MyLzwCompressor_ESTest extends MyLzwCompressor_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      MyLzwCompressor.Listener myLzwCompressor_Listener0 = mock(MyLzwCompressor.Listener.class, new ViolatedAssumptionAnswer());
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor((-2550), byteOrder0, true, myLzwCompressor_Listener0);
      byte[] byteArray0 = new byte[5];
  ...
  public void test2()  throws Throwable  {
      ...
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor((-5271), byteOrder0, false);
      // Undeclared exception!
      try { 
  ...
  public void test3()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.LITTLE_ENDIAN;
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(1185, byteOrder0, false);
      byte[] byteArray0 = new byte[8];
      byte[] byteArray1 = myLzwCompressor0.compress(byteArray0);
      assertEquals(2521, byteArray1.length);
  }
