...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(1535L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(92100000000000L, long0);
  }
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(1535L, timeUnit0);
      timeout1.deadlineNanoTime(1535L);
      assertEquals(92100000000000L, timeout0.timeoutNanos());
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1315L);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(3015L);
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(1865L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(1865000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-2583L), timeUnit0);
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(3015L);
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(3015L, timeUnit0);
      try { 
  ...
  public void test20()  throws Throwable  {
      ...
      timeout0.deadline(1315L, timeUnit0);
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(185L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-199L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime((-2285L));
