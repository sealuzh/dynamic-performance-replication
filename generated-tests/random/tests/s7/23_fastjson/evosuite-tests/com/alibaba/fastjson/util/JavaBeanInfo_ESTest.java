...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn("LocalVariableTypeTable").when(jSONType0).typeKey();
      doReturn(" |l{7;2K").when(jSONType0).typeName();
  ...
  public void test20()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("com.alibaba.fastjson.util.FieldInfo", class0, class0, class0, (Field) null, 2147483645, 11, 22);
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("com.alibaba.fastjson.util.FieldInfo", class1, class1, class0, (Field) null, 11, 1, 22);
