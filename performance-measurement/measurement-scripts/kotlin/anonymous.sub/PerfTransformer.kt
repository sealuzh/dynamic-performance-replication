...
class PerfTransformer(outDir: String, testDir: String, approaches: List<String>, val printToStdout: Boolean = false, val mockGui: Boolean = true) : AbstractTransformer(outDir, testDir, approaches) {
    ...
    val importPerfCounterWriterImpl = "anonymous.sub.PerfCounterWriterImpl"
    val importPerfCounterWriter = "anonymous.sub.PerfCounterWriter"
    val importPCWFileWriter = "anonymous.sub.FileWriter"
    val importPCWSystem = "anonymous.sub.System"
