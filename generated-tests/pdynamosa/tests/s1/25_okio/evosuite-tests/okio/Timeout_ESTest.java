...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(177L, timeUnit0);
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1142L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.deadline(386L, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals(2782009281320000L, long0);
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.deadline(4111200000000000L, timeUnit0);
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      Timeout timeout1 = timeout0.timeout(2076L, timeUnit0);
      timeout1.deadline(4111200000000000L, timeUnit0);
      assertEquals(7473600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1823L));
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout1.timeout(1L, timeUnit0);
      assertEquals(86400000000000L, timeout1.timeoutNanos());
  }
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(152L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified("EBcTZqr z{#%");
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(570L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(177L, timeUnit0);
      timeout0.throwIfReached();
  ...
  public void test25()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2175L);
      try { 
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1401L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2689L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(2175L, timeUnit0);
      timeout0.deadlineNanoTime(2175L);
      try { 
        timeout0.waitUntilNotified(timeout1);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test31()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime(872L);
      assertSame(timeout0, timeout1);
  }
