...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1047L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(576L);
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout1.timeout(576L, timeUnit0);
      try { 
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(1047L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(90460800000000000L, long0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      timeout0.timeout(174L, timeUnit0);
      timeout0.deadlineNanoTime(174L);
      assertEquals(174L, timeout0.timeoutNanos());
  }
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.deadline(3382L, timeUnit0);
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals(90460800000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1565L));
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1565L), timeUnit0);
  ...
  public void test15()  throws Throwable  {
      ...
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(5161609281320000L, long0);
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(174L, timeUnit0);
      Timeout timeout2 = timeout1.deadline(174L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test20()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(174L, timeUnit0);
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(174L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime(2861L);
