...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(2705, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      int int0 = cacheControl0.minFreshSeconds();
      assertFalse(cacheControl0.mustRevalidate());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
  ...
  public void test31()  throws Throwable  {
      ...
      stringArray0[1] = "no-store, max-stale=15760800, min-fresh=0, no-transform";
      stringArray0[2] = "EC@dXq'vHj&8QY&`14k";
      stringArray0[3] = "no-store, max-stale=15760800, min-fresh=0, no-transform";
      stringArray0[4] = "cache-control";
      stringArray0[5] = "no-store, max-stale=15760800, min-fresh=0, no-transform";
      ...
      assertFalse(cacheControl0.onlyIfCached());
      assertEquals(15760800, cacheControl0.maxStaleSeconds());
      assertEquals((-1), cacheControl0.maxAgeSeconds());
  ...
  public void test35()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.addLenient("cache-control", "a21$AHx4S5e#Gg;");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertEquals((-1), cacheControl0.minFreshSeconds());
  ...
  public void test36()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "cache-control";
      stringArray0[1] = "no-store, max-age=15760800, min-fresh=378259200, no-transform";
      stringArray0[2] = "EC@dXq'vHj&8QY&`14k";
      stringArray0[3] = "no-store, max-age=15760800, min-fresh=378259200, no-transform";
      stringArray0[4] = "cache-control";
      stringArray0[5] = "no-store, max-age=15760800, min-fresh=378259200, no-transform";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertEquals(378259200, cacheControl0.minFreshSeconds());
      assertTrue(cacheControl0.noStore());
      assertEquals((-1), cacheControl0.maxStaleSeconds());
      assertEquals(15760800, cacheControl0.maxAgeSeconds());
      assertFalse(cacheControl0.onlyIfCached());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.noCache());
      assertFalse(cacheControl0.mustRevalidate());
  ...
  public void test37()  throws Throwable  {
      ...
      headers_Builder0.addLenient("Cache-Control", "`rjyfa8mfh(");
      Headers headers0 = new Headers(headers_Builder0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.minFreshSeconds());
