...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(3406L);
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1103L, timeUnit0);
      timeout1.deadlineNanoTime(1039L);
      assertEquals(66180000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1523L, timeUnit0);
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(3406L);
  ...
  public void test06()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(2815L, timeUnit0);
      timeout1.timeout(1535L, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      timeout0.timeout(4088L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(object0);
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(2815L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(timeUnit0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1523L);
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1810L, (TimeUnit) null);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-716L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.deadline(1103L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(1458589281320000L, long0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1810L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-179L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(1103L, timeUnit0);
      timeout1.deadline(1103L, timeUnit0);
      assertEquals(66180000000000L, timeout0.timeoutNanos());
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1810L, timeUnit0);
