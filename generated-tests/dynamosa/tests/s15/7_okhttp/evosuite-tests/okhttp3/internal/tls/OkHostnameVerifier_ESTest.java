...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // codegen.java.security.cert.Certificate$MockitoMock$597281570 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test6()  throws Throwable  {
      ...
      OkHostnameVerifier okHostnameVerifier0 = OkHostnameVerifier.INSTANCE;
      LinkedHashSet<List<Principal>> linkedHashSet0 = new LinkedHashSet<List<Principal>>(1, 1);
      ...
      okHostnameVerifier1.verify("6", x509Certificate3);
      okHostnameVerifier1.verify("6", x509Certificate2);
      ...
      certificateArray0[2] = (Certificate) x509Certificate3;
      certificateArray0[3] = (Certificate) x509Certificate2;
      certificateArray0[4] = (Certificate) x509Certificate3;
      certificateArray0[5] = (Certificate) x509Certificate3;
      certificateArray0[6] = (Certificate) x509Certificate3;
      certificateArray0[7] = certificateArray0[6];
      SSLSession sSLSession0 = mock(SSLSession.class, new ViolatedAssumptionAnswer());
      doReturn(certificateArray0).when(sSLSession0).getPeerCertificates();
      // Undeclared exception!
      try { 
        okHostnameVerifier2.verify("J4Cj*lV*=?$", sSLSession0);
        fail("Expecting exception: NullPointerException");
