...
public class JSJshop_ESTest extends JSJshop_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/mnt/gaiagpfs/users/homedirs/apanichella/Evosuite_performance/Dataset/gordon_script_mosa/projects/19_shop/'{x@c");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "'{x@c");
      JSJshop jSJshop0 = null;
      try {
        jSJshop0 = new JSJshop("'{x@c", "'{x@c");
  ...
  public void test02()  throws Throwable  {
      JSJshop jSJshop0 = null;
      try {
        jSJshop0 = new JSJshop("&Yh;s555KTr\"", (JSTaskAtom) null);
  ...
  public void test17()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/mnt/gaiagpfs/users/homedirs/apanichella/Evosuite_performance/Dataset/gordon_script_mosa/projects/19_shop/pu/pu");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "tR@eBX6N Z_8");
      JSJshop jSJshop0 = new JSJshop();
      BufferedReader bufferedReader0 = jSJshop0.getBufferedReader("pu", "pu", (JApplet) null);
  ...
  public void test18()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/mnt/gaiagpfs/users/homedirs/apanichella/Evosuite_performance/Dataset/gordon_script_mosa/projects/19_shop/'{x@c");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, ";");
      JSJshop jSJshop0 = new JSJshop("'{x@c", "'{x@c");
  ...
  public void test20()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/mnt/gaiagpfs/users/homedirs/apanichella/Evosuite_performance/Dataset/gordon_script_mosa/projects/19_shop/pu/pu");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, ">@afPJ}o(xeHO");
      JSJshop jSJshop0 = new JSJshop();
      String[] stringArray0 = new String[3];
      stringArray0[0] = ">@afPJ}o(xeHO";
      stringArray0[1] = "pu";
      stringArray0[2] = "all";
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      JSJshop jSJshop1 = new JSJshop("g+\"uDQ%W6KpDN", "g+\"uDQ%W6KpDN");
      assertFalse(JSJshop.corbaToHicap);
  }
}
