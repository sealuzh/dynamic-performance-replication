...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(3478L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(692L);
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout2 = timeout1.timeout(692L, timeUnit0);
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(2837L);
  ...
  public void test06()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1L, timeUnit0);
      timeout1.deadlineNanoTime(814L);
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals(1393554281320000L, long0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-9L));
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(389L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(23340000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime((-1743L));
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(502L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1578L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1392409281320001L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-389L), (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(1674L, timeUnit0);
      Timeout timeout1 = timeout0.deadline(1L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
  ...
  public void test28()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.NONE.timeout(7430400000000000L, timeUnit0);
      assertFalse(timeout1.equals((Object)timeout0));
  }
