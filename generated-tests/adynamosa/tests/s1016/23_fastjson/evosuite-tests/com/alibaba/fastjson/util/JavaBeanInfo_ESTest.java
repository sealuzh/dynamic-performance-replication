...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test12()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("getnotifyAll", class0, class0, class2, (Field) null, (-2063927856), (-2079609709), 854);
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.SnakeCase;
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build(class2, (Type) class0, propertyNamingStrategy0);
      Type[] typeArray0 = new Type[2];
      ParameterizedTypeImpl parameterizedTypeImpl0 = new ParameterizedTypeImpl(typeArray0, fieldInfo0.fieldClass, fieldInfo0.declaringClass);
      typeArray0[0] = (Type) parameterizedTypeImpl0;
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build(javaBeanInfo0.clazz, typeArray0[0], propertyNamingStrategy0, true, true);
  ...
  public void test14()  throws Throwable  {
      ...
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.SnakeCase;
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build(class2, (Type) class0, propertyNamingStrategy0);
      ParameterizedTypeImpl parameterizedTypeImpl0 = new ParameterizedTypeImpl(javaBeanInfo0.creatorConstructorParameterTypes, fieldInfo0.fieldClass, fieldInfo0.declaringClass);
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      ...
      try {
        javaBeanInfo1 = new JavaBeanInfo(class1, class0, javaBeanInfo0.creatorConstructor, javaBeanInfo0.creatorConstructor, (Method) null, (Method) null, (JSONType) null, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      doReturn(class1).when(jSONType0).builder();
      Class<?> class2 = JavaBeanInfo.getBuilderClass(jSONType0);
      FieldInfo fieldInfo0 = new FieldInfo("getnotifyAll", class0, class0, class2, (Field) null, (-2063927856), (-2079609709), 887);
      Class<Annotation> class3 = Annotation.class;
      Class<AtomicInteger> class4 = AtomicInteger.class;
      FieldInfo fieldInfo1 = new FieldInfo("getnotifyAll", class3, class4, class2, (Field) null, (-1182), (-2208), (-2208));
  ...
  public void test33()  throws Throwable  {
      ...
      doReturn(class1).when(jSONType0).builder();
      Class<?> class2 = JavaBeanInfo.getBuilderClass(jSONType0);
      FieldInfo fieldInfo0 = new FieldInfo("getnotifyAll", class0, class0, class2, (Field) null, (-2063927856), (-2079609681), 854);
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo0);
      assertEquals(1, linkedList0.size());
      assertTrue(boolean0);
  ...
  public void test35()  throws Throwable  {
      ...
      doReturn("get", "get").when(jSONType0).typeKey();
      doReturn("get", "get").when(jSONType0).typeName();
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
      Class<AtomicLong> class0 = AtomicLong.class;
      ...
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(class0, class0, javaBeanInfo0.defaultConstructor, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      Class<Object> class3 = Object.class;
      linkedList0.add((FieldInfo) null);
      JavaBeanInfo javaBeanInfo2 = null;
      try {
        javaBeanInfo2 = new JavaBeanInfo(class1, class3, (Constructor<?>) null, javaBeanInfo0.defaultConstructor, (Method) null, (Method) null, javaBeanInfo1.jsonType, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      ...
      doReturn("[],2ldRQ)9L$=0(").when(jSONType0).typeKey();
      doReturn("[],2ldRQ)9L$=0(").when(jSONType0).typeName();
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
      Class<AtomicLong> class0 = AtomicLong.class;
      Class<AtomicBoolean> class1 = AtomicBoolean.class;
      JSONType jSONType1 = mock(JSONType.class, new ViolatedAssumptionAnswer());
  ...
  public void test37()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo1 = null;
      try {
        javaBeanInfo1 = new JavaBeanInfo(class0, class1, (Constructor<?>) null, javaBeanInfo0.defaultConstructor, (Method) null, (Method) null, jSONType0, linkedList0);
        fail("Expecting exception: NullPointerException");
