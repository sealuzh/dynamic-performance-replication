...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn(".A,7|~oD2").when(request0).method();
  ...
  public void test02()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn(".A,7|~YD2").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test06()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>(485);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test07()  throws Throwable  {
      ...
      stringArray0[1] = "337252758";
      stringArray0[2] = "337252758";
      stringArray0[3] = "337252758";
      Headers headers0 = Headers.of(stringArray0);
      long long0 = HttpHeaders.contentLength(headers0);
      assertEquals(337252758L, long0);
  }
  ...
  public void test15()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("chunked", (-1215));
  ...
  public void test19()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put(".A,7|~oD2", "7wL;g*\"T]:<gp#N");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test25()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace(".A,7|~oD2", (-332));
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("Ka2Ha60A", (-114), "Ka2Ha60A");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-200), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("CQ19 %o/}JQrpd^ ", "CQ19 %o/}JQrpd^ ");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
  ...
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("7", 3886);
      assertEquals(7, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("2233725477588", 75);
  ...
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("data == null", 0, "-");
  ...
  public void test45()  throws Throwable  {
      ...
      doReturn("D44(V").when(response0).header(anyString());
      doReturn(headers0).when(response0).headers();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertFalse(boolean0);
  ...
  public void test46()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Y;8gE").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test48()  throws Throwable  {
      ...
      doReturn(".A,7|~oD2").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(480).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      stringArray0[3] = "(M2)";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "(M2)");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("; relms=", "; relms=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "; relms=");
      assertEquals(0, list0.size());
  }
