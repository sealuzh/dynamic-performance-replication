...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(119L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(10281600000000000L, long0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(2843L, timeUnit0);
      timeout1.timeout(2843L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      assertEquals(2843000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      assertEquals(10281600000000000L, timeout0.timeoutNanos());
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      Timeout timeout1 = timeout0.deadlineNanoTime((-2995L));
  ...
  public void test11()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(3830L, timeUnit0);
      Timeout timeout2 = timeout1.deadline(3830L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(906L);
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(119L, (TimeUnit) null);
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.deadline(3830L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(119L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(2843L, timeUnit0);
      // Undeclared exception!
      try { 
