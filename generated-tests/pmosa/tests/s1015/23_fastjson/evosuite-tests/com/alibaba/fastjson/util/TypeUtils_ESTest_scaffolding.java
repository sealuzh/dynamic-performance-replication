...
public class TypeUtils_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.function.DoubleBinaryOperator", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToDoubleFunction", false, TypeUtils_ESTest_scaffolding.class.getClassLoader()));
  }
