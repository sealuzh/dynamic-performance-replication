...
public class Class2HTML_ESTest extends Class2HTML_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Class2HTML class2HTML0 = new Class2HTML(javaClass0, "clas");
  ...
  public void test02()  throws Throwable  {
      String string0 = Class2HTML.referenceType("F`{=vpIQZH[~H");
      assertEquals("<A HREF=\"F`{=vpIQZH.html\" TARGET=_top>F`{=vpIQZH[~H</A>", string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        Class2HTML.referenceClass(2430);
  ...
  public void test10()  throws Throwable  {
      ...
      stringArray0[1] = "}^CVBx";
      stringArray0[2] = "FE ";
      stringArray0[3] = "7U|Z59bI!ow|AUpD";
      stringArray0[4] = "$&B";
      stringArray0[5] = "";
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      ...
      JavaClass javaClass0 = classPathRepository0.loadClass(class0);
      Class2HTML class2HTML0 = new Class2HTML(javaClass0, "bVRWGb%8");
  }
  ...
  public void test12()  throws Throwable  {
      ...
      try {
        class2HTML0 = new Class2HTML((JavaClass) null, "[5(Gx9S/LD~>L");
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      String[] stringArray0 = new String[9];
      stringArray0[0] = "java.util.regex.Pattern";
      stringArray0[1] = "areturn";
      stringArray0[2] = "-zip";
      stringArray0[3] = ">H6r2Njm";
      stringArray0[4] = "L=_aCnKt(?g";
      stringArray0[5] = "2~#O&XF:H@EHy~m[<";
      stringArray0[6] = "QLuAWaY%D U&y";
      stringArray0[7] = "]";
      stringArray0[8] = "CONSTANT_MethodHandle";
      try { 
        Class2HTML.main(stringArray0);
        fail("Expecting exception: FileNotFoundException");
         ...
         //
         // >H6r2Njm (No such file or directory)
         //
  ...
  public void test15()  throws Throwable  {
      ...
      JavaClass javaClass0 = classPathRepository0.loadClass(class0);
      javaClass0.dump("java.lang.Object");
  ...
  public void test19()  throws Throwable  {
      ...
      stringArray0[0] = "2*Cr$35k([t3";
      stringArray0[1] = "-d";
      stringArray0[2] = "2*Cr$35k([t3";
      stringArray0[3] = "long";
      stringArray0[4] = "-d";
      stringArray0[5] = "S(*+snO:>/";
      // Undeclared exception!
      try { 
        Class2HTML.main(stringArray0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "WY\"mzc3&'Hy)HD";
      stringArray0[1] = "-Q},1.G=x";
      // Undeclared exception!
      try { 
        Class2HTML.main(stringArray0);
        fail("Expecting exception: NullPointerException");
