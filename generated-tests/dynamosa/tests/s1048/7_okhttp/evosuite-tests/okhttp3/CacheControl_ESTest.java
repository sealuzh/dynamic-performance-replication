...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      Headers.Builder headers_Builder1 = headers_Builder0.add("Pragma", "no-store, min-fresh=0, only-if-cached, no-transform");
  ...
  public void test09()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      cacheControl_Builder0.minFresh(1059, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
      int int0 = cacheControl0.minFreshSeconds();
      assertFalse(cacheControl0.isPublic());
      assertFalse(cacheControl0.isPrivate());
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-1616438855), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minFresh < 0: -1616438855
         //
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-1080), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      cacheControl_Builder0.maxStale(198, timeUnit0);
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-2147483604), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
      assertEquals("min-fresh=16711680", string0);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxAge(113, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder1);
      String string0 = cacheControl0.toString();
      assertNotNull(string0);
      assertEquals("max-age=406800", string0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      Headers.Builder headers_Builder3 = headers_Builder2.addLenient("cache-control", "public");
      Headers headers0 = headers_Builder3.build();
      headers0.values("to$P=j5wD{/!D");
      CacheControl.parse(headers0);
      Headers headers1 = headers_Builder3.build();
      headers1.values("public");
  ...
  public void test27()  throws Throwable  {
      ...
      assertTrue(cacheControl2.isPublic());
  ...
  public void test35()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("Pragma", "0=taM)zlTJD`x;~.2");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.noTransform());
      assertFalse(cacheControl0.onlyIfCached());
  ...
  public void test36()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.add("Pragma", "no-store, min-fresh=16711680, only-if-cached, no-transform");
      ...
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.noCache());
      assertEquals(16711680, cacheControl0.minFreshSeconds());
      assertTrue(cacheControl0.onlyIfCached());
      assertTrue(cacheControl0.noTransform());
      assertFalse(cacheControl0.isPublic());
  }
  ...
  public void test37()  throws Throwable  {
      ...
      stringArray0[1] = "yplpSV";
      stringArray0[2] = " P8E.U'T0]nO5<fCw]9";
      stringArray0[3] = " P8E.U'T0]nO5<fCw]9";
      stringArray0[4] = " P8E.U'T0]nO5<fCw]9";
      stringArray0[5] = " P8E.U'T0]nO5<fCw]9";
