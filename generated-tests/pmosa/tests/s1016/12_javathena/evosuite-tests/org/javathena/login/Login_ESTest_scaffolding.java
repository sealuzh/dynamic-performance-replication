...
public class Login_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiFunction", false, Login_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javolution.util.FastComparator", false, Login_ESTest_scaffolding.class.getClassLoader()));
