...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string1 = "FP(4z2jFOp)#)P!enFR";
      X509Certificate x509Certificate7 = mock(X509Certificate.class, new ViolatedAssumptionAnswer());
      SSLSession sSLSession0 = mock(SSLSession.class, new ViolatedAssumptionAnswer());
      String string2 = "*";
      X509Certificate x509Certificate8 = mock(X509Certificate.class, new ViolatedAssumptionAnswer());
      String string3 = "";
      X509Certificate x509Certificate9 = mock(X509Certificate.class, new ViolatedAssumptionAnswer());
      X509Certificate x509Certificate10 = mock(X509Certificate.class, new ViolatedAssumptionAnswer());
      doReturn((Collection) null, (Collection) null).when(x509Certificate10).getSubjectAlternativeNames();
      List<String> list1 = OkHostnameVerifier.allSubjectAltNames(x509Certificate10);
  ...
  public void test1()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.INSTANCE.verify("(evSh8Cs;GF", (SSLSession) null);
  ...
  public void test5()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // codegen.java.security.cert.Certificate$MockitoMock$251873309 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
