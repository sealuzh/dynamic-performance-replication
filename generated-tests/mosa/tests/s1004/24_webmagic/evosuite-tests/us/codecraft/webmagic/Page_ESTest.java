...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Page page0 = Page.fail();
      Page page1 = page0.setRawText("kE_#%>{Lh");
      assertEquals(200, page1.getStatusCode());
  ...
  public void test08()  throws Throwable  {
      Page page0 = new Page();
      page0.putField("P&5Qvdm", "P&5Qvdm");
      assertTrue(page0.isDownloadSuccess());
      assertEquals(200, page0.getStatusCode());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      page0.addTargetRequests((List<String>) linkedList0, (-309L));
      assertEquals(200, page0.getStatusCode());
      assertTrue(page0.isDownloadSuccess());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0, 708L);
        fail("Expecting exception: NoClassDefFoundError");
