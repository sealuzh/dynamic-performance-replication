...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxAge((-3282), timeUnit0);
  ...
  public void test07()  throws Throwable  {
      ...
      stringArray0[1] = "no-cache, no-store, max-age=0, min-fresh=0, no-transform";
      stringArray0[2] = "pragma";
      stringArray0[3] = "no-cache, no-store, max-age=0, min-fresh=0, no-transform";
      stringArray0[4] = "no-cache, no-store, max-age=0, min-fresh=0, no-transform";
  ...
  public void test14()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      cacheControl_Builder0.maxStale(4083, timeUnit0);
  ...
  public void test15()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxStale(751, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder1.build();
      int int0 = cacheControl0.maxStaleSeconds();
      assertEquals(45060, int0);
      assertEquals((-1), cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.isPublic());
      assertEquals((-1), cacheControl0.maxAgeSeconds());
      assertFalse(cacheControl0.isPrivate());
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-350), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      cacheControl_Builder0.minFresh(204, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      String string0 = cacheControl0.toString();
  ...
  public void test27()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      cacheControl_Builder0.maxAge(204, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
      String string0 = cacheControl0.toString();
  ...
  public void test28()  throws Throwable  {
      ...
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.removeAll("#pqn7");
      Headers.Builder headers_Builder2 = headers_Builder1.addLenient("pragma", "U)");
  ...
  public void test34()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.add("pragma", "6>!xbqzov~.ls;=\"");
      Headers headers0 = new Headers(headers_Builder1);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.mustRevalidate());
  ...
  public void test35()  throws Throwable  {
      ...
      stringArray0[5] = "&_E{xiOu";
      stringArray0[6] = "cache-control";
      stringArray0[7] = "&_E{xiOu";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals((-1), cacheControl0.maxAgeSeconds());
      assertFalse(cacheControl0.noStore());
  ...
  public void test36()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "pragma";
      stringArray0[1] = "no-cache, no-store, max-stale=0, min-fresh=17625600, only-if-cached, no-transform";
      stringArray0[2] = "pragma";
      stringArray0[3] = "no-cache, no-store, max-stale=0, min-fresh=17625600, only-if-cached, no-transform";
      stringArray0[4] = "no-cache, no-store, max-stale=0, min-fresh=17625600, only-if-cached, no-transform";
      stringArray0[5] = "pblc";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPrivate());
      ...
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.mustRevalidate());
      assertEquals(17625600, cacheControl0.minFreshSeconds());
