...
public class Okio_ESTest extends Okio_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      realBufferedSink0.writeDecimalLong((-1339L));
      realBufferedSink0.emit();
      MockFile mockFile0 = new MockFile("[Obppq0#d3fjZz/V_");
  ...
  public void test07()  throws Throwable  {
      System.setCurrentTimeMillis((-5665L));
      MockFile mockFile0 = new MockFile(";K+n .^VUNaVu");
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile((File) null, ".11.g");
      Sink sink0 = Okio.sink((File) mockFile0);
      assertNotNull(sink0);
  }
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      File file0 = MockFile.createTempFile("4LK'*l9f{jg^H:6", "4LK'*l9f{jg^H:6", (File) mockFile0);
      MockFile mockFile1 = new MockFile(file0, "_I*;]~9xhtUI");
      try { 
  ...
  public void test15()  throws Throwable  {
      ...
      MockFile.createTempFile("Failed to close timed out socket ", (String) null, (File) mockFile0);
      try { 
        Okio.sink((File) mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test21()  throws Throwable  {
      MockThrowable mockThrowable0 = new MockThrowable("lK14Y=S?J_Tv");
  ...
  public void test24()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          MockFile mockFile0 = new MockFile((String) null, "zlEeA%@Ji9@h*4ipI");
          Path path0 = mockFile0.toPath();
          ...
          try { 
            ...
            fail("Expecting exception: SecurityException");
             ...
             //
             // Security manager blocks (\"java.io.FilePermission\" \"zlEeA%@Ji9@h*4ipI\" \"write\")
  ...
  public void test32()  throws Throwable  {
      ...
      try { 
        realBufferedSource0.readByteString(76L);
  ...
  public void test38()  throws Throwable  {
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("g(ZfA\" +O");
      Sink sink0 = Okio.sink((OutputStream) mockFileOutputStream0);
      RealBufferedSink realBufferedSink0 = new RealBufferedSink(sink0);
      Timeout timeout0 = realBufferedSink0.timeout();
      assertEquals(0L, timeout0.timeoutNanos());
