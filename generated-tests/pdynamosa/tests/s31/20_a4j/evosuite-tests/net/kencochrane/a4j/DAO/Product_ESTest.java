...
public class Product_ESTest extends Product_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/HEAVY_SU(2T7$VO##GT_HEAVY_HEAVY.XML");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "B|+@i=!A");
      Product product0 = new Product();
      FullProduct fullProduct0 = product0.getProduct("heavy", "Su(2t7$vO##GT", "heavy");
