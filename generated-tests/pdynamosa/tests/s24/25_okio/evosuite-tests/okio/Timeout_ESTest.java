...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      timeout1.deadline(465L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      timeout0.timeout(1775L, timeUnit0);
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1239L);
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout1.timeout(1239L, timeUnit0);
      assertEquals(107049600000000000L, timeout1.timeoutNanos());
  }
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.timeout(465L, timeUnit0);
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1967L));
  ...
  public void test20()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(153L);
      try { 
        timeout0.throwIfReached();
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test24()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(4035L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified("8iP-,xd\":4(4");
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1967L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      Timeout timeout0 = Timeout.NONE;
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.NONE.timeout(503L, timeUnit0);
  ...
  public void test29()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.NONE.deadline(465L, timeUnit0);
