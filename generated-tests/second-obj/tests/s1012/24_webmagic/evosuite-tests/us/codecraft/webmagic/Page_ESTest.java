...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Page page0 = new Page();
      page0.toString();
      page0.setStatusCode((-638));
      assertEquals((-638), page0.getStatusCode());
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      Page page0 = new Page();
      Page page1 = page0.setRawText("D$|");
  ...
  public void test19()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("(?iZ)e.*?>");
      Page page0 = new Page();
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0, (-4162L));
        fail("Expecting exception: NoClassDefFoundError");
