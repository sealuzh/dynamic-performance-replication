...
public class Okio_ESTest extends Okio_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile(">zx_xB,YC", "Failed to close timed out socket ");
      Path path0 = mockFile0.toPath();
  ...
  public void test04()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, 2487, (-4894));
      PushbackInputStream pushbackInputStream0 = new PushbackInputStream(byteArrayInputStream0);
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(pushbackInputStream0, 2717);
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/EKO#q'v@ehi/okio.Pipe$PipeSink0okio.Pipe$PipeSink");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "");
      MockFile mockFile0 = new MockFile("", "EKO#q'v@ehi");
      File file0 = MockFile.createTempFile("okio.Pipe$PipeSink", "okio.Pipe$PipeSink", (File) mockFile0);
  ...
  public void test10()  throws Throwable  {
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("9U%ewZV|!f^[p6Vz;&/");
  ...
  public void test11()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("okio.Pipe$PipeSource");
  ...
  public void test12()  throws Throwable  {
      File file0 = MockFile.createTempFile(".i<K4Im!!)^", "Unexpected code point: ");
  ...
  public void test16()  throws Throwable  {
      MockFile mockFile0 = new MockFile("path == null", "d1dnmY)27H'`A");
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile(".inputStream()", "gTn{w)L1DWc@");
  ...
  public void test18()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "EKO#q'v@ehi");
      MockFile.createTempFile("okio.Pipe$PipeSink", "okio.Pipe$PipeSink", (File) mockFile0);
      try { 
        Okio.appendingSink(mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test19()  throws Throwable  {
      MockFile mockFile0 = new MockFile("=uY[9");
      Path path0 = mockFile0.toPath();
      OpenOption[] openOptionArray0 = new OpenOption[0];
      try { 
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("vXGc%&;H&tb*! ", "vXGc%&;H&tb*! ");
      Path path0 = mockFile0.toPath();
  ...
  public void test21()  throws Throwable  {
      MockFile mockFile0 = new MockFile("k!0k4s", "k!0k4s");
      try { 
        Okio.source((File) mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test26()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("okio.Okio");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "EfBy~q$yET");
      try { 
        Okio.appendingSink(mockFile0);
        fail("Expecting exception: FileNotFoundException");
  ...
  public void test28()  throws Throwable  {
      ...
      AssertionError assertionError0 = new AssertionError(standardOpenOption0);
  ...
  public void test30()  throws Throwable  {
      AssertionError assertionError0 = new AssertionError('7');
  ...
  public void test33()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          MockFile mockFile0 = new MockFile("+T", ",R+B]0xamto_0opEm");
          Path path0 = mockFile0.toPath();
          OpenOption[] openOptionArray0 = new OpenOption[0];
          // Undeclared exception!
          try { 
            ...
            fail("Expecting exception: SecurityException");
             ...
             //
             // Security manager blocks (\"java.io.FilePermission\" \"/home/apaniche/performance/Dataset/gordon_scripts/projects/25_okio/+T/,R+B]0xamto_0opEm\" \"write\")
  ...
  public void test38()  throws Throwable  {
      MockFile mockFile0 = new MockFile("okio4Okio", "okio4Okio");
      Okio.sink((File) mockFile0);
      Source source0 = Okio.source((File) mockFile0);
      RealBufferedSource realBufferedSource0 = new RealBufferedSource(source0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("okio4Okio/okio4Okio");
  ...
  public void test48()  throws Throwable  {
      MockFile mockFile0 = new MockFile("okio4Okio");
      Sink sink0 = Okio.sink((File) mockFile0);
      RealBufferedSink realBufferedSink0 = new RealBufferedSink(sink0);
      Timeout timeout0 = realBufferedSink0.timeout();
      assertEquals(0L, timeout0.timeoutNanos());
  ...
  public void test49()  throws Throwable  {
      MockFile mockFile0 = new MockFile("rwy 3Fn+");
      Sink sink0 = Okio.appendingSink(mockFile0);
      RealBufferedSink realBufferedSink0 = new RealBufferedSink(sink0);
  ...
  public void test50()  throws Throwable  {
      MockFile mockFile0 = new MockFile("O)cXG`t<\"IN.'RI");
      Sink sink0 = Okio.sink((File) mockFile0);
  ...
  public void test52()  throws Throwable  {
      Sink sink0 = Okio.blackhole();
      RealBufferedSink realBufferedSink0 = new RealBufferedSink(sink0);
      BufferedSink bufferedSink0 = realBufferedSink0.writeShortLe(2270);
