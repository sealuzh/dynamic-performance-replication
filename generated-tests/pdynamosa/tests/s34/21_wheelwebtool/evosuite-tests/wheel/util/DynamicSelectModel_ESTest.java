...
public class DynamicSelectModel_ESTest extends DynamicSelectModel_ESTest_scaffolding {
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getLabel(1370);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("iceRS");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Could not evaluate expression iceRS.values() to create a dynamic ISelectModel.
         //
         verifyException("wheel.components.ElExpression", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getLabel((-1116));
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      DynamicSelectModel dynamicSelectModel2 = dynamicSelectModel1.label("c%csK");
      // Undeclared exception!
      try { 
  ...
  public void test24()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("+,EF`UIQLXU]%E.:Q.");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.validate();
        fail("Expecting exception: RuntimeException");
  ...
  public void test29()  throws Throwable  {
      ElExpression elExpression0 = new ElExpression("eD");
  ...
  public void test32()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getValue((-3143));
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("iceRS");
      dynamicSelectModel0.validate();
      assertSame(dynamicSelectModel0, dynamicSelectModel1);
  }
