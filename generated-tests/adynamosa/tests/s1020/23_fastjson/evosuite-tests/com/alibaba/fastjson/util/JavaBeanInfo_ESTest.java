...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("m", class0, class0, javaBeanInfo0.clazz, (Field) null, (-12473307), 0, (-12473307));
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.SnakeCase;
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build(fieldInfo0.fieldClass, (Type) null, propertyNamingStrategy0, false, false);
  ...
  public void test19()  throws Throwable  {
      ...
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("I-Z)Fv92%B1<J.Y)O").when(jSONType0).typeKey();
      doReturn("I-Z)Fv92%B1<J.Y)O").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
  ...
  public void test23()  throws Throwable  {
      ...
      try {
        javaBeanInfo2 = new JavaBeanInfo(class0, (Class<?>) null, javaBeanInfo1.creatorConstructor, javaBeanInfo1.creatorConstructor, (Method) null, (Method) null, (JSONType) null, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(javaBeanInfo0.clazz, (Class<?>) null, javaBeanInfo0.defaultConstructor, javaBeanInfo0.defaultConstructor, (Method) null, (Method) null, (JSONType) null, linkedList0);
  ...
  public void test25()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("m", class0, class0, javaBeanInfo0.clazz, (Field) null, (-12473307), 0, (-12473307));
      FieldInfo fieldInfo1 = new FieldInfo("m", javaBeanInfo0.clazz, class3, javaBeanInfo0.clazz, (Field) null, 1420, (-12473307), (-12473307));
      JavaBeanInfo.add(linkedList0, fieldInfo1);
      linkedList0.add(fieldInfo0);
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(fieldInfo1.fieldClass, class3, (Constructor<?>) null, javaBeanInfo0.defaultConstructor, (Method) null, (Method) null, (JSONType) null, linkedList0);
  ...
  public void test30()  throws Throwable  {
      ...
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build(class1, (Type) class2, propertyNamingStrategy0);
      assertEquals(0, javaBeanInfo0.defaultConstructorParameterSize);
  }
  ...
  public void test31()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("d3^lr6|").when(jSONType0).typeKey();
      doReturn("d3^lr6|").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<String> class2 = String.class;
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class1, class2, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      Class<Integer> class3 = Integer.class;
      FieldInfo fieldInfo0 = new FieldInfo("dec", class0, class0, javaBeanInfo0.clazz, (Field) null, (-2231), 0, (-2231));
      FieldInfo fieldInfo1 = new FieldInfo("dec", javaBeanInfo0.clazz, class3, fieldInfo0.declaringClass, (Field) null, 1402, (-2231), 1402);
      JavaBeanInfo.add(linkedList0, fieldInfo1);
  ...
  public void test33()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(class2, (Class) null, (Class) null).when(jSONType0).builder();
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("m", (String) null).when(jSONType0).typeKey();
      doReturn("m", (String) null).when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<String> class3 = String.class;
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class1, class3, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      Class<Integer> class4 = Integer.class;
      JavaBeanInfo.getDefaultConstructor(class4, constructorArray0);
      JavaBeanInfo.getCreatorConstructor(constructorArray0);
      Class<AtomicBoolean> class5 = AtomicBoolean.class;
      FieldInfo fieldInfo0 = new FieldInfo("m", class0, class5, javaBeanInfo0.clazz, (Field) null, (-12473307), 0, (-12473307));
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<?> class6 = JavaBeanInfo.getBuilderClass(javaBeanInfo0.jsonType);
      FieldInfo fieldInfo1 = new FieldInfo("m", javaBeanInfo0.clazz, class4, class6, (Field) null, 1420, (-12473307), (-12473307));
      JavaBeanInfo.add(linkedList0, fieldInfo1);
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.SnakeCase;
      JavaBeanInfo.getBuilderClass(javaBeanInfo0.jsonType);
      JavaBeanInfo.getBuilderClass(class0, javaBeanInfo0.jsonType);
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build(fieldInfo0.fieldClass, (Type) javaBeanInfo0.builderClass, propertyNamingStrategy0, false, false);
      LinkedList<FieldInfo> linkedList1 = new LinkedList<FieldInfo>();
      Class<Integer> class7 = Integer.class;
      JavaBeanInfo javaBeanInfo2 = null;
      try {
        javaBeanInfo2 = new JavaBeanInfo(fieldInfo1.fieldClass, class7, (Constructor<?>) null, javaBeanInfo1.defaultConstructor, (Method) null, (Method) null, javaBeanInfo0.jsonType, linkedList0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test34()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class0, class0, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
      JavaBeanInfo javaBeanInfo1 = JavaBeanInfo.build(javaBeanInfo0.builderClass, (Type) javaBeanInfo0.builderClass, propertyNamingStrategy0, false, true);
      assertEquals(0, javaBeanInfo1.defaultConstructorParameterSize);
  }
}
