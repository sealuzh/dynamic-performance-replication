...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime((-387L));
  ...
  public void test07()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1796L, timeUnit0);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-633L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-372L));
      try { 
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(35L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(35L, timeUnit0);
      timeout1.deadline(35L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeUnit0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(4981609280828000L);
      timeout1.throwIfReached();
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(1306L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(1306L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
