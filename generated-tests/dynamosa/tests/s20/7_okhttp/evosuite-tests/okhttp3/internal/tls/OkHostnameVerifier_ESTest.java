...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.verify("!;k&BDFh+\b$N/zOj", (SSLSession) null);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("pJr+<i5<|bHN<Aw]@j ", sSLSession0);
        fail("Expecting exception: ClassCastException");
      
      } catch(ClassCastException e) {
         //
         // codegen.java.security.cert.Certificate$MockitoMock$1852582985 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("r^/YMlx", sSLSession0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("pJr+<i5<|bHN<Aw]@j ", x509Certificate0);
        fail("Expecting exception: NullPointerException");
