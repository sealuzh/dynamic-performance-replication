...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.INSTANCE.verify("CpPdq", (X509Certificate) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("WQ][hG", sSLSession0);
        fail("Expecting exception: ClassCastException");
      
      } catch(ClassCastException e) {
         //
         // codegen.java.security.cert.Certificate$MockitoMock$275816421 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
