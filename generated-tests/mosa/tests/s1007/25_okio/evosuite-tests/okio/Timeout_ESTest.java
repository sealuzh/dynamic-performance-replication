...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1567L), timeUnit0);
  ...
  public void test06()  throws Throwable  {
      ...
      timeout0.timeout(1131L, timeUnit0);
      assertEquals(1131000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-405L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(2568L);
      try { 
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(7218000000000000L);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(7153200000000000L);
      timeout0.throwIfReached();
  ...
  public void test15()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1915L, timeUnit0);
      timeout1.timeout(1915L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(111L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(111L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
