...
public class DynamicSelectModel_ESTest extends DynamicSelectModel_ESTest_scaffolding {
  ...
  public void test09()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("HM*N##G-TMn4EiQ`w");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.translateValue("HM*N##G-TMn4EiQ`w");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Could not evaluate expression HM*N##G-TMn4EiQ`w.values() to create a dynamic ISelectModel.
         //
  ...
  public void test10()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("b]z2gjy^loj=^hxn6G");
      // Undeclared exception!
  ...
  public void test11()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.collection("D9SJj@?##");
      dynamicSelectModel1.label("D9SJj@?##");
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("*2r=;QK[g#");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.validate();
        fail("Expecting exception: RuntimeException");
  ...
  public void test14()  throws Throwable  {
      ...
      DynamicSelectModel dynamicSelectModel2 = dynamicSelectModel1.value("bnS5`~");
      // Undeclared exception!
      try { 
        dynamicSelectModel2.getValue(37);
        fail("Expecting exception: RuntimeException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getLabel(1683);
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.translator("PhY.");
      assertSame(dynamicSelectModel1, dynamicSelectModel0);
  }
