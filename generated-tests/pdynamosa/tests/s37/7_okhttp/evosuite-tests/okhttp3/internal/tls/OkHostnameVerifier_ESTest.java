...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.INSTANCE.verify("8jY", (X509Certificate) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("?a#", sSLSession0);
        fail("Expecting exception: ClassCastException");
      
      } catch(ClassCastException e) {
         //
         // codegen.java.security.cert.Certificate$MockitoMock$1568009245 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
