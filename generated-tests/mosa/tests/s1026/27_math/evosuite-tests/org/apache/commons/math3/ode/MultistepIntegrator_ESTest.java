...
public class MultistepIntegrator_ESTest extends MultistepIntegrator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        adamsMoultonIntegrator0 = new AdamsMoultonIntegrator((-2955), (-2955), (-2955), (-2955), (-2955));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // multistep method needs at least -2,955 previous steps, got 2
         //
  ...
  public void test2()  throws Throwable  {
      AdamsMoultonIntegrator adamsMoultonIntegrator0 = new AdamsMoultonIntegrator(2, 2, 2, 2.0, 0.0);
