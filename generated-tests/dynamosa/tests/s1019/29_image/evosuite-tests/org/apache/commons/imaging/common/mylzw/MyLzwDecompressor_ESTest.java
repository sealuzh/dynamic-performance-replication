...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 2991);
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress((InputStream) null, 7);
  ...
  public void test04()  throws Throwable  {
      ByteOrder byteOrder0 = ByteOrder.nativeOrder();
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-376), byteOrder0);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress((InputStream) null, (-376));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -376
         //
  ...
  public void test05()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-3682), 1986);
  ...
  public void test06()  throws Throwable  {
      ...
      try {
        myLzwDecompressor0 = new MyLzwDecompressor(12, (ByteOrder) null, myLzwDecompressor_Listener0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream0, 196);
  ...
  public void test12()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 352);
        fail("Expecting exception: IOException");
  ...
  public void test13()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Bad Code: 14 codes: 10 code_size: 4, table: 4096
         //
         verifyException("org.apache.commons.imaging.common.mylzw.MyLzwDecompressor", e);
      }
  }
