...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(fieldInfo0.fieldClass).when(jSONType0).builder();
  ...
  public void test11()  throws Throwable  {
      ...
      JavaBeanInfo.build((Class<?>) class2, (Type) javaBeanInfo0.clazz, propertyNamingStrategy0, false, true);
      // Undeclared exception!
  ...
  public void test23()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("multi-JSONCreator", class2, class3, class0, (Field) null, (-2259), (-2259), (-2259));
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("", class0, class0, class1, (Field) null, (-3764), (-1961), 1514);
      JavaBeanInfo.add(linkedList0, fieldInfo1);
      Class<AtomicBoolean> class4 = AtomicBoolean.class;
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class0, class4, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, (JSONType) null, linkedList0);
  ...
  public void test30()  throws Throwable  {
      Class<String> class0 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("sek", class0, class0, class0, (Field) null, 2, 2, 2);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
      Class<FieldInfo> class1 = FieldInfo.class;
      FieldInfo fieldInfo1 = new FieldInfo("sek", fieldInfo0.declaringClass, class1, fieldInfo0.fieldClass, (Field) null, 2, 2, 2);
  ...
  public void test31()  throws Throwable  {
      Class<String> class0 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("sek", class0, class0, class0, (Field) null, 163, 163, 163);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
      Class<Integer> class1 = Integer.class;
      FieldInfo fieldInfo1 = new FieldInfo("sek", class1, class1, fieldInfo0.fieldClass, (Field) null, 163, 163, 163);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
  ...
  public void test32()  throws Throwable  {
      Class<String> class0 = String.class;
      FieldInfo fieldInfo0 = new FieldInfo("authorities", class0, class0, class0, (Field) null, 3551, 3551, 3551);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
  ...
  public void test33()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("javax.servlet.http.Cookie", class0, class0, class0, (Field) null, (-1046), (-1791353048), (-1046));
  ...
  public void test34()  throws Throwable  {
      ...
      doReturn(":N*^1z*thA").when(jSONType0).typeName();
  ...
  public void test36()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("Uty/$` R7").when(jSONType0).typeKey();
      doReturn("Uty/$` R7").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
