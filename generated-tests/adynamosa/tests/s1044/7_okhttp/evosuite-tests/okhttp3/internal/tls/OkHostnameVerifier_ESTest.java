...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test5()  throws Throwable  {
      ...
      LinkedList<List<Object>> linkedList4 = new LinkedList<List<Object>>();
      ...
      OkHostnameVerifier.allSubjectAltNames(x509Certificate5);
      ...
      OkHostnameVerifier.allSubjectAltNames(x509Certificate6);
      SSLSession sSLSession1 = mock(SSLSession.class, new ViolatedAssumptionAnswer());
      doReturn((Certificate[]) null).when(sSLSession1).getPeerCertificates();
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("{x", sSLSession1);
        fail("Expecting exception: NullPointerException");
