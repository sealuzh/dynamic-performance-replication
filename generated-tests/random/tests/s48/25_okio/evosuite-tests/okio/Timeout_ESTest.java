...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1118L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(1118000000000L, long0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout1.timeout(1118L, timeUnit0);
      assertEquals(1118000000000L, timeout1.timeoutNanos());
  }
  ...
  public void test04()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.timeout(1118L, timeUnit0);
      timeout0.deadlineNanoTime(1118L);
      assertEquals(1118000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        timeout0.deadline((-1401L), timeUnit0);
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals(1478809281320000L, long0);
  }
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(83L, timeUnit0);
      Timeout timeout2 = timeout1.deadline(83L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-5260L));
      try { 
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(910L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(83L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-4428L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.NONE.timeout(966L, timeUnit0);
  ...
  public void test25()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(1313L);
      assertFalse(timeout1.equals((Object)timeout0));
  }
