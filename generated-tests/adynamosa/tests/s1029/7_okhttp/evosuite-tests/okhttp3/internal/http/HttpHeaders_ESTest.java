...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", (-1509));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("Wary: Wary\n", 10);
      assertEquals(10, int0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("(k}3==J>Gr", 3, "1#l_yD");
      assertEquals(10, int0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn(1577).when(response0).code();
  ...
  public void test05()  throws Throwable  {
      ...
      hashMap0.put("vary", "uDmh*PT:z b{=>=b");
  ...
  public void test15()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 476);
      assertEquals(476, int0);
  }

  @Test(timeout = 4000)
  public void test16()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("#rR6,,4lT;D.W9u=TU", 165, (String) null);
  ...
  public void test18()  throws Throwable  {
      ...
      URL uRL1 = MockURL.URL(uRL0, "{)Bzdt?c3!|Kb", (URLStreamHandler) null);
  ...
  public void test20()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("Dz 1s{*I%TkD^c", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test21()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-1026));
      assertEquals((-1026), int0);
  }

  @Test(timeout = 4000)
  public void test22()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 1018);
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("Transfer-Encoding", (-1285));
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("", (-1723737510), "!W");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test34()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 3677, "");
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "yW!mb1>7wW1ZT");
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      ...
      stringArray0[0] = "=ghpz4fhq0li";
      stringArray0[1] = "(k}3y==J>Gr";
      Headers headers0 = Headers.of(stringArray0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertFalse(set0.contains("(k}3y==J>Gr"));
  }
  ...
  public void test40()  throws Throwable  {
      ...
      stringArray0[0] = "Vary";
      stringArray0[1] = "okhtt3.internal.http.HttpHeadeEs";
      stringArray0[2] = "Vary";
      stringArray0[3] = "Vary";
      Headers headers0 = Headers.of(stringArray0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
  ...
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", 443);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("5", 43);
      assertEquals(5, int0);
  }
  ...
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("HP0\"EI$TI", 9);
      assertEquals(9, int0);
  }
  ...
  public void test47()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("okhtt3.internal.http.HttpHeaders").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
  ...
  public void test48()  throws Throwable  {
      ...
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(12).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test51()  throws Throwable  {
      ...
      assertEquals("/", httpUrl0.encodedPath());
  }

  @Test(timeout = 4000)
  public void test52()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Vary", "v. realm=_q.fzf?");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test53()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("<. K@ul=_q.fzf?bk", "<. K@ul=_q.fzf?bk realm=\"<. K@ul=_q.fzf?bk\"");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "<. K@ul=_q.fzf?bk");
  ...
  public void test54()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.putIfAbsent("<. K@ul=_q.fzf?bk", "<. K@ul=_q.fzf?bk");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "<. K@ul=_q.fzf?bk");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test55()  throws Throwable  {
      ...
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "Wary");
      assertEquals(0, list0.size());
  }
  ...
  public void test59()  throws Throwable  {
      ...
      Headers headers3 = HttpHeaders.varyHeaders(headers2, headers2);
      hashMap0.put((String) null, "tvary");
      URI uRI0 = MockURI.aFTPURI;
      hashMap0.put("Vary", " +([^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)");
      headers2.getDate("M6b(F&W");
      headers2.toMultimap();
      HttpHeaders.varyHeaders(headers1, headers2);
      HttpHeaders.parseSeconds("k)&3XbIMZ", 204);
      HttpHeaders.skipUntil("domni]c", 1, "ueHb^xcxqj`-8=~~T");
      HttpHeaders.skipUntil("M6b(F&W", 204, "M6b(F&W");
      HttpHeaders.hasVaryAll(headers3);
      Response response1 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn((Request) null).when(response1).request();
      // Undeclared exception!
      try { 
        HttpHeaders.hasBody(response1);
        fail("Expecting exception: NullPointerException");
