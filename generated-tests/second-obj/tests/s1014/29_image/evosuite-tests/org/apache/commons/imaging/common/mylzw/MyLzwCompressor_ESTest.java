...
public class MyLzwCompressor_ESTest extends MyLzwCompressor_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      MyLzwCompressor.Listener myLzwCompressor_Listener0 = mock(MyLzwCompressor.Listener.class, new ViolatedAssumptionAnswer());
      MyLzwCompressor myLzwCompressor0 = new MyLzwCompressor(255, byteOrder1, true, myLzwCompressor_Listener0);
  ...
  public void test5()  throws Throwable  {
      ...
      MyLzwCompressor myLzwCompressor1 = new MyLzwCompressor(8, byteOrder2, false);
      byte[] byteArray1 = new byte[1];
      byteArray1[0] = (byte)0;
      byte[] byteArray2 = myLzwCompressor1.compress(byteArray1);
      MyLzwCompressor myLzwCompressor2 = new MyLzwCompressor((-287), byteOrder1, false);
      try { 
        myLzwCompressor2.compress(byteArray2);
        fail("Expecting exception: IOException");
