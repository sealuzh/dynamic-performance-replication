...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("(!0KEH,{t-CGOFD0", sSLSession0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify(") and stream length (", (X509Certificate) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // codegen.java.security.cert.Certificate$MockitoMock$679981256 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      doReturn(x500Principal0).when(x509Certificate0).getSubjectX500Principal();
      OkHostnameVerifier okHostnameVerifier0 = OkHostnameVerifier.INSTANCE;
      boolean boolean0 = okHostnameVerifier0.verify("]4<~ZL", x509Certificate0);
      assertFalse(boolean0);
  }
