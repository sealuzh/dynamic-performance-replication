...
public class MnAlgebraicSymMatrix_ESTest extends MnAlgebraicSymMatrix_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MnAlgebraicSymMatrix mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix(1019);
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set((-2072), 1019, 1490);
  ...
  public void test02()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get((-4719), 1);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test07()  throws Throwable  {
      MnAlgebraicSymMatrix mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix(672);
      int int0 = mnAlgebraicSymMatrix0.nrow();
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get(554, (-105));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set(0, (-774), (-887.418423));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get((-1447), 14);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.set(0, 3, 3);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        mnAlgebraicSymMatrix0.get((-4719), 591);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test22()  throws Throwable  {
      ...
      try {
        mnAlgebraicSymMatrix0 = new MnAlgebraicSymMatrix((-215));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid matrix size: -215
         //
         verifyException("org.freehep.math.minuit.MnAlgebraicSymMatrix", e);
      }
  }
