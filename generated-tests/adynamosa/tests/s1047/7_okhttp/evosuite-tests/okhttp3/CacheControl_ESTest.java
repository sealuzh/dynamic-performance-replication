...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        cacheControl_Builder0.maxStale((-1945), timeUnit0);
  ...
  public void test08()  throws Throwable  {
      ...
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.minFresh(365, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder1.build();
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-1722569441), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // minFresh < 0: -1722569441
         //
         verifyException("okhttp3.CacheControl$Builder", e);
      }
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-6345), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.addLenient("4E`k@");
      headers_Builder0.set("pragma", "[text=");
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[3] = "ZfG&BKQp~t";
      stringArray0[4] = "pragma";
      stringArray0[5] = "R(4:lk\"g'R$5!]";
      stringArray0[6] = "R(4:lk\"g'R$5!]";
      stringArray0[7] = "@x(l&sl";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.onlyIfCached());
      assertFalse(cacheControl0.noCache());
  ...
  public void test28()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("pragma", "no-cache, no-store, max-age=0, only-if-cached");
  ...
  public void test29()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      headers_Builder0.set("cache-control", "=\"7=&Sp]Qk+D0ZP/");
      Headers headers0 = headers_Builder0.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPublic());
      assertFalse(cacheControl0.noStore());
  ...
  public void test30()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.set("pragma", "no-store, min-fresh=0, only-if-cached, no-transform");
      Headers headers0 = headers_Builder1.build();
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPublic());
      assertTrue(cacheControl0.onlyIfCached());
