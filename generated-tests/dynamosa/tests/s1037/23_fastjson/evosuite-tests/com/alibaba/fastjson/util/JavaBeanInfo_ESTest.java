...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn("rp`u.L").when(jSONType0).typeKey();
      doReturn("yyyy-MM-dd HH:mm:ss").when(jSONType0).typeName();
  ...
  public void test12()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("getlastIndexOf").when(jSONType0).typeKey();
      doReturn("getlastIndexOf").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class0, class0, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      ...
      JavaBeanInfo.build(javaBeanInfo0.builderClass, (Type) javaBeanInfo1.clazz, propertyNamingStrategy0);
      ...
      // Undeclared exception!
      JavaBeanInfo.build((Class<?>) class0, (Type) javaBeanInfo0.builderClass, propertyNamingStrategy0, false, false);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("<(G'm/I\"SjH", class0, class1, class1, (Field) null, 4096, 16, 1301);
      linkedList0.add(fieldInfo0);
      String[] stringArray0 = new String[7];
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("on").when(jSONType0).typeKey();
      doReturn("on").when(jSONType0).typeName();
  ...
  public void test31()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("jaYax.:Trvle)phttn.C0okie", class1, class2, class2, (Field) null, (-98), (-98), (-98));
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("jaYax.:Trvle)phttn.C0okie", class0, class0, class0, (Field) null, (-98), (-98), (-98));
  ...
  public void test32()  throws Throwable  {
      ...
      FieldInfo fieldInfo1 = new FieldInfo("", fieldInfo0.declaringClass, class1, fieldInfo0.declaringClass, (Field) null, (-32), (-32), (-32));
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
  ...
  public void test33()  throws Throwable  {
      Class<FieldInfo> class0 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("B", class0, class0, class0, (Field) null, (-50), (-50), (-50));
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.add(fieldInfo0);
  ...
  public void test34()  throws Throwable  {
      ...
      linkedList0.add(fieldInfo0);
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(fieldInfo0.declaringClass, fieldInfo0.fieldClass, javaBeanInfo0.creatorConstructor, javaBeanInfo0.creatorConstructor, (Method) null, (Method) null, (JSONType) null, linkedList0);
  ...
  public void test37()  throws Throwable  {
      ...
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("rp`u.L").when(jSONType0).typeKey();
      doReturn("rp`u.L").when(jSONType0).typeName();
      Class<AtomicLong> class0 = AtomicLong.class;
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
