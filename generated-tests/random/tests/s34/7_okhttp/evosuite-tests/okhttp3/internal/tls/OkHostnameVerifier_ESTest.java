...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string4 = "Nol";
      String string5 = "*.";
      SSLSession sSLSession3 = mock(SSLSession.class, new ViolatedAssumptionAnswer());
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.INSTANCE.verify(string0, x509Certificate1);
        fail("Expecting exception: NullPointerException");
