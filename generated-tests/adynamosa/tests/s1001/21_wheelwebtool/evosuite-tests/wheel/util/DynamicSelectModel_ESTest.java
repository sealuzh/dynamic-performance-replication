...
public class DynamicSelectModel_ESTest extends DynamicSelectModel_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.value("v&r");
  ...
  public void test03()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.translator("Could not create DynamicSelection model. Label attribute 7as null or not an el-expression.");
      assertSame(dynamicSelectModel0, dynamicSelectModel1);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        dynamicSelectModel0.translateValue("after xmlns in attribute name must be colonwhen namespaces are enabled");
  ...
  public void test07()  throws Throwable  {
      ...
      ActionExpression actionExpression0 = new ActionExpression("GNxTaxVhY");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getValue((-2122));
        fail("Expecting exception: NullPointerException");
  ...
  public void test13()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("$9XD");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Could not evaluate expression $9XD.values() to create a dynamic ISelectModel.
         //
  ...
  public void test16()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("Pc[~Q]I:]Se>");
      // Undeclared exception!
      try { 
  ...
  public void test18()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("Ev");
      dynamicSelectModel0.label("Ev");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Could not evaluate expression Ev to create a dynamic ISelectModel.
         //
         verifyException("wheel.components.ElExpression", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.enumeration("+XC TIs1cr;2ZboMy9H");
  ...
  public void test22()  throws Throwable  {
      ...
      DynamicSelectModel dynamicSelectModel1 = dynamicSelectModel0.label("+XC TIs1cr;2ZboMy9H");
      // Undeclared exception!
      try { 
        dynamicSelectModel1.validate();
        fail("Expecting exception: RuntimeException");
  ...
  public void test24()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.enumeration("#H-rHNxM31sCtl.");
      dynamicSelectModel0.collection((String) null);
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getValue(1033);
        fail("Expecting exception: RuntimeException");
  ...
  public void test25()  throws Throwable  {
      DynamicSelectModel dynamicSelectModel0 = new DynamicSelectModel();
      dynamicSelectModel0.collection("char");
      // Undeclared exception!
      try { 
        dynamicSelectModel0.getObjects();
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expression char evaluated to an object that is not an instance of Collection or Object[]. Can't build a dynamic ISelectModel
         //
         verifyException("wheel.util.DynamicSelectModel", e);
      }
  }
  ...
  public void test29()  throws Throwable  {
      ElExpression elExpression0 = new ElExpression("Hb");
