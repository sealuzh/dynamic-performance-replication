...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 802);
  ...
  public void test03()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor(8, byteOrder0, myLzwDecompressor_Listener0);
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 1884);
        fail("Expecting exception: IOException");
  ...
  public void test06()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[5];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-115), 4096);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 236);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(sequenceInputStream0, (-2766));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -2766
         //
         verifyException("java.io.ByteArrayOutputStream", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      try {
        myLzwDecompressor0 = new MyLzwDecompressor(4089, byteOrder0, myLzwDecompressor_Listener0);
  ...
  public void test09()  throws Throwable  {
      ...
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream1, (byte)1);
