...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("JHCH: v\n", 7);
      assertEquals(7, int0);
  }
  ...
  public void test02()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("*", 0, "Jn[");
      assertEquals(1, int0);
  }
  ...
  public void test05()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("KJ@@&C@9").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test08()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("$E", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds(" CJOyUwl", (-2795));
  ...
  public void test10()  throws Throwable  {
      ...
      stringArray0[2] = "(d{2,4})[^d]*";
      stringArray0[3] = "(d{2,4})[^d]*";
      stringArray0[4] = "Content-Length";
      stringArray0[5] = "(d{2,4})[^d]*";
      stringArray0[6] = "(d{2,4})[^d]*";
      stringArray0[7] = "(d{2,4})[^d]*";
  ...
  public void test11()  throws Throwable  {
      ...
      stringArray0[0] = "KJ@@&C@9";
      stringArray0[1] = "&i~-5c55tjL5";
      stringArray0[2] = "$E";
      stringArray0[3] = "KJ@@&C@9";
      stringArray0[4] = "\"P|sJYp";
      stringArray0[5] = "([^ \"=]*)";
      Headers headers0 = Headers.of(stringArray0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn((Headers) null).when(response0).headers();
  ...
  public void test14()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 45);
  ...
  public void test15()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("TupkXibVt", 0, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 2985);
  ...
  public void test21()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "byteCount < 0: ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 10, "P");
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", (-2090));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("9", 2849);
      assertEquals(9, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" CJOyUwl", 0);
      assertEquals(1, int0);
  }
  ...
  public void test41()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("sha-256", (-1402));
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("I(e]^%iYRe.R", 8, "[size=0]");
      assertEquals(9, int0);
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("&3yjT#a~", 0, "&3yjT#a~");
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test44()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("P", 159, "P");
  ...
  public void test45()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("KE\", dd MMM yy HH:mm:ss z").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test46()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Q2{kO:eS").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test49()  throws Throwable  {
      ...
      stringArray0[0] = "Content-Length";
      stringArray0[1] = "Content-Length";
      stringArray0[2] = "KE\", dd MMM yy HH:mm:ss z";
      stringArray0[3] = "KE\", dd MMM yy HH:mm:ss z";
      stringArray0[4] = "Content-Length";
      stringArray0[5] = "KE\", dd MMM yy HH:mm:ss z";
      stringArray0[6] = "KE\", dd MMM yy HH:mm:ss z";
      stringArray0[7] = "KE\", dd MMM yy HH:mm:ss z";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "KE\", dd MMM yy HH:mm:ss z");
  ...
  public void test54()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = " +([^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)";
      stringArray0[1] = "A+)_ctWz~K8(|{W+rp>";
      stringArray0[2] = "[SL";
      stringArray0[3] = "~9\"";
      Headers headers0 = Headers.of(stringArray0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
