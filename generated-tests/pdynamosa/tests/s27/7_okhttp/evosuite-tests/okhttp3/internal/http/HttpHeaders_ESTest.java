...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("4", 5485);
      assertEquals(4, int0);
  }
  ...
  public void test02()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("$+l7kzkc\"77}-26", 65533, "`z]");
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn("$+l7kzkc\"77}-26").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(65533).when(response0).code();
  ...
  public void test04()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("iu5i").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(223).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test05()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("$+l7~kzk$c\"n77}h6").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test09()  throws Throwable  {
      ...
      stringArray0[0] = "$+l7~kzk$c\"n77}h6";
      stringArray0[1] = "$+l7~kzk$c\"n77}h6";
      stringArray0[2] = "$+l7~kzk$c\"n77}h6";
      stringArray0[3] = "$+l7~kzk$c\"n77}h6";
      stringArray0[4] = "o/q}";
      stringArray0[5] = "$+l7~kzk$c\"n77}h6";
      stringArray0[6] = "$+l7~kzk$c\"n77}h6";
      stringArray0[7] = "$+l7~kzk$c\"n77}h6";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
  ...
  public void test10()  throws Throwable  {
      String[] stringArray0 = new String[4];
      stringArray0[0] = "^+~,90fcu-ke";
      stringArray0[1] = "^+~,90fcu-ke";
      stringArray0[2] = "Zkof";
      stringArray0[3] = "\f)/^dZD5[RnAX'";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
  ...
  public void test17()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("'-%", (-745));
      assertEquals((-745), int0);
  }

  @Test(timeout = 4000)
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, 255);
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("t)-Hz.\b*$bH[\b", (-4846));
  ...
  public void test28()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, 3166);
        fail("Expecting exception: NullPointerException");
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("0", (-56321), "0");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, 1188, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, ":c%");
        fail("Expecting exception: NullPointerException");
  ...
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("^+~,90FCU-ke", 30);
      assertEquals(30, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("$+l7~kzk$c\"n77}h6", 3, "$+l7~kzk$c\"n77}h6");
      assertEquals(3, int0);
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("\r", 0, "^+~,90FCU-ke");
      assertEquals(1, int0);
  }
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("$+l7kzkc\"77}-26").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>(0, 3375.599F);
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test44()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("IU#I").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(89).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test47()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("kZz*U!lXw}v\u0006h", "kZz*U!lXw}v\u0006h");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "kZz*U!lXw}v\u0006h");
      assertEquals(0, list0.size());
  }
  ...
  public void test50()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "<'dK+/fG_ G'~H,kt");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Headers headers1 = HttpHeaders.varyHeaders(headers0, headers0);
      assertEquals(0, headers1.size());
  }
