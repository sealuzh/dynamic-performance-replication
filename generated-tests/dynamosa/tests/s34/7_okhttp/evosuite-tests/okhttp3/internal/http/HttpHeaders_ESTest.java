...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil(",0tndWNol<v]x^4aTu", 0, "Ui");
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn("okhttp3.Handshake").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(1601).when(response0).code();
  ...
  public void test02()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("okhttp3.HLnd;hake").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(234).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test14()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put(">0", "okhttp3.RequestBody$3");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals("/+([%5E%20%22=]*)=(:", httpUrl1.encodedPath());
  }
  ...
  public void test18()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds(",0tndWNol<v]x^4aTu", 1);
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-2431));
  ...
  public void test28()  throws Throwable  {
      ...
      stringArray0[0] = "Vary";
      stringArray0[1] = "d2ue;f#j3jj@_}p";
      stringArray0[2] = "d2ue;f#j3jj@_}p";
      stringArray0[3] = "d2ue;f#j3jj@_}p";
      stringArray0[4] = "Vary";
      stringArray0[5] = "Vary";
      stringArray0[6] = "Vary";
      stringArray0[7] = "d2ue;f#j3jj@_}p";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x7f at 2 in Vary value: d2ue;f#j3jj@_}p
         //
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("HEAD", (-172));
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-221));
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "z2QN9D");
        fail("Expecting exception: NullPointerException");
  ...
  public void test36()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", (-45));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("8", (-622));
      assertEquals(8, int0);
  }

  @Test(timeout = 4000)
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("(4.1.qX~Dw(20L\"M", 0);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("Number too large: ", 17);
      assertEquals(18, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("twrh#)", 3, "=PMClUI&xw}%pt)8");
      assertEquals(5, int0);
  }
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("cqnA^v[").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(174).when(response0).code();
      doReturn("cqnA^v[").when(response0).header(anyString());
      doReturn(headers0).when(response0).headers();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertFalse(boolean0);
  ...
  public void test43()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("Dat|XeO:").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test44()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("M;;DXGYQ").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test48()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("H<cTk", "9^ realm=");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "H<cTk");
      assertTrue(list0.isEmpty());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      stringArray0[0] = "VUiQ";
      stringArray0[1] = "tWRH#8L)";
      Headers headers0 = Headers.of(stringArray0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "VUiQ");
      assertEquals(0, list0.size());
  }
  ...
  public void test57()  throws Throwable  {
      String[] stringArray0 = new String[8];
      stringArray0[0] = "LY'<Zr#3ICZ@f/E4i6g";
      stringArray0[1] = "LY'<Zr#3ICZ@f/E4i6g";
      stringArray0[2] = "LY'<Zr#3ICZ@f/E4i6g";
      stringArray0[3] = "LY'<Zr#3ICZ@f/E4i6g";
      stringArray0[4] = "Content-Length";
      stringArray0[5] = "LY'<Zr#3ICZ@f/E4i6g";
      stringArray0[6] = "LY'<Zr#3ICZ@f/E4i6g";
