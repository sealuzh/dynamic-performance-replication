...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn("qr~?W").when(jSONType0).typeKey();
      doReturn("qr~?W").when(jSONType0).typeName();
  ...
  public void test27()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("get", class1, class0, class0, (Field) null, (-1003), (-1003), (-1003));
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      ...
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(javaBeanInfo0.clazz, class3, javaBeanInfo0.defaultConstructor, (Constructor<?>) null, (Method) null, (Method) null, (JSONType) null, linkedList0);
  ...
  public void test28()  throws Throwable  {
      ...
      Class<FieldInfo> class1 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("Lk'2S lEQ", class0, class1, class1, (Field) null, 24, 24, 24);
      linkedList0.offerLast(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("Lk'2S lEQ", class0, fieldInfo0.declaringClass, class0, (Field) null, 24, 24, 24);
      linkedList0.add(fieldInfo1);
      Class<Integer> class2 = Integer.class;
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class2, class0, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, (JSONType) null, linkedList0);
      assertEquals(0, javaBeanInfo0.parserFeatures);
  }
  ...
  public void test31()  throws Throwable  {
      Class<FieldInfo> class0 = FieldInfo.class;
      Class<AtomicLong> class1 = AtomicLong.class;
      FieldInfo fieldInfo0 = new FieldInfo("r^7,y$sI/lavjv", class0, class1, class1, (Field) null, (-69812449), (-1720), 936);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      linkedList0.offerLast(fieldInfo0);
      Class<Integer> class2 = Integer.class;
      FieldInfo fieldInfo1 = new FieldInfo("r^7,y$sI/lavjv", fieldInfo0.declaringClass, class2, fieldInfo0.fieldType, (Field) null, 55, (-1818), 2088);
  ...
  public void test32()  throws Throwable  {
      ...
      Class<String> class0 = String.class;
      Class<FieldInfo> class1 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("*qnQNGy~'UZyq6SO-XHj", class0, class1, class1, (Field) null, 574, 574, 574);
      linkedList0.offerLast(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("*qnQNGy~'UZyq6SO-XHj", class0, fieldInfo0.declaringClass, class0, (Field) null, 574, 574, 574);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
  ...
  public void test33()  throws Throwable  {
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<AtomicBoolean> class0 = AtomicBoolean.class;
      FieldInfo fieldInfo0 = new FieldInfo("", class0, class0, class0, (Field) null, 7, 7, 7);
  ...
  public void test35()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("method").when(jSONType0).typeKey();
      doReturn("method").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Integer> class0 = Integer.class;
      Class<Annotation> class1 = Annotation.class;
      FieldInfo fieldInfo0 = new FieldInfo("method", class0, class1, class0, (Field) null, 5, 5, 5);
      linkedList0.add(fieldInfo0);
  ...
  public void test36()  throws Throwable  {
      Class<FieldInfo> class0 = FieldInfo.class;
      String[] stringArray0 = new String[5];
      stringArray0[0] = "fastjson.compatibleWithFieldName";
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("fastjson.compatibleWithFieldName").when(jSONType0).typeKey();
      doReturn("fastjson.compatibleWithFieldName").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Object> class1 = Object.class;
      FieldInfo fieldInfo0 = new FieldInfo("fastjson.compatibleWithFieldName", class0, class1, class1, (Field) null, 2, 2, 2);
      linkedList0.add(fieldInfo0);
  ...
  public void test38()  throws Throwable  {
      ...
      doReturn("Ohp`SHU").when(jSONType0).typeKey();
