...
public class DistinguishedNameParser_ESTest extends DistinguishedNameParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("l=lta*c?)c(by");
  ...
  public void test1()  throws Throwable  {
      X500Principal x500Principal0 = new X500Principal("l=ta*c?)c(by");
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("l");
      assertEquals("ta*c?)c(by", string0);
  ...
  public void test3()  throws Throwable  {
      ...
      X500Principal x500Principal0 = new X500Principal("l=ta*c )c=by", map0);
      DistinguishedNameParser distinguishedNameParser0 = new DistinguishedNameParser(x500Principal0);
      String string0 = distinguishedNameParser0.findMostSpecific("0_5-w5cpR},U8G-N6oo");
      assertNull(string0);
  }
}
