...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      timeout0.deadline(3224L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified("#z*4~#YR;(Mu\"^be*2");
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(3028L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(3028000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(601200000000000L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(3224L, timeUnit0);
      timeout1.deadlineNanoTime((-3030L));
      assertEquals(278553600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      Timeout timeout1 = timeout0.timeout(3028L, timeUnit0);
      timeout1.deadline(3028L, timeUnit0);
      assertEquals(3028000L, timeout0.timeoutNanos());
  }
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(1893L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(163555200000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-3030L));
      long long0 = timeout0.deadlineNanoTime();
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(3224L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(279946009281320000L, long0);
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.timeout(1000001L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-4331L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(612L, timeUnit0);
      assertSame(timeout0, timeout1);
  }
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(1871L);
