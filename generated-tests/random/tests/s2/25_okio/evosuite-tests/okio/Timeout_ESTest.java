...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.timeout(927L, timeUnit0);
      TimeUnit timeUnit1 = TimeUnit.DAYS;
      timeout0.deadline(1979L, timeUnit1);
  ...
  public void test01()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime(1335L);
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(201000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout0.deadline(1979L, timeUnit0);
      Object object0 = new Object();
      // Undeclared exception!
      try { 
        timeout0.waitUntilNotified(object0);
  ...
  public void test10()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.deadline(1979L, timeUnit0);
      timeout1.throwIfReached();
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.NONE.deadline(1L, (TimeUnit) null);
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(1392411260320000L, long0);
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2537L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.NONE.timeout(1979L, timeUnit0);
      timeout1.throwIfReached();
