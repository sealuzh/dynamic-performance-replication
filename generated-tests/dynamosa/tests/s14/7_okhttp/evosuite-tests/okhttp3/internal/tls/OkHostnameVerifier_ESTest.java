...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("$d,U~EdIvV(B^>", (X509Certificate) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("ol]%U?:tf9", sSLSession0);
        fail("Expecting exception: ClassCastException");
      
      } catch(ClassCastException e) {
         //
         // codegen.java.security.cert.Certificate$MockitoMock$1421546733 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("V-LK;5P[", x509Certificate0);
        fail("Expecting exception: NullPointerException");
