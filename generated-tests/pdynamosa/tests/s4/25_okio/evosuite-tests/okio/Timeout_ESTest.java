...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.deadline(417L, timeUnit0);
  ...
  public void test03()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(262L, timeUnit0);
      long long0 = timeout1.timeoutNanos();
      assertEquals(15720000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.deadline(453L, timeUnit0);
  ...
  public void test06()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      timeout0.timeout(117L, timeUnit0);
      timeout0.deadlineNanoTime(117L);
      assertEquals(7020000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-341L));
      long long0 = timeout1.deadlineNanoTime();
  ...
  public void test09()  throws Throwable  {
      ...
      timeout0.timeout(1451L, timeUnit0);
      timeout0.deadline(1451L, timeUnit0);
      assertEquals(5223600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      Timeout timeout1 = timeout0.timeout(758L, timeUnit0);
      timeout1.clearDeadline();
      assertEquals(45480000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1047L), timeUnit0);
  ...
  public void test15()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      timeout0.deadline(2509L, timeUnit0);
      assertTrue(timeout0.hasDeadline());
      
      long long0 = timeout0.deadlineNanoTime();
      assertEquals(10424809281320000L, long0);
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1451L);
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(480L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.deadline(417L, timeUnit0);
      timeout1.throwIfReached();
      assertTrue(timeout0.hasDeadline());
  }
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-456L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
