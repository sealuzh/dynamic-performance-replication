...
public class Page_ESTest extends Page_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Page page0 = Page.fail();
      Page page1 = page0.setRawText("-IU8r-6");
  ...
  public void test11()  throws Throwable  {
      Page page0 = new Page();
      page0.setStatusCode((-534));
      assertEquals((-534), page0.getStatusCode());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0, 2304L);
        fail("Expecting exception: NoClassDefFoundError");
  ...
  public void test22()  throws Throwable  {
      Page page0 = new Page();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.offerFirst("OhiMPVQR*N9R=)");
      // Undeclared exception!
      try { 
        page0.addTargetRequests((List<String>) linkedList0);
        fail("Expecting exception: NoClassDefFoundError");
