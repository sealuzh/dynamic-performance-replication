...
public class Segment_ESTest extends Segment_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      segment0.writeTo(segment1, 8178);
      // Undeclared exception!
      try { 
        segment1.writeTo(segment0, 12300);
  ...
  public void test01()  throws Throwable  {
      ...
      segment0.next.push(segment1);
      Segment segment2 = segment0.next.split(1023);
      segment1.writeTo(segment0.next, 1023);
  ...
  public void test04()  throws Throwable  {
      ...
      segment0.next = segment0;
      Segment segment1 = new Segment();
      segment0.writeTo(segment1, 5363);
      Segment segment2 = segment0.next.push(segment1);
      segment2.compact();
      segment1.writeTo(segment0, 3673);
  ...
  public void test06()  throws Throwable  {
      Segment segment0 = new Segment();
      segment0.next = segment0;
      segment0.next.limit = 2278;
      Segment segment1 = new Segment();
      Segment segment2 = segment0.next.push(segment1);
      segment1.push(segment2);
      Segment segment3 = segment0.split(1033);
  ...
  public void test07()  throws Throwable  {
      Segment segment0 = new Segment();
      Segment segment1 = new Segment();
      segment0.writeTo(segment1, 1960);
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        segment0.writeTo((Segment) null, (-319));
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ...
      segment0.next = segment0;
      Segment segment1 = new Segment();
      segment0.writeTo(segment1, 1342);
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        segment0.writeTo(segment1, 12300);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ...
      Segment segment4 = segment3.split(2278);
      segment4.compact();
  ...
  public void test23()  throws Throwable  {
      Segment segment0 = new Segment();
      Segment segment1 = new Segment((byte[]) null, 3003, 3003, false, false);
      segment0.prev = segment1;
      segment0.compact();
      assertNotSame(segment0, segment1);
  }
  ...
  public void test25()  throws Throwable  {
      ...
      segment0.writeTo(segment1, 8192);
      Segment segment2 = segment0.next.push(segment1);
      Segment segment3 = segment0.next.split(1023);
  ...
  public void test28()  throws Throwable  {
      Segment segment0 = new Segment((byte[]) null, 12302, 12302, false, false);
      // Undeclared exception!
      try { 
