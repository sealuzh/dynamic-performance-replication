...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test20()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(javaBeanInfo0.clazz, class1, javaBeanInfo0.creatorConstructor, (Constructor<?>) null, (Method) null, (Method) null, (JSONType) null, linkedList0);
  ...
  public void test25()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build((Class<?>) class0, (Type) class1, (PropertyNamingStrategy) null, false, true);
      PropertyNamingStrategy propertyNamingStrategy0 = PropertyNamingStrategy.CamelCase;
  ...
  public void test28()  throws Throwable  {
      Class<FieldInfo> class0 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("-TZ.ksvD", class0, class0, class0, (Field) null, 48, 48, 48);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<AtomicBoolean> class1 = AtomicBoolean.class;
      Class<String> class2 = String.class;
      Class<Annotation> class3 = Annotation.class;
      FieldInfo fieldInfo1 = new FieldInfo("-TZ.ksvD", class2, class3, class1, (Field) null, (-1680), 48, 1241579778);
  ...
  public void test29()  throws Throwable  {
      ...
      Class<AtomicBoolean> class1 = AtomicBoolean.class;
      Class<String> class2 = String.class;
      FieldInfo fieldInfo1 = new FieldInfo("-TZ.ksvD", class1, class2, class2, (Field) null, 90, 48, 90);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
  ...
  public void test30()  throws Throwable  {
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<FieldInfo> class0 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("n_/}CN+08yCXWn", class0, class0, class0, (Field) null, 63, 95, 4713);
      JavaBeanInfo.add(linkedList0, fieldInfo0);
  ...
  public void test32()  throws Throwable  {
      ...
      doReturn("gnt").when(jSONType0).typeKey();
      doReturn("gnt").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<Void> class1 = Void.class;
      FieldInfo fieldInfo0 = new FieldInfo("=", class1, class1, class1, (Field) null, 1692, 22, 1692);
  ...
  public void test33()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("buildMethod not found.").when(jSONType0).typeKey();
      doReturn("buildMethod not found.").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
  ...
  public void test34()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("gxQ]X0)Q(Og\"cNm").when(jSONType0).typeKey();
      doReturn("bO'w").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
