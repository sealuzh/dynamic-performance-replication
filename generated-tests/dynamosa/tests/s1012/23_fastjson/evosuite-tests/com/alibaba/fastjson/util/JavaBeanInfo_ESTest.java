...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test26()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("@_n.4+co\"axG", class2, class3, class1, (Field) null, 1707, 5, 0);
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("com.alibaba.fastjson.util.FieldInfo", javaBeanInfo0.clazz, class1, (Type) null, (Field) null, 0, 0, 1707);
      linkedList0.add(fieldInfo1);
      JavaBeanInfo javaBeanInfo1 = new JavaBeanInfo(fieldInfo1.declaringClass, fieldInfo1.fieldClass, (Constructor<?>) null, javaBeanInfo0.creatorConstructor, (Method) null, (Method) null, (JSONType) null, linkedList0);
      assertEquals(0, javaBeanInfo0.defaultConstructorParameterSize);
  }
  ...
  public void test30()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("getgetlss", class0, class1, class1, (Field) null, (-226), (-226), (-226));
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      Class<AtomicInteger> class2 = AtomicInteger.class;
      FieldInfo fieldInfo1 = new FieldInfo("getgetlss", fieldInfo0.declaringClass, class2, fieldInfo0.fieldClass, (Field) null, (-226), (-226), (-226));
  ...
  public void test31()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      Class<FieldInfo> class1 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("geUgetls#", class0, class0, class0, (Field) null, 29, 29, (-2448));
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("geUgetls#", class0, class1, fieldInfo0.fieldType, (Field) null, 29, 319, 29);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
      assertTrue(boolean0);
  }
  ...
  public void test32()  throws Throwable  {
      Class<Integer> class0 = Integer.class;
      FieldInfo fieldInfo0 = new FieldInfo("getgetAndSet", class0, class0, class0, (Field) null, 33, 33, 33);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo.add(linkedList0, fieldInfo0);
  ...
  public void test33()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build((Class<?>) class0, (Type) class0, propertyNamingStrategy0);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      FieldInfo fieldInfo0 = new FieldInfo("java.lang.Integer", (Class<?>) null, javaBeanInfo0.clazz, javaBeanInfo0.clazz, (Field) null, 0, 0, 0);
      linkedList0.add(fieldInfo0);
  ...
  public void test35()  throws Throwable  {
      ...
      doReturn(";h?5").when(jSONType0).typeKey();
      doReturn(";h?5").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<String> class0 = String.class;
      Class<FieldInfo> class1 = FieldInfo.class;
      FieldInfo fieldInfo0 = new FieldInfo("$H9^9B{Z[IB#&hS", class0, class1, class1, (Field) null, (-44), (-44), (-44));
      linkedList0.add(fieldInfo0);
  ...
  public void test36()  throws Throwable  {
      String[] stringArray0 = new String[1];
      stringArray0[0] = "getnotfyll";
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn(stringArray0).when(jSONType0).orders();
      doReturn("getnotfyll").when(jSONType0).typeKey();
      doReturn("getnotfyll").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      Class<FieldInfo> class0 = FieldInfo.class;
      Class<AtomicInteger> class1 = AtomicInteger.class;
      FieldInfo fieldInfo0 = new FieldInfo("getnotfyll", class0, class1, class0, (Field) null, (-26772328), 16, 16);
      linkedList0.add(fieldInfo0);
      Class<AtomicLong> class2 = AtomicLong.class;
      JavaBeanInfo javaBeanInfo0 = new JavaBeanInfo(class2, class2, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
      assertEquals(0, javaBeanInfo0.defaultConstructorParameterSize);
  ...
  public void test38()  throws Throwable  {
      ...
      doReturn("java.util.concurrent.atomic.AtomicBoolean").when(jSONType0).typeKey();
      doReturn("java.util.concurrent.atomic.AtomicBoolean").when(jSONType0).typeName();
      JavaBeanInfo javaBeanInfo0 = null;
      try {
