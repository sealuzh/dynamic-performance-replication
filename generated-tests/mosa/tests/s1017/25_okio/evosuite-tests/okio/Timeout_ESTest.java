...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MICROSECONDS;
      timeout0.deadline(9L, timeUnit0);
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1444L);
      try { 
  ...
  public void test10()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(1055000000L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      Timeout timeout1 = timeout0.timeout(1055000010L, timeUnit0);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeUnit0);
        fail("Expecting exception: IllegalMonitorStateException");
  ...
  public void test16()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      Timeout timeout1 = timeout0.timeout(363L, timeUnit0);
      timeout1.deadlineNanoTime(363L);
      try { 
        timeout1.waitUntilNotified(timeUnit0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(44L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout(23L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
