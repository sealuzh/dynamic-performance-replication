...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(4487L, timeUnit0);
      Object object0 = new Object();
      timeout0.deadlineNanoTime(4487L);
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadlineNanoTime(0L);
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout1.timeout(3396L, timeUnit0);
      assertEquals(3396000000L, timeout1.timeoutNanos());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.deadline(967L, timeUnit0);
  ...
  public void test07()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      timeout0.deadlineNanoTime((-1392409281322666L));
      long long0 = timeout0.deadlineNanoTime();
      assertEquals((-1392409281322666L), long0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals(4487000000L, timeout0.timeoutNanos());
  ...
  public void test20()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.deadline(1271L, timeUnit0);
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(601L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-1572L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-1615L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.NANOSECONDS;
      timeout0.timeout(4487L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test31()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      Timeout timeout1 = timeout0.NONE.deadline(4487L, timeUnit0);
  ...
  public void test33()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(83721600000000000L);
      // Undeclared exception!
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: IllegalMonitorStateException");
