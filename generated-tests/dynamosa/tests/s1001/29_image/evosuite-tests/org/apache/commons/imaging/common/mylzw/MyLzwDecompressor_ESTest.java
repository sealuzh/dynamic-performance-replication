...
public class MyLzwDecompressor_ESTest extends MyLzwDecompressor_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        myLzwDecompressor0.decompress(byteArrayInputStream0, 1022);
  ...
  public void test03()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = new MyLzwDecompressor((-6209), byteOrder0);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(pipedInputStream0, (-6209));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Negative initial size: -6209
         //
  ...
  public void test04()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-54), 2702);
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream(byteArrayInputStream0, 3638);
      SequenceInputStream sequenceInputStream0 = new SequenceInputStream(bufferedInputStream0, bufferedInputStream0);
      // Undeclared exception!
      try { 
        myLzwDecompressor0.decompress(sequenceInputStream0, 642);
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        myLzwDecompressor0 = new MyLzwDecompressor(856, byteOrder0, myLzwDecompressor_Listener0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test07()  throws Throwable  {
      ...
      MyLzwDecompressor myLzwDecompressor0 = null;
      try {
        myLzwDecompressor0 = new MyLzwDecompressor(1078, byteOrder0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test10()  throws Throwable  {
      ...
      byteArray0[0] = (byte) (-11);
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      byte[] byteArray1 = myLzwDecompressor0.decompress(byteArrayInputStream0, 1978);
