...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.verify("cn", (SSLSession) null);
  ...
  public void test4()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // codegen.java.security.cert.Certificate$MockitoMock$762049718 cannot be cast to java.security.cert.X509Certificate
         //
         verifyException("okhttp3.internal.tls.OkHostnameVerifier", e);
      }
  }
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        okHostnameVerifier0.verify("okhttp3.internal.tls.OkHostnameVerifier", x509Certificate0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test9()  throws Throwable  {
      ...
      boolean boolean0 = okHostnameVerifier0.verify("", x509Certificate0);
      LinkedHashSet<List<JMXPrincipal>> linkedHashSet0 = new LinkedHashSet<List<JMXPrincipal>>();
      ...
      SSLSession sSLSession0 = mock(SSLSession.class, new ViolatedAssumptionAnswer());
      doReturn(certificateArray0).when(sSLSession0).getPeerCertificates();
      boolean boolean1 = okHostnameVerifier0.verify(".", sSLSession0);
