...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test10()  throws Throwable  {
      ...
      cacheControl_Builder0.maxStale(3956, timeUnit0);
      CacheControl cacheControl0 = new CacheControl(cacheControl_Builder0);
  ...
  public void test13()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      cacheControl_Builder0.maxAge(3299, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder0.build();
      int int0 = cacheControl0.maxAgeSeconds();
      assertEquals((-1), cacheControl0.minFreshSeconds());
      assertFalse(cacheControl0.isPublic());
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-22), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxAge((-1952820692), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test32()  throws Throwable  {
      ...
      stringArray0[0] = "cache-control";
      stringArray0[1] = "no-cache, no-store, max-age=0, min-fresh=0";
      stringArray0[2] = "no-cache, no-store, max-age=0, min-fresh=0";
      stringArray0[3] = "no-cache, no-store, max-age=0, min-fresh=0";
      stringArray0[4] = "no-cache, no-store, max-age=0, min-fresh=0";
      stringArray0[5] = "no-cache, no-store, max-age=0, min-fresh=0";
      stringArray0[6] = "no-cache, no-store, max-age=0, min-fresh=0";
      stringArray0[7] = "no-cache, no-store, max-age=0, min-fresh=0";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.onlyIfCached());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
  ...
  public void test33()  throws Throwable  {
      Headers.Builder headers_Builder0 = new Headers.Builder();
      Headers.Builder headers_Builder1 = headers_Builder0.add("cache-control", "w~;LiR&O)L8)T0_]/%");
