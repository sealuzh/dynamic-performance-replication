...
public class OkHostnameVerifier_ESTest extends OkHostnameVerifier_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      LinkedList<List<MockJapaneseDate>> linkedList0 = new LinkedList<List<MockJapaneseDate>>();
      ...
      boolean boolean0 = okHostnameVerifier0.verify("2", x509Certificate0);
  ...
  public void test1()  throws Throwable  {
      ...
      try { 
        okHostnameVerifier0.verify("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([d.]+)", x509Certificate0);
