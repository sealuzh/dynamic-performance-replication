...
public class CacheControl_ESTest extends CacheControl_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.HOURS;
      CacheControl.Builder cacheControl_Builder1 = cacheControl_Builder0.maxStale(1163, timeUnit0);
      CacheControl cacheControl0 = cacheControl_Builder1.build();
      int int0 = cacheControl0.maxStaleSeconds();
      assertFalse(cacheControl0.isPublic());
      assertEquals((-1), cacheControl0.maxAgeSeconds());
      assertEquals(4186800, int0);
      assertFalse(cacheControl0.mustRevalidate());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertFalse(cacheControl0.isPrivate());
      assertEquals((-1), cacheControl0.minFreshSeconds());
  ...
  public void test13()  throws Throwable  {
      CacheControl.Builder cacheControl_Builder0 = new CacheControl.Builder();
      TimeUnit timeUnit0 = TimeUnit.MINUTES;
      cacheControl_Builder0.maxAge(4162, timeUnit0);
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.minFresh((-1351), timeUnit0);
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        cacheControl_Builder0.maxStale((-901), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals("n-tr2asfoOm, ", string0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      stringArray0[0] = "n-tr2asfoOm, ";
      stringArray0[1] = "V[<J {}";
      stringArray0[2] = "pmg?hma";
      stringArray0[3] = "n-tr2asfoOm, ";
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      CacheControl cacheControl1 = CacheControl.FORCE_CACHE;
      CacheControl cacheControl2 = CacheControl.parse(headers0);
      CacheControl.parse(headers0);
      cacheControl2.headerValue = "n-tr2asfoOm, ";
      CacheControl cacheControl3 = CacheControl.FORCE_NETWORK;
      Headers.Builder headers_Builder0 = new Headers.Builder();
      cacheControl2.headerValue = "pmg?hma";
      cacheControl1.FORCE_CACHE.headerValue = "n-tr2asfoOm, ";
      Headers.Builder headers_Builder1 = headers_Builder0.addLenient("4]lxIhC", "V[<J {}");
      headers_Builder1.removeAll("n-tr2asfoOm, ");
      headers_Builder0.set("pragma", "=");
      Headers headers1 = headers_Builder0.build();
      CacheControl cacheControl4 = CacheControl.parse(headers1);
      String string0 = cacheControl4.FORCE_NETWORK.toString();
      assertEquals("no-cache", string0);
      
      CacheControl cacheControl5 = CacheControl.FORCE_NETWORK;
      cacheControl4.FORCE_NETWORK.headerValue = "V[<J {}";
      System.setCurrentTimeMillis(536L);
      cacheControl5.maxStaleSeconds();
  ...
  public void test34()  throws Throwable  {
      ...
      stringArray0[1] = "no-cache, max-age=242940, max-stale=4049, min-fresh=242940, only-if-cached";
      stringArray0[2] = "no-cache, max-age=242940, max-stale=4049, min-fresh=242940, only-if-cached";
      ...
      Headers headers0 = Headers.of(stringArray0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertEquals(242940, cacheControl0.maxAgeSeconds());
      assertFalse(cacheControl0.noStore());
      assertTrue(cacheControl0.onlyIfCached());
      assertEquals((-1), cacheControl0.sMaxAgeSeconds());
      assertEquals(4049, cacheControl0.maxStaleSeconds());
      assertFalse(cacheControl0.noTransform());
      assertFalse(cacheControl0.isPrivate());
      assertFalse(cacheControl0.mustRevalidate());
      assertEquals(242940, cacheControl0.minFreshSeconds());
  ...
  public void test35()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("pragma", "Q$L6I^\"@r=\"=W/4ZE");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      CacheControl cacheControl0 = CacheControl.parse(headers0);
      assertFalse(cacheControl0.isPublic());
      assertFalse(cacheControl0.isPrivate());
