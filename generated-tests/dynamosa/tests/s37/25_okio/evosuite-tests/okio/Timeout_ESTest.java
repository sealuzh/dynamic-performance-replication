...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      timeout0.timeout(3090L, timeUnit0);
      long long0 = timeout0.timeoutNanos();
      assertEquals(266976000000000000L, long0);
  }
  ...
  public void test05()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.SECONDS;
      timeout0.timeout(3821L, timeUnit0);
      timeout0.deadlineNanoTime(3821L);
      assertEquals(3821000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals(2392409281320000L, long0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      timeout1.deadline(531L, timeUnit0);
      assertEquals(531000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      assertEquals(266976000000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test13()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1044L));
      try { 
  ...
  public void test19()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(888L);
      TimeUnit timeUnit0 = TimeUnit.MILLISECONDS;
      timeout1.timeout(888L, timeUnit0);
      try { 
        timeout1.waitUntilNotified(timeout0);
        fail("Expecting exception: InterruptedIOException");
  ...
  public void test20()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(1743L, timeUnit0);
      // Undeclared exception!
      try { 
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-3542L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test28()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-936L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test30()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.NONE.deadlineNanoTime(9223372036854775807L);
      assertFalse(timeout1.equals((Object)timeout0));
  }
