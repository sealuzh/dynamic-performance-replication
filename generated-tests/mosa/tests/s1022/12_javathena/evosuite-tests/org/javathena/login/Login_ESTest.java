...
public class Login_ESTest extends Login_ESTest_scaffolding {
  ...
  public void test19()  throws Throwable  {
      Login.login_log("or.avthena.core.data.Auth_dta");
  }
  ...
  public void test31()  throws Throwable  {
      ...
      Auth_data auth_data0 = UserManagement.addUserTXT("conf/subnet_athena.conf", "conf/subnet_athena.conf", "conf/subnet_athena.conf", 'X');
  ...
  public void test35()  throws Throwable  {
      Socket_data socket_data0 = new Socket_data((Socket) null);
      socket_data0.setMd5key("md5key setup complete");
      // Undeclared exception!
      try { 
        Login.codingKeyAdministration(socket_data0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test46()  throws Throwable  {
      Login login0 = new Login();
      login0.do_initTXT();
      UserManagement.setAccountIdCount((-879));
      UserManagement.addUserTXT("conf/subnet_athena.conf", "conf/subnet_athena.conf", "----End of login-server (normal end with closing of all files).", '0');
      login0.setAuth_max(9980);
      assertEquals(9980, login0.getAuth_max());
  }
  ...
  public void test49()  throws Throwable  {
      Login login0 = new Login();
      UserManagement.addUserTXT("conf/subnet_athena.conf", "8vw>4cih<", "[Fatal Error]: ", 'R');
      Login.mmo_auth_syncTXT();
      Login login1 = new Login();
      // Undeclared exception!
      try { 
