...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("70", (-3652));
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn("4lmwjn^r,pxe6r0>").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(995).when(response0).code();
  ...
  public void test04()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("|0", "lMCFw)t\"n:*k1f>d%0");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn((Headers) null).when(response0).headers();
      // Undeclared exception!
  ...
  public void test09()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("", 60, "");
  ...
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds(" +([^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)", 1450);
  ...
  public void test23()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("yl*(i3 {yd5jgn", (-455));
  ...
  public void test24()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, (-378));
        fail("Expecting exception: NullPointerException");
  ...
  public void test26()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-1733227377), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test27()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "V");
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "<PX!YI#{z4sr!lABM=!");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertTrue(set0.contains("<PX!YI#{z4sr!lABM=!"));
  }

  @Test(timeout = 4000)
  public void test32()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", (-821));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-0", (-16777238));
      assertEquals(0, int0);
  }
  ...
  public void test35()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" +([^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)", 29);
      assertEquals(29, int0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("PyQ[*qiX3 {Yd5jgN", 1382);
      assertEquals(1382, int0);
  }

  @Test(timeout = 4000)
  public void test37()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("HEAD", 0, "3'[%r?Gq @^jjQh~9)");
      assertEquals(4, int0);
  }
  ...
  public void test39()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn(".SA3^~{~p@2rAYdy&{").when(request0).method();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test40()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("z.LS3^{Tp@>5Yd&").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test42()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("4lmEwjn^r,pxe6r0>").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
      doReturn(58).when(response0).code();
      doReturn(request0).when(response0).request();
      boolean boolean0 = HttpHeaders.hasBody(response0);
      assertTrue(boolean0);
  }
  ...
  public void test51()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("vary", "VD~Jom+akw_&oP");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Headers headers1 = HttpHeaders.varyHeaders(headers0, headers0);
  ...
  public void test53()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("PyQ[*qiX3 {Yd5jgN", "UTF-8");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Set<String> set0 = HttpHeaders.varyFields(headers0);
      assertFalse(set0.contains("UTF-8"));
  }
