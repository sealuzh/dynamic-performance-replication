...
public class HttpHeaders_ESTest extends HttpHeaders_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("8", 100);
      assertEquals(8, int0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn(779).when(response0).code();
  ...
  public void test05()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(";S\"gJB/ovIv)E", 0);
      assertEquals(0, int0);
  }
  ...
  public void test13()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace("", 1562);
  ...
  public void test19()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds((String) null, (-2629));
      assertEquals((-2629), int0);
  }

  @Test(timeout = 4000)
  public void test20()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("", 1381);
  ...
  public void test27()  throws Throwable  {
      ...
      stringArray0[3] = "";
      stringArray0[4] = "vary";
      stringArray0[5] = "jl3nb,uNU5|:S%`Ny";
      Headers headers0 = Headers.of(stringArray0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unexpected char 0x7f at 9 in vary value: jl3nb,uNU5|:S%`Ny
         //
  ...
  public void test29()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace("([^ \"f=]*)", (-1691));
  ...
  public void test30()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipWhitespace((String) null, 918);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil("okhttp3.Headers$Builder", (-3602), "okhttp3.Headers$Builder");
        fail("Expecting exception: StringIndexOutOfBoundsException");
  ...
  public void test32()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.skipUntil((String) null, (-1322), (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test33()  throws Throwable  {
      // Undeclared exception!
      try { 
        HttpHeaders.parseChallenges((Headers) null, "`2");
        fail("Expecting exception: NullPointerException");
  ...
  public void test38()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("0", 1916);
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test39()  throws Throwable  {
      int int0 = HttpHeaders.parseSeconds("-9223372036854775808", (-817));
      assertEquals(0, int0);
  }

  @Test(timeout = 4000)
  public void test40()  throws Throwable  {
      int int0 = HttpHeaders.skipWhitespace(" must not have a request body.", 0);
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test41()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("z#!", 0, "R}k=#Q(pcGjkrs>g,");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test42()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("#.2", 1, "#.2");
      assertEquals(1, int0);
  }

  @Test(timeout = 4000)
  public void test43()  throws Throwable  {
      int int0 = HttpHeaders.skipUntil("d}k=#Q(phGekrs>g,", 3829, "d}k=#Q(phGekrs>g,");
  ...
  public void test46()  throws Throwable  {
      Request request0 = mock(Request.class, new ViolatedAssumptionAnswer());
      doReturn("z").when(request0).method();
      Response response0 = mock(Response.class, new ViolatedAssumptionAnswer());
  ...
  public void test52()  throws Throwable  {
      ...
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      List<Challenge> list0 = HttpHeaders.parseChallenges(headers0, "; realmres=");
      assertEquals(0, list0.size());
  }
  ...
  public void test55()  throws Throwable  {
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      hashMap0.put("Vary", "(to read code point prefix|d 0x");
      Headers headers0 = Headers.of((Map<String, String>) hashMap0);
      Headers headers1 = HttpHeaders.varyHeaders(headers0, headers0);
