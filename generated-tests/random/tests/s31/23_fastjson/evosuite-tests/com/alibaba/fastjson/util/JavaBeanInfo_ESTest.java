...
public class JavaBeanInfo_ESTest extends JavaBeanInfo_ESTest_scaffolding {
  ...
  public void test11()  throws Throwable  {
      ...
      doReturn("IN3t)R {h").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
  ...
  public void test18()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo("ppGFvGsVXTcSz", (Class<?>) null, class0, parameterizedTypeImpl0, (Field) null, 2586, (-2), 2586);
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo("ppGFvGsVXTcSz", (Class<?>) null, class1, class1, (Field) null, (-1), (-2), 999999999);
  ...
  public void test19()  throws Throwable  {
      ...
      FieldInfo fieldInfo0 = new FieldInfo(".QmN<5H, Y,'7v?9", class2, class2, (Type) null, (Field) null, 9, 4237, (-1682));
      linkedList0.add(fieldInfo0);
      FieldInfo fieldInfo1 = new FieldInfo(".QmN<5H, Y,'7v?9", class0, class1, class1, (Field) null, 24, 24, 24);
      boolean boolean0 = JavaBeanInfo.add(linkedList0, fieldInfo1);
      assertEquals(1, linkedList0.size());
      assertTrue(boolean0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JavaBeanInfo javaBeanInfo0 = JavaBeanInfo.build((Class<?>) class0, (Type) class0, propertyNamingStrategy0);
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      FieldInfo fieldInfo0 = new FieldInfo("qxuLku&nr", class0, class0, javaBeanInfo0.clazz, (Field) null, 1, (-1183), 1);
  ...
  public void test23()  throws Throwable  {
      ...
      JSONType jSONType0 = mock(JSONType.class, new ViolatedAssumptionAnswer());
      doReturn((String[]) null).when(jSONType0).orders();
      doReturn("/jEk\"J=|[,>").when(jSONType0).typeKey();
      doReturn("/jEk\"J=|[,>").when(jSONType0).typeName();
      LinkedList<FieldInfo> linkedList0 = new LinkedList<FieldInfo>();
      JavaBeanInfo javaBeanInfo0 = null;
      try {
        javaBeanInfo0 = new JavaBeanInfo(class0, class1, (Constructor<?>) null, (Constructor<?>) null, (Method) null, (Method) null, jSONType0, linkedList0);
