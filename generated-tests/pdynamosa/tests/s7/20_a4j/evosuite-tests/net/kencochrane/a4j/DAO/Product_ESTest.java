...
public class Product_ESTest extends Product_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/{''|Q$9V9GQLJVI=8YE_NET.KENCOCHRANE.A4J.DAO.PRODUCT_HEAVY_=VAK~!TN:'ZVSDT.XML");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "$N<|");
      Product product0 = new Product();
      FullProduct fullProduct0 = product0.getProduct("{''|q$9V9gQLJVI=8ye", "net.kencochrane.a4j.DAO.Product", "=VaK~!Tn:'zvSDT");
