...
public class CRSMatrix_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiFunction", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("org.la4j.operation.MatrixMatrixOperation", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
