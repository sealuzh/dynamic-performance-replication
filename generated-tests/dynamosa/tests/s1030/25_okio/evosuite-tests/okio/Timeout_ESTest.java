...
public class Timeout_ESTest extends Timeout_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      timeout0.timeout(4025L, timeUnit0);
  ...
  public void test02()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-414L));
      try { 
  ...
  public void test09()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime((-1938L));
  ...
  public void test10()  throws Throwable  {
      ...
      Timeout timeout1 = timeout0.timeout(173L, timeUnit0);
      timeout1.deadline(2352L, timeUnit0);
      assertEquals(173000000L, timeout0.timeoutNanos());
  }
  ...
  public void test11()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      Timeout timeout1 = timeout0.deadline(2730L, timeUnit0);
  ...
  public void test12()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      TimeUnit timeUnit0 = TimeUnit.DAYS;
      timeout0.timeout(1134L, timeUnit0);
      timeout0.clearDeadline();
      assertEquals(97977600000000000L, timeout0.timeoutNanos());
  }
  ...
  public void test18()  throws Throwable  {
      Timeout timeout0 = new Timeout();
      Timeout timeout1 = timeout0.deadlineNanoTime(1897200000000000L);
      // Undeclared exception!
      try { 
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline(22L, (TimeUnit) null);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.deadline((-989L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test26()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        timeout0.timeout((-2013L), timeUnit0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test31()  throws Throwable  {
      ...
      long long0 = timeout1.deadlineNanoTime();
      assertEquals(237264409281320000L, long0);
  }
